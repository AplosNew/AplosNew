...
namespace Library.Service.Extension
{
    public class clsWebLib
    {
        ...
        public static bool GetBoolData(string inputData)
        {
            ...
            else if (Convert.ToDouble(clsWebLib.GetNumData(inputData.Trim())) < 0)
                return false;
        ...
        //			clsWebLib.BappsAlert(ref this_page_ref, "Error !! occurred in data saving process. Please see the log below for details.","bappskey1");
        //			this_page_ref=null;
        ...
        // part. ---------- Bappa
        //clsWebLib.bappsConfirm(ref this.Button_delete,"Are you sure to delete this data");
        ...
        //sample use
        //txtModificationDate.Text = clsutilib.DateData_DBToApp(dsLocal.Tables[0].Rows[0]["ModificationDate"].ToString()).ToString("d");
        //drLocal["ModificationDate"] =clsutilib.DateData_AppToDB(System.DateTime.Now,clsStartUp.DB_DATE_FORMAT);
