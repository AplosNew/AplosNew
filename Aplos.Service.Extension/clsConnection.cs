...
namespace Library.Service.Extension
{
    ...
    {
        private int ExecutionTimeout = int.MaxValue;//seconds or 10 minutes


        private string SERVER_NAME = System.Configuration.ConfigurationManager.AppSettings["DBSERVER"];
        private string DATABASE_NAME = System.Configuration.ConfigurationManager.AppSettings["DBNAME"];
        private string USER_NAME = System.Configuration.ConfigurationManager.AppSettings["DBUSERID"];
        private string PASSWORD = System.Configuration.ConfigurationManager.AppSettings["DBUSERPWD"];
        ...
        public clsConnectionManager(int Timeout = 30)
        {
        ...
        private void getDataSetUsingOleDbDataAdapter(string strQuery, ref System.Data.DataSet dsRef)
        {
            ...
            try
            {
                ...
                oleDbDataAdapter.SelectCommand.CommandTimeout = ExecutionTimeout;
        ...
        private void executeOledbQuery(string strQuery)
        {
            ...
            try
            {
                ...
                oleDbCommand.CommandTimeout = ExecutionTimeout;
