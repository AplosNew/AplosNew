...
{
    public class GRNRejectionDetailsService : Service<GRNRejectionDetails>, IGRNRejectionDetailsService
    {
        #region Constructor

        private readonly ISqlRepository _sqlRepository;
        private readonly IRepositoryAsync<GRNRejectionDetails> _gRNPORequisitionAllocationService; 
        //private readonly IRepositoryAsync<PurchaseOrderGroupDetails> _purchaseOrderGroupDetails;
        private readonly IUnitOfWork _unitOfWork;
        private readonly IRepositoryAsync<GRNRejectionDetails> _gRNPORequisitionAllocationRepository;
        
        public GRNRejectionDetailsService( 
            IRepositoryAsync<GRNRejectionDetails> gRNPORequisitionAllocationService
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            , IRepositoryAsync<PurchaseOrderGroupDetails> purchaseOrderGroupDetails
            , IRepositoryAsync<GRNRejectionDetails> gRNPORequisitionAllocationRepository
            ...
            try
            {
                ...
                foreach (var itemDetail in entity)
                {
                    ...
                    //{
                        ...
                        //currentId1++;
                        var receiveDetail = new GRNRejectionDetails
                        {

                            Id = GetPK(),
                            //GRNID = itemDetail.GRNID,
                            //POReqDetailsID = itemDetail.POReqDetailsID,
                            //Qty = Convert.ToDecimal(itemDetail.TransactionQty),
                        ...
                        //_gRNPORequisitionAllocationRepository.Insert(receiveDetail);
                        //_gRNPORequisitionAllocationRepository.Insert(receiveDetail);
        ...
        public override void Insert(GRNRejectionDetails entity)
        {
            try
            {
                entity.Id = GetPK();
