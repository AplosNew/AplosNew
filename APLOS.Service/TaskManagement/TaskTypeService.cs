...
namespace Library.Service.TaskManagement
{
    public class TaskTypeService : Service<TaskType>, ITaskTypeService
    {
        ...
        public TaskTypeService(
            IRepositoryAsync<TaskType> TaskTypeRepository
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(TaskTypeRepository, unitOfWork, pkGeneratorService)
        {
        ...
        public override void Insert(TaskType entity)
        {
            try
            {
                Check (entity);
        ...
        public GridModel Query(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = @"SELECT * FROM [HKP].[TaskType] ";
