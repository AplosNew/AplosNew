...
namespace Library.Service.TaskManagement
{
    public class TaskStatusService : Service<TaskStatus>, ITaskStatusService
    {
        ...
        public TaskStatusService(
            IRepositoryAsync<TaskStatus> TaskStatusRepository
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(TaskStatusRepository, unitOfWork, pkGeneratorService)
        {
        ...
        public string GetPK()
        {
            return GetAutoNumber(nameof(TaskStatus), PKGeneratorEnum.Auto, null, DateTime.Now);
        }
        private void Check(TaskStatus entity)
        {
        ...
        public override void Insert(TaskStatus entity)
        {
            try
            {
                Check (entity);
        ...
        public GridModel Query(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = @"SELECT * FROM [HKP].[TaskStatus] ";
