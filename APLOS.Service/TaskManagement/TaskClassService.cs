...
{
    public class TaskClassService : Service<TaskClass>, ITaskClassService
    {
        #region Constructor
        ...
        public TaskClassService(
            IRepositoryAsync<TaskClass> TaskClassRepository
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(TaskClassRepository, unitOfWork, pkGeneratorService)
        {
        ...
        public string GetPK()
        {
            return GetAutoNumber(nameof(TaskClass), PKGeneratorEnum.Auto, null, DateTime.Now);
        }
        private void Check(TaskClass entity)
        {
        ...
        public override void Insert(TaskClass entity)
        {
            try
            {
                Check(entity);
        ...
        public override void Update(TaskClass entity)
        {
            try
            {
                //Check(entity);
        ...
        public GridModel Query(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = @"SELECT * FROM [HKP].[TaskClass] ";
