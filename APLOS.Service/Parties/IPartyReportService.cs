...
namespace Library.Service.Parties
{
    public interface IPartyReportService
    {
        ...
        IWorkbook GetShortPartyPaymentStatusLedgerReport(string companyGroupId, string companyId, string plantId, string plantName, PartyType partyType, string partyId, string partyPlantId, string fromDate, string toDate, string glId, bool active, string gSTINId);
