...
namespace Library.Service.Advances
{
    public interface IAdvanceWriteOffService : IService<AdvanceWriteOff>
    {
        ...
        string InsertMultiCustomerAdvanceWriteOff(VoucherViewModel voucherVM, IEnumerable<VoucherDetailViewModel> advanceDetailVMList, IEnumerable<VoucherDetailCurrencyViewModel> voucherDetailCurrencyVMList);
