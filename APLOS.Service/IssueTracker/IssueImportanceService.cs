...
{
    public class IssueImportanceService : Service<IssueImportance>, IIssueImportanceService
    {
        #region Constructor
        ...
        public IssueImportanceService(
            IRepositoryAsync<IssueImportance> IssueImportanceRepository
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(IssueImportanceRepository, unitOfWork, pkGeneratorService)
        {
        ...
        public string GetPK()
        {
            return GetAutoNumber(nameof(IssueImportance), PKGeneratorEnum.Auto, null, DateTime.Now);
        }
        private void Check(IssueImportance entity)
        {
        ...
        public override void Insert(IssueImportance entity)
        {
            try
            {
                Check(entity);
        ...
        public override void Update(IssueImportance entity)
        {
            try
            {
                Check(entity);
        ...
        public GridModel Query(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = @"SELECT * FROM [dbo].[IssueImportance] ";
