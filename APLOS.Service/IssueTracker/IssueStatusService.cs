...
{
    public class IssueStatusService : Service<IssueStatus>, IIssueStatusService
    {
        #region Constructor
        ...
        public IssueStatusService(
            IRepositoryAsync<IssueStatus> IssueStatusRepository
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(IssueStatusRepository, unitOfWork, pkGeneratorService)
        {
        ...
        public string GetPK()
        {
            return GetAutoNumber(nameof(IssueStatus), PKGeneratorEnum.Auto, null, DateTime.Now);
        }
        private void Check(IssueStatus entity)
        {
        ...
        public override void Insert(IssueStatus entity)
        {
            try
            {
                Check(entity);
        ...
        public override void Update(IssueStatus entity)
        {
            try
            {
                Check(entity);
        ...
        public GridModel Query(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = @"SELECT * FROM [dbo].[IssueStatus] ";
