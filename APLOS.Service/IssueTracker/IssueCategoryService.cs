...
{
    public class IssueCategoryService : Service<IssueCategory>, IIssueCategoryService
    {
        #region Constructor
        ...
        public IssueCategoryService(
            IRepositoryAsync<IssueCategory> IssueCategoryRepository
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(IssueCategoryRepository, unitOfWork, pkGeneratorService)
        {
        ...
        public string GetPK()
        {
            return GetAutoNumber(nameof(IssueCategory), PKGeneratorEnum.Auto, null, DateTime.Now);
        }
        private void Check(IssueCategory entity)
        {
        ...
        public override void Insert(IssueCategory entity)
        {
            try
            {
                Check(entity);
        ...
        public override void Update(IssueCategory entity)
        {
            try
            {
                Check(entity);
        ...
        public GridModel Query(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = @"SELECT * FROM [dbo].[IssueCategory] ";
