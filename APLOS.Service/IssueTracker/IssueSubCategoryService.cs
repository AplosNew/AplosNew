...
{
    public class IssueSubCategoryService : Service<IssueSubCategory>, IIssueSubCategoryService
    {
        #region Constructor
        ...
        public IssueSubCategoryService(
            IRepositoryAsync<IssueSubCategory> IssueSubCategoryRepository
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(IssueSubCategoryRepository, unitOfWork, pkGeneratorService)
        {
        ...
        public string GetPK()
        {
            return GetAutoNumber(nameof(IssueSubCategory), PKGeneratorEnum.Auto, null, DateTime.Now);
        }
        private void Check(IssueSubCategory entity)
        {
        ...
        public override void Insert(IssueSubCategory entity)
        {
            try
            {
                Check(entity);
        ...
        public override void Update(IssueSubCategory entity)
        {
            try
            {
                Check(entity);
        ...
        public GridModel Query(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = @"SELECT * FROM [dbo].[IssueSubCategory] ";
