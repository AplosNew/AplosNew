...
namespace Library.Service.Invoices
{
    public class InventoryPayableService : IInventoryPayableService
    {
            ...
            try
            {
                ...
                //_inventoryReceiveRepository.Update(receiveNewData);
                    ...
                    foreach (var voucherDetailVM in voucherDetailVMList.Where(r => r.Amount > 0))
                    {
                        ...
                        else if (voucherDetailVM.TrnType == "Cr" && voucherDetailVM.OtherName == "Vendor")
                        {
                            currentInvoiceDetail++;
                            // INSERT INTO InvoiceDetail
                            var invoiceDetail = new InvoiceDetail
                            ...
                            {
                                currentTaxRecord++;
                            voucherCr.PartyId = null;
                            voucherCr.PartyPlantId = null;
                            voucherCr.PartyType = null;
                                var invoiceTax = new InvoiceTax
                                {
                                    Archive = false,
                                    VoucherDetailId = voucherCr.Id,//voucherDetailCrrId,
        ...
        public string InsertPurchaseReturnPayable(VoucherViewModel voucherVM, IEnumerable<VoucherDetailViewModel> voucherDetailVMList, IEnumerable<InvoiceTaxViewModel> invoiceTaxVMList, bool isDebitNote)
        {
            var flag = false;
            try
            {
                ...
                purhcaseReturn.IsDebitNote = isDebitNote;
