...
{
    public class ProductionSystemService : Service<ProductionSystem>, IProductionSystemService
    {
        #region Constructor
        ...
        public ProductionSystemService(
            IRepositoryAsync<ProductionSystem> productionSystemRepository,
            IPKGeneratorService pkGeneratorService,
            IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(productionSystemRepository, unitOfWork, pkGeneratorService)
        {
        ...
        private void Check(ProductionSystem entity)
        {
        ...
        public GridModel Query(GridParameter parameters, string companyGroupId)
        {
            try
            {
                parameters.CmdText = @"SELECT * FROM [HKP].[ProductionSystem] WHERE CompanyGroupId='" + companyGroupId + "'";
        ...
        public override void Insert(ProductionSystem entity)
        {
            try
            {
                Check(entity);
                entity.Id = GetAutoNumber(nameof(ProductionSystem), PKGeneratorEnum.Auto, entity.CompanyGroupId, DateTime.Now);
                entity.Active = true;
                base.Insert(entity);
            }
            catch (Exception ex)
        ...
        public override void Update(ProductionSystem entity)
        {
            try
            {
                Check(entity);
