...
{
    public partial class MachineSubClassService : Service<MachineSubClass>, IMachineSubClassService
    {
        #region Constructor
        ...
        public MachineSubClassService(
            IRepositoryAsync<MachineSubClass> machineSubCategoryRepository,
        ...
        public override IQueryFluent<MachineSubClass> Query()
        {
        ...
        /// </returns>
        ///-------------------------------------------------------------------------------------------------
        public IEnumerable<object> GetMachineSubClassList()
        {
            try
            {
        ...
        #endregion GetMachineSubClassList
        ...
        public override void Insert(MachineSubClass entity)
        {
            var flag = false;
            try
            {
        ...
        {
            return _pkGeneratorService.GetAutoNumber(nameof(MachineSubClass), PKGeneratorEnum.Auto, null, DateTime.Now);
        }

        public override void Update(MachineSubClass entity)
        {
            try
            {
    ...
    public partial class MachineSubClassService : IMachineSubClassService
    {
        ...
        public virtual GridModel GetSearchData(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = $"SELECT * FROM [HKP].[{DbTable.MachineSubClass}] WHERE Archive=0";
        ...
        public virtual Dictionary<string, object> GetModelData(object id)
        {
            try
            {
                var sql = $"SELECT * FROM  [HKP].[{DbTable.MachineSubClass}] WHERE Id = @0";
