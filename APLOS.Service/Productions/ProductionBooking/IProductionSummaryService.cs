...
namespace Library.Service.Productions
{
    public interface IProductionSummaryService : IService<ProductionSummary>
    {
        ...
        IEnumerable<object> GetCboIssueQIC(string plantId, string ProcessId, string entityId, string productionDate, string shiftId, string HeaderResponsiblePersonId, string IssueId, string PeriodId);
