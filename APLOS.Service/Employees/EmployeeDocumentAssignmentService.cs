...
namespace Library.Service.Employees
{
    public class EmployeeDocumentAssignmentService : Service<EmployeeInformation>, IEmployeeDocumentAssignmentService
    {
       ...
       //             {
        ...
        //		InitPostDocument(entities, plantId, empType);
        ...
        //	try
        //	{
        //		string _sql = @"SELECT CD.Id AS ComplianceDocumentId
        ...
        //						LEFT OUTER JOIN HKP.ComplianceDocumentPositonCode PC ON CD.Id = PC.ComplianceDocumentId
        //						LEFT OUTER JOIN ORG.Position PO ON PC.PositionId = PO.Id
        //						WHERE CD.[Type]='EmployeeRelated'
        //							AND DC.PlantId = '" + plantId + @"'
        //							AND CD.IsSkillBased = 1
        //							AND PC.PositionId IN (SELECT PositionId FROM MST.ManpowerBudget WHERE Id IN
        //							(
        //							SELECT BudgetCode FROM EmployeeInformation Where GivenDesignationId IN (" + givenDesignationIds + @")
        //							))
        ...
        //{
        //	List<EmployeeDocument> uidoclist = new List<EmployeeDocument>();
        //	List<EmployeeDocument> savelist = new List<EmployeeDocument>();
        ...
        //	var _pk = _employeeDocumentService.GetAutoNumber("EmployeeDocument", PKGeneratorEnum.Auto, null, DateTime.Now);
        //	int pkCount = 0;
        //	DataTable docList = GetDocList(plantId, givenDesignationIds, empType);

        //	var getdeldoclist = GetDetaList(givenDesignationIds).ToList<EmployeeDocument>();
        //	var getAllDocList = GetAllDocList(givenDesignationIds).ToList<EmployeeDocument>();
        ...
        //		DataView dvList = new DataView(docList)
        //		{
        ...
        //		//var deldoclist = _employeeDocumentService.Query(t => t.EmpSystemID == empId && t.FileName == null).Select().ToList();
        //		var deldoclist = getdeldoclist.Where(t => t.EmpSystemID == empId).ToList();
        //		if (deldoclist != null)
        //		{
        //			foreach (var del in deldoclist)
        //			{
        //				del.ModelState = ModelState.Deleted;
        //				_employeeDocumentService.DeleteGraph(del);
        //			}
        //		}

        //		//savelist = new List<EmployeeDocument>();
        //		////var dbdoclist = _employeeDocumentService.Query(t => t.EmpSystemID == empId).Select().ToList();
        //		var dbdoclist = getAllDocList.Where(t => t.EmpSystemID == empId).ToList();

        //		foreach (var doc in uidoclist)
        //		{
        //			var obj = GetMachedData(dbdoclist, doc.ComplianceDocumentId);

        //			if (obj == null)
        //			{
        //				//savelist.Add(doc);
        //				_employeeDocumentService.InsertGraph(doc);
        //			}
        //		}
        ...
        //	//{
        //	//	_employeeDocumentService.InsertGraph(item);
        //	//}
        //}
        //private EmployeeDocument GetMachedData(List<EmployeeDocument> list, string compliancedocid)
        //{
        //	EmployeeDocument ob = null;
        //	foreach (var item in list)
        //	{
        //		if (item.ComplianceDocumentId == compliancedocid)
        //		{
        //			ob = item;
        //			break;
        //		}
        ...
        //public IEnumerable<EmployeeDocument> GetDetaList(string givenDesignationIds)
        //{
        //	try
        //	{
        //		string _sql = @"SELECT * FROM EmployeeDocument ED
        //						LEFT JOIN EmployeeInformation EI ON ED.EmpSystemID=EI.SystemId
        //						WHERE ED.FileName IS NULL AND EI.GivenDesignationId IN(" + givenDesignationIds + ")";
        //		return _employeeDocumentRepository.SqlQuery<EmployeeDocument>(_sql).AsEnumerable();
        //	}
        //	catch (Exception)
        //	{
        //		throw;
        ...
        //public IEnumerable<EmployeeDocument> GetAllDocList(string givenDesignationIds)
        //{
        //	try
        //	{
        //		string _sql = @"SELECT * FROM EmployeeDocument ED
        //						LEFT JOIN EmployeeInformation EI ON ED.EmpSystemID=EI.SystemId
        //						WHERE EI.GivenDesignationId IN(" + givenDesignationIds + ")";
        //		return _employeeDocumentRepository.SqlQuery<EmployeeDocument>(_sql).AsEnumerable();
        //	}
        //	catch (Exception)
        //	{
