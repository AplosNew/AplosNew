...
namespace OTSBD
{
    public class xclsEmployeeLoad
    {
        ...
        public bool DuplicateEmployeeCode(string sGroupID, string strCompanyID, string strPlantID, string strSystemID, string strEmpCode)
        {
            ConnectionManager.DAL.ConManager objCon;
            string strSql = string.Empty;
            ...
            try
            {
                strSql = @"SELECT * FROM
                                    ...
                                    SELECT E.SystemID, E.EmployeeCode, E.EmployeeName, REPLACE(Convert(varchar(11), E.DOB, 106),' ','-') AS DOB,
		                                   E.FatherName, E.MotherName, E.EmpType EmployeeType, E.EmploymentType EmploymentNature, E.NationalID, G.GenderName,
                                           REPLACE(Convert(varchar(11), E.DOJ, 106),' ','-') AS  DOJ, REPLACE(Convert(varchar(11), E.DOC, 106),' ','-') AS DOC,
                                           U.UnitName AS Unit, Dv.DivisionName AS Division, De.DepartmentName AS Department, Se.SectionName AS Section,
                                            uS.SubSectionName SubSection, Dsg.DesignationName AS Designation, EC.EmpCategoryName
            ...
            try
            {
                strSql = @" SELECT top (100)
                                        ...
                                        (SELECT E.SystemID,
                                          ...
                                          LEFT OUTER JOIN HKP.DesignationGroup AS dg ON dg.Id = E.DesignationGroupID
                                          LEFT OUTER JOIN
                                                      (
                                          ...
                                          LEFT OUTER JOIN ORG.SubSection AS SuS ON SuS.Id = E.SubSectionID
...
and dm.plantid=e.plantid
        ...
        public void SearchBudgetCode(string sql, string strKey, out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                strSql = "SELECT TOP(100) A.Code,A.Plant,A.Division,A.Unit,A.Section,A.SubSection,A.PositionName,A.EntityName,A.Line,A.Id FROM (" + sql + " ) A ";
        ...
        public void SearchRepotingEmpBasicInfo(string sGroupID, string strKey, out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                strSql = @"SELECT Top(100)* FROM
                                    ...
                                    SuS.UserName SubSection, Dsg.UserName AS Designation, EC.UserName EmployeeType
		                            FROM EmployeeInformation AS E
				                            LEFT OUTER JOIN
        ...
        public void XSearchAndSelectMultEmpBasicInfo(string sGroupID, string sPlantID, string sFrmDt, string sToDt, string strKey, out System.Data.DataSet dsRef)
        {
            ConnectionManager.DAL.ConManager objCon;
            string strSql = "";
            ...
            try
            {
                strSql = @"SELECT TOP (100) [CheckBoxSelectEmp] = Convert(bit, 'False'), * FROM
                                    ...
                                    U.UnitName AS Unit, Dv.DivisionName AS Division, De.DepartmentName AS Department, Se.SectionName AS Section,
                                    SuS.SubSectionName SubSection, Dsg.DesignationName AS Designation, EC.EmpCategoryName, E.SystemID
		                            FROM (
                                            SELECT * FROM
                                                EmployeeInformation WHERE SystemID IN
                                                (
        ...
        public void SearchAndSelectMultEmpBasicInfoPlantWiseP(string sGroupID, string sPlantID, string sYr, string sMth, string sDepartmentId, string sPayGrp, string strKey, out System.Data.DataSet dsRef)
        {
            ConnectionManager.DAL.ConManager objCon;
            string strSql = "";
...
LEFT OUTER JOIN MST.ManpowerBudget mpb on mpb.Id=e.BudgetCode
        ...
        public void SearchOperation(string strKey, string strGroupID, out System.Data.DataSet dsRef)
        {
            ...
            {
                strSQL = @"SELECT * FROM
                                         (SELECT TOP (100) OMS.*,P.UserName Process,OP.UserName Operation, OP.Code, S.UserName Skill,MM.StandardName
										  FROM MST.OperationMachineSkill OMS
										  LEFT JOIN	HKP.Process P ON OMS.ProcessId=P.Id
										  LEFT JOIN	MST.Operation OP ON OMS.OperationId=OP.Id
										  LEFT JOIN	HKP.Skill S ON OMS.SkillId=S.Id
										  LEFT JOIN [MST].[MaterialMasterArticle] MM ON OMS.MaterialMasterArticleId=MM.Id
										  WHERE OMS.MaterialMasterArticleId <>''
										  AND OMS.OperationId IN(SELECT OperationId FROM [HKP].[CompanyGroupWiseOperation]
									      WHERE CompanyGroupId = '" + strGroupID + @"')
                                          ) x ";
                if (strKey.Trim() != "")
                {
                    strSQL = strSQL + " WHERE " + strKey + @"";
        ...
        public void GetOperationCategory(string skillid, out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                strSQL = @"SELECT O.OperationCategoryId [Id],
                                    OC.UserName
                                    FROM [MST].[Operation] O
                                    JOIN [MST].[OperationMachineSkill] OMS on OMS.OperationId=O.Id
                                    JOIN [HKP].[OperationCategory] OC on OC.Id=O.OperationCategoryId
                                    WHERE OMS.SkillId='" + skillid + @"'";
                objCon = new ConnectionManager.DAL.ConManager("1");
                objCon.OpenDataSetThroughAdapter(strSQL, out dsRef, false, "1");
            }
            catch (Exception ex)
        ...
        public void GetOperation(string OperationCategoryId, string skillid, out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                ...
                strSQL = @"SELECT O.Id,
                                    ...
                                    JOIN [MST].[OperationMachineSkill] OMS on OMS.OperationId=O.Id
                                    JOIN [HKP].[OperationCategory] OC on OC.Id=O.OperationCategoryId
                                    WHERE OMS.SkillId='" + skillid + @"' AND O.OperationCategoryId='" + OperationCategoryId + "'";
                objCon = new ConnectionManager.DAL.ConManager("1");
                objCon.OpenDataSetThroughAdapter(strSQL, out dsRef, false, "1");
            }
            catch (Exception ex)
        ...
        public void SearchBank(string rowid, out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                ...
                strSQL = @"Select EBI.*, B.UserName BankName,bb.Id BankBranchId,bb.UserName BankBranch From  [dbo].[EmployeeBankInfo] EBI
                            LEFT OUTER JOIN HKP.Bank B ON B.Id=EBI.BankSystemID
            ...
            try
            {
                ...
                strSQL = @"select s.SystemID,s.SalaryRuleName from SalaryRuleMaster s
                                    left outer join (
                                                ...
                                                ) dm on dm.SalaryRuleMasterId=s.SystemID
									where dm.DesignationId='" + GivenDesignation + "' and s.Plantid='" + PlantId + "'";
        ...
        public void GetSysIdWiseEmpBasicInfoInformation(string sGroupID, string sCompanyID, string sPlantID, string strEmpSysID, out System.Data.DataSet dsRef)
        {
            ...
            {
                strSql = @"SELECT * FROM
                                        (SELECT E.SystemID, E.EmployeeId, CONVERT (int, E.EmployeeCode) EmployeeCode , E.CardNumber, E.Salutation, E.FirstName, E.MiddleName, E.LastName,
        ...
        public void GetEmpReportingPersonForGrd(string sEmpSysID, out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                ...
                //                REPLACE(Convert(varchar(11), E.DOJ, 106),' ','-') AS  DOJ, REPLACE(Convert(varchar(11), E.DOC, 106),' ','-') AS DOC,
                //                U.UnitName AS Unit, Dv.DivisionName AS Division, De.DepartmentName AS Department, Se.SectionName AS Section,
                //                SuS.SubSectionName SubSection, Dsg.DesignationName AS Designation
                //            FROM [dbo].[EmpReportingPerson] RP
                //              INNER JOIN
                //                 EmployeeInformation AS E ON RP.RptEmpSystemID  = E.SystemID
                //              LEFT OUTER JOIN
        ...
        public void GetEmpAcademicQualificationInformationForGrd(string sEmpSysID, out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                ...
                //strSQL = @"SELECT EA.SystemID, EA.EductLevelSystemID, ELI.LevelShort, EA.IsGeneral, EA.IsEnglishMedium, EA.IsMadrasah, EA.IsVocational, EA.IsOther,
                //                EA.OtherEductType, EA.ExamDegreeType, EA.ConcMajor, EA.IntituteName, EA.IsForeignInstitute, EA.ResultSystemID, RGI.GradeShort Result,
                //                EA.Marks, EA.CGPA, EA.Scale, EA.YearOfPass, EA.Duration, EA.Achievement
                //            FROM EmpAcademicQualificationInformation EA
                //              LEFT JOIN [dbo].[EducationLevelInfo] ELI ON EA.EductLevelSystemID = ELI.LevelShort
                //              LEFT JOIN [dbo].[ResultGradeInfo] RGI ON EA.ResultSystemID = RGI.SystemID
                //            WHERE EA.EmpSystemID = '" + sEmpSysID + @"'
                //            ORDER BY ELI.SequenceNo";
            ...
            try
            {
                strSql = @"SELECT * FROM
                                        (SELECT E.SystemID, E.EmployeeCode, E.CardNumber, E.Salutation, E.FirstName, E.MiddleName, E.LastName, E.IsConfirmed, E.Tin,
					                            ...
					                            E.PresZipCode, E.ParmZipCode, E.PresDistrictID, PresD.StandardName PresDistrictName, E.ParmDistrictID,
					                            ParmD.StandardName ParmDistrictName, E.PresCountryID, PresC.StandardName PresCountry, E.ParmCountryID, ParmC.StandardName ParmCountry,
					                            E.TelePhnNo, E.CellPhnNo, E.EmailID, E.UnitID, U.StandardName UnitName, E.PositionID,-- PC.StandardName PositionName,
					                            E.DivisionID, Dv.StandardName DivisionName, E.DepartmentID, De.StandardName DepartmentName, E.SectionID, Se.StandardName SectionName, E.SubSectionID,
					                            SuS.StandardName SubSectionName, E.LineID, Ln.StandardName LineName, E.BudgetCategoryID, EBC.StandardName BudgetCategoryName, E.EmployeeCategorySystemID,
                                                E.SubSecStrucSystemID, SSSM.Description SubSectionStructureDes, SSSM.Code SubSectionStructureCode,
					                            EC.StandardName EmpCategoryName, E.DesignationGroupID, E.DesignationSystemID, DG.StandardName DesignationGroupName, Dsg.StandardName DesignationName,
				                            ...
				                            FROM EmployeeInformation AS E
						                            ...
						                            LEFT OUTER JOIN
									                            [HKP].[BloodGroup] AS BG ON E.BloodGroupID  = BG.ID
						                            --LEFT OUTER JOIN
																--[HKP].[Position] AS PC ON E.PositionID  = PC.ID
						                            LEFT OUTER JOIN
									                            [SCS].[PoliceStation] AS PresT ON E.PresThanaID  = PresT.ID
						                            LEFT OUTER JOIN
									                            [SCS].[PoliceStation] AS ParmT ON E.ParmThanaID  = ParmT.ID
        ...
        public void getEmpCodeAuto(string plantId, out DataSet dsRef)
        {
            ...
            try
            {
                strSQL = @"	SELECT max(CAST(EmployeeCode AS int)) c  from EmployeeInformation
        ...
        public void LoadEmpSalaryProcApprovalGrid(string sPlantID, string sUserGroupID, int iMonthNo, int iYearNo, out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                ...
                //                        GROUP BY SC.SlrProcMstSystemID, SC.IsApproved, SC.IsDisbursed, SC.EmpInfoSystemID, SM.MonthNo, SM.YearNo
                // ) S ON E.SystemID = S.EmpInfoSystemID
                //                          LEFT JOIN Plant F ON E.PlantID = F.PlantID
                //                          LEFT JOIN DesignationGroup DG ON DG.SystemID = E.DesignationGroupID
                //             WHERE IsApproved = 0 ";
                ...
                strSQL = @"SELECT IsSelectSlrProc = Case WHEN S.SlrProcMstSystemID IS NULL THEN Convert(bit, 'False')
                                  ...
                                  E.DesignationGroupID, DG.UserName AS DesignationGroup, E.SalaryRuleMasterSystemID
                           FROM EmployeeInformation E
                                        INNER JOIN (
										            SELECT SC.SlrProcMstSystemID, SC.IsApproved, SC.IsDisbursed, SC.EmpInfoSystemID, SM.MonthNo, SM.YearNo
					                                 FROM SalaryProcChild SC
                ...
                strSQL += @"
                            ORDER BY F.UserName, E.EmployeeCode";
        ...
        public void SearchEmpEntityWise(string sGroupID, string sPlantID, string sEntityID, string sFrmDt, string sToDt, string strKey, out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                //string _fromDate = DateTime.Now.ToString("dd-MMM-yyyy");
                strSql = @"SELECT  [CheckBoxSelectEmp] = Convert(bit, 'False'), * FROM
		                             (SELECT CONVERT(INT, E.EmployeeCode) EmployeeCode, E.EmployeeName, REPLACE(Convert(varchar(11), E.DOB, 106),' ','-') AS [DateOfBirth],
		                            E.FatherName, E.MotherName, E.EmpType EmployeeType, E.EmploymentType EmploymentNature, E.NationalID, E.GenderID GenderName,
...
LEFT OUTER JOIN MST.ManpowerBudget mpb on mpb.Id=e.BudgetCode
        ...
        public void SearchAndSelectMultEmpBasicInfoPlantWisePaySlip(string sGroupID, string sPlantID, string strKey, out System.Data.DataSet dsRef)
        {
            ConnectionManager.DAL.ConManager objCon;
            string strSql = "";
            clsStaticInfo obs = null;
        ...
        public void GetPayGroup(string sa, string ca, string USERPK, out DataSet dsLocal)
        {
            ...
            try
            {
                ...
                else
                {
                    strSql = @"SELECT HPG.Id, HPG.UserName 
                            FROM HKP.PayrollGroup HPG
                            WHERE Id IN (SELECT PayrollGroupId FROM SEC.UserPayrollGroup WHERE UserId = '" + USERPK + @"')";
                }
