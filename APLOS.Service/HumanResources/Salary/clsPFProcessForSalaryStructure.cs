...
namespace OTSBD
{
    public class clsPFProcessForSalaryStructure
    {
        public string sFormulaValue = "";

        public clsPFProcessForSalaryStructure()
        {
