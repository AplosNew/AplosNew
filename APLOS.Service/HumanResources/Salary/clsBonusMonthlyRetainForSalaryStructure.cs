...
namespace OTSBD
{
    public class clsBonusMonthlyRetainForSalaryStructure
    {
        public string sFormulaValue = "";

        public clsBonusMonthlyRetainForSalaryStructure()
        {
        ...
        private void xReLoadFormulaWithValue(string sEmpSystemID, BnsParaList para, string sFormulaID, bool bEarning, ref DataTable dtValue, ref DataTable dtSlrHd)
        {
            DataSet dsLocal = null;
            DataView dvLocal = null;
            DataView dvSlrHd = null;
        ...
        public void xGeneratorBonusEligibleEmployee(BnsParaList para)
        {
            #region Variable Dataset
            DataTable dtValue = null;
            DataSet dsBnsEligibleEmp = null;
        ...
        public void xBonusCalculationMonthly(BnsParaList para)
        {
            #region Variable Dataset
            DataTable dtValue = null;
            DataSet dsBnsEligibleEmp = null;
