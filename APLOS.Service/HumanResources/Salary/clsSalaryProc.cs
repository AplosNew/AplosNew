...
namespace OTSBD
{
    public class xxclsSalaryProc
    {
        public xxclsSalaryProc()
        {
        ...
        /// <summary>
        /// Date Range wise Summary for Monthly Attendance Information date Range Reports.
        /// </summary>
        /// <param name="sEmpSystemID"></param>
        /// <param name="sfrmDate"></param>
        /// <param name="sToDate"></param>
        /// <param name="dsRef"></param>
        public void GetAttdnDataForMonthlyProcPlantAndEmpWise(string sEmpSystemID, string sfrmDate, string sToDate,string plantId, out DataSet dsRef)
        {
            string strSQL;
            ConnectionManager.DAL.ConManager objCon;
        ...
        public void GetSelectedEmployee(string sEmpInfo, out System.Data.DataSet dsRef)
        {
            string strSQL;
            ConnectionManager.DAL.ConManager objCon;
            try
            {
                strSQL = @"SELECT DISTINCT E.SystemID EmpSystemID, E.EmployeeCode, E.EmployeeName, E.PlantID, P.UserName PlantName, REPLACE(CONVERT(VARCHAR(11), E.DOJ, 106),' ','-') DOJ, 
                                  ...
                                  E.DesignationGroupID, E.SalaryRuleMasterSystemID, E.GivenDesignationId,
        ...
        public void GetEmployeeWiseOTPolicy(string sEmpInfo, out DataSet dsRef)
        {
            ConnectionManager.DAL.ConManager objCon;
            string strSql = "";
            try
