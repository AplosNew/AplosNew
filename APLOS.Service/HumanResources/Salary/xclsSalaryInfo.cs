...
namespace OTSBD
{
    public class xclsSalaryInfo
    {
        public xclsSalaryInfo()
        {
...
SELECT SD.SystemID, SD.SalaryID, SDM.EmpInfoSystemID, SDM.EffectiveDate, SDM.SalaryIncrementSystemID, SDM.SalaryRuleMasterSystemID, 
        ...
        public void SalaryStructureAPHeadOnGridOld(string sPlantID, string sEmpSystemID, string sTaxYrStartDt, string sTaxYrEndDt, string EffectiveDate, string sSlrRuleMstSystemID, out System.Data.DataSet dsRef)
        {
            string strSQL;
            ConnectionManager.DAL.ConManager objCon;
            try
...
FixedValue, SequenceNo,
        ...
        public void GetSalaryRuleWiseCurrencyChildOld(string strSlrRuleMstSystemID, out System.Data.DataSet dsRef)
        {
            string strSQL;
            ConnectionManager.DAL.ConManager objCon;
            try
        ...
        public void GetTotalSalary(string strEmpSysID, string sSysID, out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                strSql = @"SELECT isnull(c.DefineAmount,0) DefineAmount  FROM 
