...
namespace Library.Service.HumanResources
{
    public class EmployeePromotionService
    {
        ...
        public EmployeePromotionService(ISqlRepository sqlRepository)
        {
        ...
        public void LoadEmpSalaryInfoDefineData(string EmpSystemId,
            out IEnumerable<EmpSalaryInfoDefineModel> EmpSalaryInfoDefine,
            out IEnumerable<EmpSalaryInfoDefineModel> EmpApprovedSalaryInfoDefine,
            //out IEnumerable<object> EmpApprovedSalaryInfoDefine,
            out IEnumerable<SalaryRuleModel> ResultSalaryRule,
            out IEnumerable<SalaryRuleModel> ResultSelectedSalaryRule,
            out IEnumerable<OpenHeadModel> ResultOpenHead,
            out IEnumerable<OpenHeadModel> ResultApprovedOpenHead,
            out CustomOutPara outPara)
        {
            ...
            try
            {
                ob.StartProcess(o, out dsLocal, out dtApprovedSalaryDifn, out dsMinWage, out dsSalaryRule, out dsSelectedSalaryRule, out dsOpenHead, out dsApprovedOpenHead, out NewFormula_Desc, out ApprovedFormula_Desc);
            ...
            if (o.IsFreshEntry == false)
            {
                ...
                ResultMinWage = dsMinWage.Tables[0].Rows[0]["MinWage"].ToString();
                //ApprovedInfo
        ...
        private IEnumerable<OpenHeadModel> ConvertOpenHeadToList(DataSet ds)
        {
        ...
        private IEnumerable<EmpSalaryInfoDefineModel> ConvertEmpSalaryInfoDefineToList(DataTable dt)
        {
            ...
            List<EmpSalaryInfoDefineModel> list = new List<EmpSalaryInfoDefineModel>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                EmpSalaryInfoDefineModel Data = new EmpSalaryInfoDefineModel();
                ...
                Data.IsOpen = dt.Rows[i]["IsOpen"].ToString();
        ...
        public void UpdateSalaryStractureForIncrement(EmployeeInformation employeeInformation, CustomParaPFSetting PFSettingModel, EmpSalaryInfoModel SalaryInfo, IEnumerable<EmpSalaryInfoDefineModel> EmpSalaryInfoDefineNew, IncrementHistoryModel incrementHistory)
        {
            clsSalaryStructureAplos obj = null;
            CustomPara _para = null;
            DataSet dsLocal = null;
            ...
            try
            {
                ...
                if (dsLocal.Tables[0].Rows.Count > 0)
                {
                    ...
                    obj.SaveData(_para, dsEmpSalaryInfoDefineNew.Tables[0], incrementHistory);
                }
                else
                {
        ...
        public void CalculateSalary(EmployeeInformation employeeInformation, string IsbuttonPFClicked, bool IsPFEntitle,
            string salaryRuleMasterSystemID,
            IEnumerable<OpenHeadModel> OpenHeadNew,
            out IEnumerable<EmpSalaryInfoDefineModel> EmpSalaryInfoDefine,
            out string NewGross, out string NewCTC, out string _Formula_Desc)
        {
            DataTable dtResult = null;
            DataSet dsLocal = null;
            DataSet dsOpenHead = Library.Service.Helpers.DataTableExtensions.ToDataSet<OpenHeadModel>(OpenHeadNew);
            CustomPara _para = new CustomPara();
            var identity = (CustomIdentity)Thread.CurrentPrincipal.Identity;
            _para.PlantId = employeeInformation.PlantID;
            _para.CompanyId = employeeInformation.CompanyId;
            ...
            try
            {
                ...
                obj.StartCalculation(_para, dsOpenHead, out dtResult, out _Formula_Desc);
