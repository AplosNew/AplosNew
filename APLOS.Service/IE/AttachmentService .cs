...
namespace Library.Service.IE
{
    public class AttachmentService : Service<Attachment>, IAttachmentService
    {
        ...
        public AttachmentService(
            IRepositoryAsync<Attachment> AttachmentRepository
            , IPKGeneratorService pkGeneratorService
            , ISqlRepository sqlRepository
            , IUnitOfWork unitOfWork) :
            base(AttachmentRepository, unitOfWork, pkGeneratorService)
        {
        ...
        {
            return GetAutoNumber(nameof(Attachment), PKGeneratorEnum.Auto, null, DateTime.Now);
        }

        private void Check(Attachment entity)
        {
        ...
        public GridModel Query(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = $"SELECT * FROM [HKP].[Attachment]";
