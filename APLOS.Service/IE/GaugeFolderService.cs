...
{
    public class GaugeFolderService : Service<GaugeFolder>, IGaugeFolderService
    {
        #region Constructor

        private readonly ISqlRepository _sqlRepository;

        public GaugeFolderService(
            IRepositoryAsync<GaugeFolder> SizeGroupRepository
        ...
        {
            return GetAutoNumber(nameof(GaugeFolder), PKGeneratorEnum.Auto, null, DateTime.Now);
        }

        private void Check(GaugeFolder entity)
        {
        ...
        public override void Insert(GaugeFolder entity)
        {
            try
            {
                Check(entity);
        ...
        public override void Update(GaugeFolder entity)
        {
            try
            {
                Check(entity);
        ...
        public GridModel Query(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = $"SELECT * FROM [HKP].[GaugeFolder]";
