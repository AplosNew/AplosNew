...
namespace Library.Service.SalaryDisbursement
{
    public interface ISalaryDisbursementService
    {
        ...
        string ParkEmployeeMultipleAdvanceDisbursement(VoucherViewModel voucherVM, IEnumerable<VoucherDetailViewModel> directJVList, string disbursementAdviceId, string goodWorkPaymentAdviseDetailIds, List<Dictionary<string, object>> goodWorkPaymentAdviseDetail, string salaryHeadId);
        ...
        void PostEmployeeMultipleAdvanceDisbursement(string voucherId);
