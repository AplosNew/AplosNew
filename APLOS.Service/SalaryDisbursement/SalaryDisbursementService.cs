...
namespace Library.Service.SalaryDisbursement
{
    public class SalaryDisbursementService : ISalaryDisbursementService
    {
        ...
        public string ParkSalaryPayableDisbursement(VoucherViewModel voucherVM, string yearNo, string monthNo, string monthName, string pMode, IEnumerable<VoucherDetailViewModel> directJVList)
        {
            var flag = false;
            try
            {
        ...
        private Dictionary<string, object> GetAdvanceJournalHeader(string companyGroupId, string companyId, string plantId, string voucherId, SourceType sourceType)
        {
        ...
        private DataTable GetSalaryPayableData(string companyGroupId, string companyId, string plantId, string voucherId)
        {
        ...
        public IWorkbook GetSalaryPayableVoucherReport(out string reportFileName, string companyGroupId, string companyId, string plantId, string plantName, string voucherId)
        {
            ...
            var header = GetAdvanceJournalHeader(companyGroupId, companyId, plantId, voucherId, SourceType.SalaryPayable);

            reportFileName = Convert.ToDateTime(header["PostingDate"]).ToString("yyMMdd") + " " + header["VoucherNo"];

            var dsLocal = GetSalaryPayableData(companyGroupId, companyId, plantId, voucherId);
