...
{
    public class SubAssetTypeService : Service<SubAssetType>, ISubAssetTypeService
    {
        #region Constructor
        ...
        public SubAssetTypeService(
            IRepositoryAsync<SubAssetType> SubAssetTypeRepository
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(SubAssetTypeRepository, unitOfWork, pkGeneratorService)
        {
        ...
        public string GetPK()
        {
            return GetAutoNumber(nameof(SubAssetType), PKGeneratorEnum.Auto, null, DateTime.Now);
        }
        private void Check(SubAssetType entity)
        {
        ...
        public override void Insert(SubAssetType entity)
        {
            try
            {
                Check(entity);
        ...
        public override void Update(SubAssetType entity)
        {
            try
            {
                Check(entity);
        ...
        public GridModel Query(GridParameter parameters)
        {
            try
            {
                parameters.CmdText = @"SELECT * FROM [HKP].[SubAssetType] ";
