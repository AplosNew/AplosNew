...
namespace Library.Service.FixedAssets
{
    ...
    //        }
        ...
        public string InsertFixedAssetSales(string status, IEnumerable<FixedAssetRegister> fixedAssetRegister, string partyId,string partyPlantId, string remarks, string currencyId, string toCurrencyRate)
        {
            var flag = false;
            try
            {
