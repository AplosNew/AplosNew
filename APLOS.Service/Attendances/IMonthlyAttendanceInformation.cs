...
namespace Library.Service.Attendances
{
    public interface IMonthlyAttendanceInformation : IService<AttdnDataMonthlySummary>
    {
        ...
        IWorkbook GetEOTReport(string companyId, string plantId, string Month, string Year, string userName, string DayStatus, Dictionary<string, string> empParameters, bool withColor, bool includeCurrentDate, bool withSummary, bool isActive, bool isSeperated, bool isMaternity);
