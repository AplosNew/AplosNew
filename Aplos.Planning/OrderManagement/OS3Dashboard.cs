...
namespace Library.Planning.OrderManagement
{
    public class OS3Dashboard
    {
        ...
        public List<Dictionary<string, object>>_getSlabData(Dictionary<string, string> parameters, string group, out List<Object> totalArr, out List<double[]> chart, string value, string analysis, string type)
        {
            try
            {
                var str = "";
