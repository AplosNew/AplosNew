    ...
    public class MasterOrder
    {
        ...
        public void CopySalesOrderByMOIData(string MasterId, string masterItemId, List<Dictionary<string, object>> SKU1List, List<Dictionary<string, object>> SKU2List)
        {
            ...
            try
            {
                ...
                string tsql = @"SELECT distinct TaskTemplateMasterId FROM trn.MasterOrder AS mo 
                                INNER JOIN trn.MasterOrderItem AS moi ON moi.MasterOrderId=mo.Id
                                INNER JOIN trn.SalesOrder AS so ON so.MasterOrderItemId=moi.Id
                           WHERE so.id ='" + NewId + "'";
        ...
        public IEnumerable<object> GetSOListForCheck(string masterItemId)
        {
            try
            {
                var sql = @"SELECT  SO.Id,SO.ParentId
                            ...
                            ,SO.ProductionBookedQty,SO.ProductionBookingLevel,SO.SalesExpense,SO.CM,SO.DirectMaterialCost,SO.DirectProcessCost,SO.Commission,SO.ValueLoss,SO.Other,SO.StockResponsiblePersonId,SO.ShipmentFromStock,SO.ProductionType,SEMP.EmployeeName StockResponsiblePerson,SO.PackingTypeId,PT.UserName PackingType,SO.ContractId,C.ContractNo,SO.CheckByStatus,SO.CheckByDate,SO.ApproveBy,SO.LineItemReference
        ...
        public IEnumerable<object> GetSOListForApprove(string masterItemId)
        {
            try
            {
                var sql = @"SELECT  SO.Id,SO.ParentId
                            ...
                            , isTax=(SELECT ISNULL(COUNT(DISTINCT SalesOrderId),0) FROM [TRN].[SalesOrderTax] WHERE SalesOrderId=SO.Id)
                            ,ISNULL(POD.ProductionOrderId,'') ProductionOrderId,SO.Reason,SO.Description,SO.CM,SO.SalesOrderYear,SO.WeekNo
                            ,SO.ProductionBookedQty,SO.ProductionBookingLevel,SO.SalesExpense,SO.CM,SO.DirectMaterialCost,SO.DirectProcessCost,SO.Commission,SO.ValueLoss,SO.Other,SO.StockResponsiblePersonId,SO.ShipmentFromStock,SO.ProductionType,SEMP.EmployeeName StockResponsiblePerson,SO.PackingTypeId,PT.UserName PackingType,SO.ContractId,C.ContractNo,SO.CheckByStatus,SO.CheckByDate,SO.ApproveBy,SO.ApprovedStatus,SO.LineItemReference
                    FROM [TRN].[SalesOrder] AS SO
                   -- LEFT JOIN TRN.FirstCharacteristics SKU ON SKU.SalesOrderId=SO.Id
                    JOIN [TRN].[MasterOrderItem] AS MOI ON SO.MasterOrderItemId = MOI.Id
                    LEFT JOIN [TRN].[CustomerPO] AS PO ON SO.CustomerPOId = PO.Id
...
OUTER APPLY(Select * from [dbo].[SalesAdditionalInfo] Where AdditionalInfoId=A.Id AND SalesOrderId='" + SalesOrderId + @"') SA  Where A.Category='SalesOrder' Order By A.sequence";
        ...
        public void GetCompany(out System.Data.DataSet dsRef)
        {
            string strSQL;
            ConnectionManager.DAL.ConManager objCon;
            try
            {
                strSQL = @"Select UserName+'_#'+Id UserName from ORG.Company where Active=1 order by UserName";
                objCon = new ConnectionManager.DAL.ConManager("1");
        ...
        public void GetPlant(out System.Data.DataSet dsRef)
        {
            ...
            try
            {
                strSQL = @"Select UserName+'_#'+Id UserName from ORG.Plant where Active=1 order by UserName";
                objCon = new ConnectionManager.DAL.ConManager("1");
                objCon.OpenDataSetThroughAdapter(strSQL, out dsRef, false, "1");
            }
            catch (Exception ex)
        ...
        public void GetEntity(out System.Data.DataSet dsRef)
        {
            string strSQL;
            ConnectionManager.DAL.ConManager objCon;
            try
            {
                strSQL = @"Select UserName+'_#'+Id UserName from ORG.Entity where Active=1 order by UserName";
                objCon = new ConnectionManager.DAL.ConManager("1");
                objCon.OpenDataSetThroughAdapter(strSQL, out dsRef, false, "1");
            }
            catch (Exception ex)
        ...
        public IWorkbook GetMOSampleFile(string Name)
        {
            #region declare
            ...
            try
            {
                ...
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "CompanyId"); int colCompanyId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "PlantId"); int colPlantId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "EntityId"); int colEntityId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "OrderType"); int colOrderType = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "CustomerId"); int colCustomerId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "BuyerId"); int colBuyerId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "BuyerBrandId"); int colBuyerBrandId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "BuyerDivisionId"); int colBuyerDivisionId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "OrderStatusId"); int colOrderStatusId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "OrderCategoryId"); int colOrderCategoryId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "SeasonId"); int colSeasonId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "OrderYear"); int colOrderYear = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "CurrencyId"); int colCurrencyId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "TotalQty"); int colTotalQty = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "NoOfLineItem"); int colNoOfLineItem = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "ResponsiblePersonId"); int colResponsiblePersonId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "Remarks"); int colRemarks = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "OrderWastagePercentage"); int colOrderWastagePercentage = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "ExtraOrderPercentage"); int colExtraOrderPercentage = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "TotalQtyUOMId"); int colTotalQtyUOMId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "Type"); int colType = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "BuyerDepartmentId"); int colBuyerDepartmentId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "BuyerReferenceNo"); int colBuyerReferenceNo = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "OwnReferenceNo"); int colOwnReferenceNo = xlsCol;
                ...
                #endregion  SampleFileMasterOrder
        ...
        public IWorkbook GetMOISampleFile(string Name)
        {
            #region declare
            clsReport objRpt = null;
            OTSBD.clsStaticInfo objStatic = null;
            ...
            try
            {
                ...
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "MaterialMasterId"); int colMaterialMasterId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "ArticleId"); int colArticleId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "BuyerReferenceNo"); int colBuyerReferenceNo = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "OwnReferenceNo"); int colOwnReferenceNo = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "TotalQty"); int colTotalQty = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "OrderWastagePercentage"); int colOrderWastagePercentage = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "ExtraOrderPercentage"); int colExtraOrderPercentage = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "Type"); int colType = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "ProductionGrouping"); int colProductionGrouping = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "UOMId"); int colUOMId = xlsCol; 
        ...
        public IWorkbook GetSOSampleFile(string Name)
        {
            #region declare
            clsReport objRpt = null;
            OTSBD.clsStaticInfo objStatic = null;
            ...
            try
            {
                ...
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "OrderCategoryId"); int colOrderCategoryId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "DeliveryDate"); int colDeliveryDate = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "ShipmentModeId"); int colShipmentModeId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "DestinationId"); int colDestinationId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "Qty"); int colQty = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "PackingTypeId"); int colPackingTypeId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "ResponsiblePersonId"); int colResponsiblePersonId = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "LSD"); int colLSD = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "MainRawMaterialInhouseDate"); int colMainRawMaterialInhouseDate = xlsCol; xlsCol += 1;
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "OtherRawMaterialInhouseDate"); int colOtherRawMaterialInhouseDate = xlsCol;
                ...
                #endregion  SampleFileSalesOrder
...
Where BuyerId='"+ buyerId + "'";
        ...
        //        //sorting
        //        //lock               
        //        GetCompany(out dsCompany);
        //        GetPlant(out dsPlant);
        //        GetEntity(out dsEntity);
