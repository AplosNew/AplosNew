...
{
   public class FurnitureMasterService
    {
        ISqlRepository _sqlRepository;
        public FurnitureMasterService()
        {
        ...
        public IEnumerable<object> Get(string Id)
        {
            try
            {
                var sql = "select * from HKP.FurnitureMaster where Id = '" + Id + "' ";
        ...
        {
            DataTable dt = _sqlRepository.GetDataTable("SELECT  isnull(Max(Sequence),0) AS Sequence FROM HKP.FurnitureMaster");
            if (dt.Rows.Count > 0)
