   ...
   public class clsTemplateDownloadSalaryStructure
    {
        ...
        #region Bulk Increment Salary Structure Data Upload
        public IWorkbook GetBulkIncrementSampleFile(string Name, string CompanyGroupId, string PlantId, string CompanyId, string PlantName)
        {
            #region declare
            clsReport objRpt = null;
            clsStaticInfo objStatic = null;
