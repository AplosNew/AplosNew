...
{
   public class clsTemplateDownloadExternalData
    {
        ...
        public void GetSalaryRuleForCompany(string PlantId, out System.Data.DataSet dsRef)
        {
            string strSQL;
            ConnectionManager.DAL.ConManager objCon;
            try
            {
                strSQL = @"SELECT SalaryRuleName+'_#'+SystemID UserName  FROM SalaryRuleMaster WHERE IsActive=1 order by UserName";
                objCon = new ConnectionManager.DAL.ConManager("1");
                objCon.OpenDataSetThroughAdapter(strSQL, out dsRef, false, "1");
            }
            catch (Exception ex)
        ...
        public IWorkbook GetSampleFile(string Name, string CompanyGroupId, string PlantId, string CompanyId, string PlantName)
        {
            ...
            try
            {
                ...
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "EmployeeCode"); xlsCol += 1;
                ...
                ru.SetHeaderText(ref sheet1, xlsRow, xlsCol, "Amount"); xlsCol += 1;
        ...
        public IWorkbook GetSampleFileForCompany(string Name, string CompanyGroupId, string PlantId, string CompanyId, string PlantName)
        {
            #region declare
            clsReport objRpt = null;
            clsStaticInfo objStatic = null;
            ...
            try
            {
                ...
                GetSalaryRuleForCompany(PlantId, out dsSalaryRule);
