...
{
    public class clsESICProcess
    {
        public string sFormulaValue = "";

        public clsESICProcess()
        {
        ...
        public void LoadEmpSlrDefForSlrProcess(ESICParaList para, string sEmpInfo, out DataSet dsRef)
        {
            ...
            try
            {
                ...
                strSql = @"SELECT * FROM 
		                            (
                                     SELECT SEFD.SystemID AS SlrInfoDefSystemID, 
                                     SEFD.PlantID, 
                                     SEFD.EmpInfoSystemID, SEFD.EffectiveDate, SEFD.SalaryRuleMasterSystemID, 
