...
{
  public  class FuguaiService
    {
        private readonly SqlRepository _sqlRepository;
        #region Constructor
        public FuguaiService()
        {
        ...
        public IEnumerable<object> GetMaster(string Id)
        {
            try
            {
                var str = @"select * from dbo.Fuguai where Id = '" + Id + "' ";
        ...
        public IEnumerable<object> GetList()
        {
            try
            {
                string sql = @"select * from HKP.Fuguai";
        ...
        {
            DataTable dt = _sqlRepository.GetDataTable("SELECT  isnull(Max(Sequence),0) AS Sequence FROM HKP.Fuguai");
            if (dt.Rows.Count > 0)
