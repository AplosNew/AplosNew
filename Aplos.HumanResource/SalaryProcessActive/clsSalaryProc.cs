...
";
        ...
        public void LoadEmpSlrDefForSlrProcessList(string sPlantID, string sEmpInfo, string sFromDate, string sToDate, out Dictionary<string, List<dicLocal>> dsDic)
        {
            ...
            try
            {
                ...
                //                                            SD.SalaryHeadID, SH.SalaryHead
                //,SequenceNo=case when ISNULL(SlrDis.SequenceNo,0)=0 then sd.SequenceNo else ISNULL(SlrDis.SequenceNo,0) end
                //, SH.HeadType, SH.HeadCategory, SD.AmtDefinitionCurrencyID, SD.AmtDefinitionRate,	
