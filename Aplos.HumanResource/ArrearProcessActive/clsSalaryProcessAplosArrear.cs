...
public class clsSalaryProcessAplosArrear
{
    ...
    public FunctionPara SalaryProcess(FunctionPara para, string BatchNo, string ArrearFromDate, string ArrearToDate)
    {
        ...
        try
        {
            ...
            objGenID.GenID(DateTime.Now.ToShortDateString().ToString(), "ARREARPORCESS", out strCurCode);
            strCurCode = "AR" + "-" + strCurCode;
            ...
            if (dsGrid.Tables[0].Rows.Count > 0)
            {
                ...
                for (int GrdEmp = 0; GrdEmp < dsGrid.Tables[0].Rows.Count; GrdEmp++)
                {
                    #region Salary Process for each 100 employees
                    if (Convert.ToBoolean(dsGrid.Tables[0].Rows[GrdEmp]["IsSelectSlrProc"].ToString().Trim()) == true && Convert.ToBoolean(dsGrid.Tables[0].Rows[GrdEmp]["IsApproved"].ToString().Trim()) == false)
                    {
                        ...
                        if (SelectedEmpCnt == grdRowMaxCnt)
                        {
                            ...
                            /////////////////////////////////***********************************************//////////////////////////////////////
                            objSlrProc.DeleteArrearProcChild(intMonthNo, intYearNo, sEmpInfoSysID);
                            ...
                            objSlrProc.GetArrearProcMst(intMonthNo, intYearNo, para.lblSalaryProcSystemId.Trim(), out dsSPMst);
                            ...
                            objSlrProc.GetArrearProcChild(intMonthNo, intYearNo, sEmpInfoSysID, out dsSPChd);
                            ...
                            #region Salary Head calculations
                            if (dsSelectedEmp.Tables[0].Rows.Count > 0)
                            {
                                ...
                                for (int gd = 0; gd < dsSelectedEmp.Tables[0].Rows.Count; gd++)
                                {
                                    ...
                                    if (dicLocal_Sub.Count > 0)
                                    {
                                        ...
                                        #region Actual Salary head calculations 
                                        ...
                                        for (int i = 0; i < dicLocal_Sub.Count; i++)
                                        {
                                            ...
                                            if (dicLocal_Sub[i].HeadCategory != "Total Earning" && dicLocal_Sub[i].HeadCategory != "Total Deduction")
                                            {
                                                ...
                                                if (ss == "SHD202056")//SHD202023 SHD202065
                                                {
                            ...
                            #region Load Monthly Bonus and PF
                            try
                            {
                                ...
                                Bnspara.ToDate = ArrearToDate;// para.ToDate;// FirstDayOfNextMonthFromDateTime(Convert.ToDateTime(para.ToDate)).ToString();
                                ...
                                PFpara.ToDate = ArrearToDate;// para.ToDate;// FirstDayOfNextMonthFromDateTime(Convert.ToDateTime(para.ToDate)).ToString();
                            ...
                            #endregion Load Monthly Bonus and PF
                            ...
                            #endregion Calculate Monthly Bonus and PF

                            #region Trimming and Polishing Salary Head values
                                ...
                                if (dicLocal_Sub.Count > 0)
                                {
                                    for (int i = 0; i < dicLocal_Sub.Count; i++)
                                    {
                                        ...
                                        if (string.IsNullOrEmpty(sFormulaDesID) == false && sFormulaDesID.Length > 0 && IsBaseOnNetPay)
                                        {
                                            ...
                                            if (dicdtValue != null)
                                            {
                                                dicdtValue[0].EarningAmount = DisbCur.ToString();
                                            }
                                            #endregion
                                        }//IsBaseOnNetPay
                                    }//for
                            ...
                            try
                            {
                                ...
                                ESICpara.ToDate = ArrearToDate;// FirstDayOfNextMonthFromDateTime(Convert.ToDateTime(para.ToDate)).ToString();
                    ...
                    #endregion Salary Process for each 100 employees
                }//For
            }
    ...
    void GetDS(List<ProcChild> list, out DataSet dsChild)
    {
        ...
        try
        {
            ...
            objsp.GetArrearProcChild(out dsChild);
    ...
    private void UpdateSlrProcMstDataRow(string OPN_FLAG, int IsCmpMonthSlr, ParamSalary param, FunctionPara fpara, ref DataRow drLocal)
    {
        try
        {
            ...
            drLocal["ArrearProcID"] = bplib.clsWebLib.RetValidLen(fpara.lblSalaryProcId.Trim());
            ...
            drLocal["ArrearProcDate"] = DateTime.Now;
