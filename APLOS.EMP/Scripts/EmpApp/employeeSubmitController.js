EmployeeSubmitController.$inject = ['$scope', '$http', '$location', "$rootScope", '$window', "$compile", 'baseService', '$cookies'];
function EmployeeSubmitController($scope, $http, $location, $rootScope, $window, $compile, baseService, $cookies) {
    $scope.title = 'Employee Submit';
    $scope.employees = [];
    ...
    $scope.getEmployeeData = function () {
        try {
            ...
            $scope.loadEmployeeData = function (pageno) {
                baseService.paginationBase('employee/getemployeebycompanygroupandsubmit?companyGroupId=' + $cookies.get('CompanyGroupId'), pageno, $scope.employeeParameters)
    ...
    $scope.getuserAccess = function (ob) {
        ...
        $scope.userAccessNew.Submit = ob.Submit;
    ...
    $scope.Save = function () {
        try {
            $http({
                method: "post",
                url: 'employee/updateemployeesubmit',
    ...
    $scope.clearuserAccess = function () {
        ...
        $scope.userAccessNew.Submit = null;
    };
