var aplosEmpApp = angular.module('aplosEmpApp', ['ngCookies', 'angularUtils.directives.dirPagination'])
    .controller('employeeController', employeeController)
    .controller('employeeAccessLoginController', EmployeeAccessLoginController)
    .controller('EmployeeSubmitController', EmployeeSubmitController)
    .controller('AdminUserAccessController', AdminUserAccessController)
    .controller('UserAccessRestrictionController', UserAccessRestrictionController)
    .controller('ChartController', ChartController)
    .controller('reportController', reportController)
    .run(['$rootScope', '$window', '$cookies', function ($rootScope, $window, $cookies) {
        $rootScope.logoFileName = $cookies.get('LogoFileName');
        $rootScope.EmployeeName = $cookies.get('EmployeeName');
        $rootScope.CompanyGroupId = $cookies.get('CompanyGroupId');
        $rootScope.EmployeeDocument = $cookies.get('DocumentFolderName');
    }])
