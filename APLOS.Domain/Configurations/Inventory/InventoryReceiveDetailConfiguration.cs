...
{
    public class InventoryReceiveDetailConfiguration : EntityTypeConfiguration<InventoryReceiveDetail>
    {
        public InventoryReceiveDetailConfiguration()
        {
            HasKey(t => t.Id);
            ...
            ToTable(nameof(InventoryReceiveDetail), DbSchema.Transaction);
