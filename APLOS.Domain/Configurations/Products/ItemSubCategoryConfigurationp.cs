...
{
    public class ItemSubCategoryConfiguration : EntityTypeConfiguration<ItemSubCategory>
    {
        public ItemSubCategoryConfiguration()
        {
            Ignore(r => r.ModelState);
            ToTable(nameof(ItemSubCategory), DbSchema.HKP);
            // Primary Key
            HasKey(t => t.Id);
