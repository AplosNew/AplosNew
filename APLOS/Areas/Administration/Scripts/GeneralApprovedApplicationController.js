'use strict';
GeneralApprovedApplicationController.$inject = ['accountService', 'addressService', '$window', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller', '$location'];
function GeneralApprovedApplicationController(accountService, addressService, $window, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller, $location) {
	...
	$scope.poAppAuth = function () {
		...
		{
			$scope.approvalUrl = 'Administration/GeneralCheckedApproved/UpdateApprovalStatusApplication';
