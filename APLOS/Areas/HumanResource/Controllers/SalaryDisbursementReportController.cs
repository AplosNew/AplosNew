...
namespace Aplos.Areas.HumanResource.Controllers
{
    public class SalaryDisbursementReportController : BaseController
    {
        ...
        {
            JsonResult json = Json(_sqlRepository.GetDataCollection(new clsSalaryLock().GetEmpInfoForSalaryDisbursement((CustomIdentity)Thread.CurrentPrincipal.Identity, effectiveDate, salaryProcessId, isActive, isSeperated, isMaternity)), JsonRequestBehavior.AllowGet);
