...
namespace Aplos.Areas.HumanResource.Controllers
{
    public class RestTypeController : BaseController
    {
        ...
        string TableName = "hkp.RestType";

        #region Constructor

        private readonly ISqlRepository _sqlRepository;
        public RestTypeController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.RestType wher Id = '" + Id + "' ");
        ...
        {
            string sql = @"select * from hkp.RestType where Id = '" + id + "'";
