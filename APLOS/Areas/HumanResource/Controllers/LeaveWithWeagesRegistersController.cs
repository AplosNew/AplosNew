...
namespace Aplos.Areas.HumanResource.Controllers
{
    public class LeaveWithWeagesRegistersController : BaseController
    {
        ...
        {
            var identity = (CustomIdentity)Thread.CurrentPrincipal.Identity;
            JsonResult json = Json(_AttendanceManagementService.GetLeaveEmpInfo(identity.CompanyGroupId, identity.PlantId, fromDate, toDate, criteria), JsonRequestBehavior.AllowGet);
