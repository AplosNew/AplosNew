...
namespace Aplos.Areas.HumanResource.Controllers
{
    ...
    public class RosterUpdatesController : BaseController
    {
        ...
        RosterUpdatesService rs = new RosterUpdatesService();
        public RosterUpdatesController(ISqlRepository sqlRepository)
        {
