'use strict';
salaryProcessedReportBudgetaryController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function salaryProcessedReportBudgetaryController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {
    ...
    $scope.GetEmployeeSalaryProcessedOTQtyAmountReport = function () {
        try {
            var parameters = [];
            ...
            $http({
                method: 'POST',
                url: 'humanresource/PayrollReports/GetEmployeeSalaryProcessedOTQtyAmountReport',
                data: {
                    'month': $scope.month,
                    'year': $scope.year,
