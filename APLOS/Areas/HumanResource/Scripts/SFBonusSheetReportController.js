'use strict';
SFBonusSheetReportController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService'];
function SFBonusSheetReportController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService) {
    ...
    $scope.GetBonusPoint = function () {
        $http({
            method: "GET",
            dataType: 'JSON',
            url: 'humanresource/SFBonusSheetReport/GetBonusPoint/'
    ...
    $scope.GetPayRegister = function () {
        try {
            ...
            $rootScope.report('humanresource/PayRegisterBDReport/GetPayRegisterReport?' + $scope.parameters);
        } catch (e) {
