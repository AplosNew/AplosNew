'use strict';
employeeShiftAssignController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$window'];
function employeeShiftAssignController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $window) {
    $rootScope.title = 'EmployeeShiftAssign';
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.EmployeeShiftAssigns = [];
    $scope.path = 'humanresource/employeeshiftassign/';
