'use strict';
EmployeeShiftUpdatesController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function EmployeeShiftUpdatesController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = 'Employee Shift Updates';
    $rootScope.title1 = 'Employee Shift Updates';
    $scope.Action = 'Save';
    var url = "humanresource/EmployeeShiftUpdates/";
    $scope.path = "humanresource/EmployeeShiftUpdates/";
  
    // Code For the Second Tab

    var x = document.getElementById("RosterShiftGrid");
    ...
    $scope.GetSample = function () {
        ...
        try {
            window.open('humanresource/EmployeeShiftUpdates/GetSampleReport?reportFormat=' + reportFormat, '_blank');
