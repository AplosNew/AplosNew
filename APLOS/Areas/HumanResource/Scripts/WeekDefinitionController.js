'use strict';
WeekDefinitionController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function WeekDefinitionController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = 'Week Off Updates';
    $rootScope.title1 = 'Week Off Updates';
    $scope.Action = 'Save';
    var url = "humanresource/WeekDefinition/";
    $scope.path = "humanresource/WeekDefinition/";
    ...
    $scope.GetSample = function () {
        ...
        try {
            window.open('humanresource/WeekDefinition/GetSampleReport?reportFormat=' + reportFormat, '_blank');
