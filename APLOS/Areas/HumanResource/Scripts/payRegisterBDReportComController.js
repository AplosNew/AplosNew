'use strict';
payRegisterBDReportComController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function payRegisterBDReportComController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {
    $rootScope.title = 'Pay Register';
    ...
    $scope.GetPayRegisterReport = function (reportType) {
        ...
        try {
            ...
            $http({
                method: 'POST',
                url: 'humanresource/PayRegisterBDReport/GetPayRegisterReportCom',
                data: {
                    'month': $scope.month,
                    'year': $scope.year,
    ...
    $scope.GetPaySlipRDLC = function () {
        ...
        try {
            ...
            $http({
                method: 'POST',
                url: 'humanresource/PayRegisterBDReport/GetPaySlipCompliance',
                data: {
                    'month': $scope.month,
                    'year': $scope.year,
                    'languageId': $scope.languageId,
