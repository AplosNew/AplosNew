'use strict';
salaryStructureSheetDailyController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function salaryStructureSheetDailyController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {
    ...
    $scope.GetEmployeeInformation = function () {
        ...
        //}
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'humanresource/PayrollReports/GetEmpInfoDaily',
                data: parameters
    ...
    $scope.GetEmployeeSalaryStructureDaily = function () {
        try {
            var parameters = [];
            ...
            $http({
                method: 'POST',
                url: 'humanresource/PayrollReports/GetEmployeeSalaryStructureDaily',
                data: {
                    'effectiveDate': $scope.effectiveDate,
                    'payRollGroup': $scope.payGroupListSelected,
                    'parameters': parameters,
                    'payDays': $scope.payDays
                }
            }).then(function successCallback(response) {
