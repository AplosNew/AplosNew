'use strict';
salaryStructureAndProcessedReportNewController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function salaryStructureAndProcessedReportNewController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {
    ...
    $scope.getYear = function () {
        ...
        var monthName = $scope.monthList.filter(function (mnth) {
            return mnth.Value == $scope.month;//intentinally given 
        });
    ...
    $scope.GetEmployeeSalaryStructureWithProceesd = function () {
        try {
            ...
            $http({
                method: 'POST',
                url: 'humanresource/PayrollReports/GetEmployeeSalaryStructureWithProceesdNew',
                data: {
                    'month': $scope.month,
                    'year': $scope.year,
