'use strict';
SalaryIntegrationWithThirdPartyController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function SalaryIntegrationWithThirdPartyController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {
    ...
    $scope.GetReport = function () {
        ...
        if (angular.isUndefinedOrNull($scope.year)) {
            ShowResult('Please select year', 'failure');
            return;
        }
