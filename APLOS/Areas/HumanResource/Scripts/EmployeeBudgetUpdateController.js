'use strict';
EmployeeBudgetUpdateController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function EmployeeBudgetUpdateController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = 'Roster Pattern Creation';
    $rootScope.title1 = 'Roster Pattern Planning';
    $scope.Action = 'Save';
    var url = "humanresource/EmployeeBudgetUpdate/";
    ...
    $scope.GetSample = function () {
        ...
        try {
            window.open('humanresource/EmployeeBudgetUpdate/GetSampleReport?plantId='+$scope.PlantId+'&name='+plantName+'&reportFormat=' + reportFormat, '_blank');
