'use strict';
SalarySheetBudgetaryOTController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function SalarySheetBudgetaryOTController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {
    ...
    $scope.GetEmployeeSalaryProcessedReport = function () {
        try {
            ...
            $http({
                method: 'POST',
                url: 'humanresource/PayrollReports/GetEmployeeSalaryProcessedReport',
                data: {
                    'month': $scope.month,
                    'year': $scope.year,
