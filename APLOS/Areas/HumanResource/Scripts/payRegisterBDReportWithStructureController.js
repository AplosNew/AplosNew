'use strict';
payRegisterBDReportWithStructureController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService'];
function payRegisterBDReportWithStructureController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService) {
    ...
    $scope.GetPayRegister = function () {
        try {
            ...
            $scope.parameters = 'month=' + $scope.month + '&year=' + $scope.year + '&salaryProcessId=' + $scope.salaryProcessId + '&divisionId=' + $scope.divisionId + '&unitId=' + $scope.unitId + '&sectionId=' + $scope.sectionId + '&subSectionId=' + $scope.subSectionId + '&departmentId=' + $scope.departmentId + '&payGroupId=' + $scope.payGroupId + '&paymentDate=' + $scope.paymentDate + '&isActive=' + $scope.isActive + '&isSeperated=' + $scope.isSeperated + '&isMaternity=' + $scope.isMaternity;
            location.href = 'humanresource/PayRegisterBDReport/EmployeeSalaryRegisterWithStructure?' + $scope.parameters;
        } catch (e) {
    ...
    $scope.GetPayRegisterBangla = function () {
        try {
            ...
            $scope.parameters = 'month=' + $scope.month + '&year=' + $scope.year + '&salaryProcessId=' + $scope.salaryProcessId + '&divisionId=' + $scope.divisionId + '&unitId=' + $scope.unitId + '&sectionId=' + $scope.sectionId + '&subSectionId=' + $scope.subSectionId + '&departmentId=' + $scope.departmentId + '&payGroupId=' + $scope.payGroupId + '&employeeCategoryId=' + $scope.employeeCategoryId + '&paymentDate=' + $scope.paymentDate + '&printDate=' + $scope.printDate + '&paymentMode=' + $scope.paymentMode + '&languageId=' + $scope.languageId + '&isActive=' + $scope.isActive + '&isSeperated=' + $scope.isSeperated + '&isMaternity=' + $scope.isMaternity;
            location.href = 'humanresource/PayRegisterBDReportWithStructure/GetPayRegisterReportBangla?' + $scope.parameters;
        } catch (e) {
            ShowResult(e, 'failure');
        }
    };
