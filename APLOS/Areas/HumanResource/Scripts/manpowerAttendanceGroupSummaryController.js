'use strict';
manpowerAttendanceGroupSummaryController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService'];
function manpowerAttendanceGroupSummaryController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService) {
    ...
    $scope.GetSummaryManpowerAttendanceGroupWiseExcel = function () {
        try {
            ...
            location.href = 'humanresource/ManpowerAttendanceSummary/GetSummaryManpowerAttendanceGroupWiseExcel?' + $scope.parameters;
        } catch (e) {
