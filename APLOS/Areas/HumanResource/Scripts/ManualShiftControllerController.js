'use strict';
ManualShiftController.$inject = ['fileReader', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$window', '$filter'];
function ManualShiftController(fileReader, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $window, $filter) {
    $rootScope.title = 'Manual Attendance';
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.preRecruitmentEmployees = [];
    $scope.path = 'HumanResource/ManualShift/';
    ...
    $scope.actionCompleteSingleEmployee = function (args) {
        try {
            if (args == "refresh" || args.requestType == "refresh") {
                ...
                var gridObj = null;
                try {
                    gridObj = $("#GridChangeAttendances").ejGrid("instance");
    ...
    $scope.actionCompleteSingleDay = function (args) {
        try {
            if (args == "refresh" || args.requestType == "refresh") {
                ...
                try {
                    gridObj = $("#GridChangeAttendanceBySingleDates").ejGrid("instance");
    ...
    //$scope.selectedshiftinfo = function (args)
    //{
    //    var gridObj = $("#GridChangeAttendances").ejGrid("instance");
