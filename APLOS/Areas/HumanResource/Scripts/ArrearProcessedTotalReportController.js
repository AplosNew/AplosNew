'use strict';
ArrearProcessedTotalReportController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function ArrearProcessedTotalReportController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {
    ...
    $scope.GetEmployeeInformation = function () {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'humanresource/PayrollReports/GetEmpInfoSalaryFromArrearPorcessed',
            data: { 'ArrearProcessBatchId': $scope.SelectedArrearProcessBatchId }
        }).then(function successCallback(response) {
    ...
    $scope.GetEmployeeSalaryProcessedReport = function () {
        try {
            ...
            $http({
                method: 'POST',
                url: 'humanresource/PayrollReports/GetEmployeeArrearTotalAndSalaryProcessedReportSalLogWise',
                data: {
                    'month': $scope.month,
                    'year': $scope.year,
                    ...
                    'ArrearBatchNo': $scope.SelectedArrearProcessBatchId,
