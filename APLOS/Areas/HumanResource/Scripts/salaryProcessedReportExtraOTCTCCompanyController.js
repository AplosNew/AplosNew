'use strict';
salaryProcessedReportExtraOTCTCCompanyController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function salaryProcessedReportExtraOTCTCCompanyController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {
    ...
    $scope.GetEmployeeInformation = function () {
        ...
        if (angular.isUndefinedOrNull($scope.year)) {
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'humanresource/PayrollReports/GetEmpInfoSalaryPorcessedCompany',
                data: parameters
    ...
    $scope.GetEmployeeSalaryProcessedReport = function () {
        try {
            ...
            $http({
                method: 'POST',
                url: 'humanresource/PayrollReports/GetSalarySheetExtraOTCTCReportCompany',
                data: {
                    'month': $scope.month,
                    'year': $scope.year,
