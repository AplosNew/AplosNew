'use strict';
leaveEncashmentController.$inject = ['fileReader', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'cboService', '$window', 'toaster'];
function leaveEncashmentController(fileReader, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, cboService, $window, toaster)
{
    ...
    $scope.EmpEncashReportPrint = function () {
        try {
           // CheckField($scope.EmpEncashReport.FromDate, "From Date");
            CheckField($scope.EmpEncashReport.ToDate, "To Date");
            var _fromdate = new Date($scope.EmpEncashReport.FromDate);
            var _todate = new Date($scope.EmpEncashReport.ToDate);
           /* var empcount = ($scope.EmpEncashReport.selectedemployeeList.EmployeeCode)*/;
            ...
            //}
            location.href = 'humanresource/MaternityLeaveTransaction/EmpEncashReport?fromDate=' + $scope.EmpEncashReport.FromDate + '&toDate=' + $scope.EmpEncashReport.ToDate + '&plantId=' + $scope.EmpEncashReport.PlantId;
    ...
    $scope.EmpEncashReportPrintOld = function () {
        try {
            // CheckField($scope.EmpEncashReport.FromDate, "From Date");
            CheckField($scope.EmpEncashReport.ToDate, "To Date");
            var _fromdate = new Date($scope.EmpEncashReport.FromDate);
           ...
           /* var empcount = ($scope.EmpEncashReport.selectedemployeeList.EmployeeCode)*/;
            ...
            //    throw "From Date [" + fromdate + "] can not be greater than To Date [" + todate + "]";
            //}
            location.href = 'humanresource/MaternityLeaveTransaction/EmpEncashReportOld?fromDate=' + $scope.EmpEncashReport.FromDate + '&toDate=' + $scope.EmpEncashReport.ToDate + '&plantId=' + $scope.EmpEncashReport.PlantId;
