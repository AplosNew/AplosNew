'use strict';
attendanceProcessDataEntityWiseController.$inject = ['fileReader', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$window', '$filter'];
function attendanceProcessDataEntityWiseController(fileReader, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $window, $filter) {
    $rootScope.title = 'Manual Attendance Entity Wise';
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.preRecruitmentEmployees = [];
    $scope.path = 'HumanResource/attendanceProcessDataEntityWise/';
    ...
    $scope.getAllEntities = function () {
        $http({
            method: 'POST',
            url: 'HumanResource/attendanceProcessDataEntityWise/GetEntity'
    ...
    $scope.getAllEmployee = function () {
        ...
        try {
            ...
            //var EntityList = $('#EntityList').ejDropDownList("getCheckedItems");
    ...
    //$scope.selectedshiftinfo = function (args)
    //{
    //    var gridObj = $("#GridChangeAttendance").ejGrid("instance");
