'use strict';
payRegisterBDReportNewController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function payRegisterBDReportNewController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {
    ...
    $scope.GetPayRegisterReport = function (reportType) {
        ...
        try {
            ...
            $http({
                method: 'POST',
                url: 'humanresource/PayRegisterBDReport/GetPayRegisterReportNew',
                data: {
                    'month': $scope.month,
                    'year': $scope.year,
