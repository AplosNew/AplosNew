...
namespace Aplos.Areas.Farming.Controllers
{
    public class CropCategoryController  : BaseController
    {
        ...
        string TableName = "hkp.CropCategory";
        //authentication for
        ...
        public CropCategoryController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.CropCategory where Id = '" + Id + "' ");
        ...
        private string GetPK()
        {
            ...
            objGenID.GenerateIDYearly(DateTime.Now.ToShortDateString().ToString(), "CropCategory", out sID);
            return sID;
        }
