...
{
    public class CropRateLocationController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.CropRateLocation";
        //authentication for
        ...
        public CropRateLocationController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.CropRateLocation where Id = '" + Id + "' ");
        ...
        private string GetPK()
        {
            ...
            objGenID.GenerateIDYearly(DateTime.Now.ToShortDateString().ToString(), "CropRateLocation", out sID);
            return sID;
        }
