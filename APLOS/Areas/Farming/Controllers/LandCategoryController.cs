...
namespace Aplos.Areas.Farming.Controllers
{
    public class LandCategoryController  : BaseController
    {
        ...
        string TableName = "hkp.LandCategory";
        //authentication for
        ...
        public LandCategoryController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.LandCategory where Id = '" + Id + "' ");
        ...
        private string GetPK()
        {
            ...
            objGenID.GenerateIDYearly(DateTime.Now.ToShortDateString().ToString(), "LandCategory", out sID);
            return sID;
        }
