...
{
    public class CropTypeController  : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.CropType";
        //authentication for
        ...
        public CropTypeController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.CropType wher Id = '" + Id + "' ");
        ...
        private string GetPK()
        {
            ...
            objGenID.GenerateIDYearly(DateTime.Now.ToShortDateString().ToString(), "CropType", out sID);
            return sID;
        }
