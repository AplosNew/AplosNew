...
{
    public class FarmingProcessController  : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.FarmingProcess";
        //authentication for
        ...
        public FarmingProcessController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.FarmingProcess where Id = '" + Id + "' ");
        ...
        private string GetPK()
        {
            ...
            objGenID.GenerateIDYearly(DateTime.Now.ToShortDateString().ToString(), "FarmingProcess", out sID);
            return sID;
        }
