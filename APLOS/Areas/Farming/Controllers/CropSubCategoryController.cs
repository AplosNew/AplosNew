...
{
    public class CropSubCategoryController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.CropSubCategory";
        //authentication for
        ...
        public CropSubCategoryController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.CropSubCategory where Id = '" + Id + "' ");
        ...
        private string GetPK()
        {
            ...
            objGenID.GenerateIDYearly(DateTime.Now.ToShortDateString().ToString(), "CropSubCategory", out sID);
            return sID;
        }
