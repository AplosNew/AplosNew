...
namespace Aplos.Areas.Farming.Controllers
{
    public class TransactionTypeController : BaseController
    {
        ...
        string TableName = "dbo.TransactionType";
     
        #region Constructor

        private readonly ISqlRepository _sqlRepository;
        public TransactionTypeController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from dbo.TransactionType where Id = '" + Id + "' ");
        ...
        private string GetPK()
        {
            ...
            objGenID.GenerateIDYearly(DateTime.Now.ToShortDateString().ToString(), "TransactionType", out sID);
            return sID;
        }
