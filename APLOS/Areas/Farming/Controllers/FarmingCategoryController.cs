...
{
    public class FarmingCategoryController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.FarmingCategory";
        //authentication for
        ...
        public FarmingCategoryController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.FarmingCategory where Id = '" + Id + "' ");
        ...
        private string GetPK()
        {
            ...
            objGenID.GenerateIDYearly(DateTime.Now.ToShortDateString().ToString(), "FarmingCategory", out sID);
            return sID;
        }
