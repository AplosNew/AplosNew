'use strict';
PackingInvoiceController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function PackingInvoiceController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    ...
    $scope.GetPackingListPopUp = function () {
        ...
        $http({
            method: 'GET',
            url: "Productions/Packing/getgridPacking"
    ...
    $scope.SetPackingList = function (obj) {
        var ob = {};
        ob.PackingId = obj.data.PackingId;
        ob.Entity = obj.data.Entity;
        $scope.salesVM.EntityId = obj.data.EntityId;
        ob.Customer = obj.data.Customer;
        ob.CustomerId = obj.data.CustomerId;
        $scope.salesVM.PartyName = obj.data.Customer;
        $scope.salesVM.PartyId = obj.data.CustomerId;
        ob.StorageLoc = obj.data.StorageLoc;
        ob.ByWhom = obj.data.ByWhom;
        ob.DRespPerson = obj.data.DRespPerson;
        ob.AddedDate = obj.data.AddedDate;
        ob.InActiveDate = obj.data.InActiveDate;
