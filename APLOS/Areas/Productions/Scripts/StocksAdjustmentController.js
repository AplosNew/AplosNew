'use strict';
StocksAdjustmentController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function StocksAdjustmentController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = 'Stocks Adjustment';
    $scope.Action = 'Save';
    var url = "Productions/StocksAdjustment/";
    $scope.path = "Productions/StocksAdjustment/";

    // Code For the Second Tab

    var x = document.getElementById("CurrTab");
    ...
    $scope.GetSample = function () {
        ...
        try {
            window.open('productions/StocksAdjustment/GetSampleReport?reportFormat=' + reportFormat, '_blank');
