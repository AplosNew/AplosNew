'use strict';
buttonRecipeConfigController.$inject = ['$window', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter'];
function buttonRecipeConfigController($window, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter) {
    $rootScope.title = "Recipe Configuration";
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.modelList = [];
    $scope.path = 'Productions/ButtonRecipeConfig/';
