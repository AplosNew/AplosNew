'use strict';
PackingScanDataController.$inject = ['$scope', '$http', '$location', "$rootScope", '$window', "$compile", 'baseService', 'fileReader', "$controller", "$filter"];
function PackingScanDataController($scope, $http, $location, $rootScope, $window, $compile, baseService, fileReader, $controller, $filter) {
