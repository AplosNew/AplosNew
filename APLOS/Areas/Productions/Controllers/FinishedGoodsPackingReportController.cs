...
namespace Aplos.Areas.Productions.Controllers
{
    public class FinishedGoodsPackingReportController : BaseController
    {
        ...
        [HttpPost, Authorize]
        public ActionResult GetFinishedStocksReport(string ToDate, string FromDate)
        {
            try
            {
                var identity = (CustomIdentity)Thread.CurrentPrincipal.Identity;

                var fileName = DateTime.Now.ToString("yy-MM-dd") + " " + "FinishedGoodsPackingReport.xlsx";
                string fullPath = System.Web.Hosting.HostingEnvironment.MapPath("~/") + fileName;
                var workbook = GetFinishedStocksReportForm(ToDate, FromDate);
        ...
        public string GetFinishedStocksReportForm(string ToDate, string FromDate)
        {
            try
            {
                #region Variable
                ...
                try
                {
                    ...
                    var data = det.GetFinishedGoodsPackingReport(ToDate, FromDate);
