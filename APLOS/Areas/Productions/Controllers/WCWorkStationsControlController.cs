...
{
    public class WCWorkStationsControlController : BaseController
    {
        ...
        public WCWorkStationsControlController(IProductionSummaryService ProductionSummaryService, ISqlRepository sqlRepository, IPKGeneratorService pkGeneratorService)
        {
