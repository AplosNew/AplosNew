...
{
	public class RecipeConfigController : BaseController
	{
		#region Constructor
		private readonly IRecipeConfigService _btnRecipeConfigService;

		public RecipeConfigController(IRecipeConfigService btnRecipeConfigService)
		{
		...
		[HttpPost]
		public JsonResult Create(RecipeConfig entity)
		{
		...
		[HttpPost]
		public JsonResult Edit(RecipeConfig entity)
		{
