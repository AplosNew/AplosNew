...
{
    public class SyncURLController : BaseController
    {
        #region Constructor
        ...
        string TableName = "AplosAuthentication";
        ...
        public ActionResult GetList(string column, string value)
        {
            ...
            string sql = @"SELECT * FROM " + TableName + " WHERE " + strkey + " ";
