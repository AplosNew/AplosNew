...
function SalesReturnController(accountService, $window, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $controller) {
    ...
    function getIssueDetailList() {
        if ($scope.productNew.Id == null) {
            $scope.returnDetailurl = 'SalesManagements/Sales/GetSalesDetailDataBySales?salesId=' + $scope.productNew.InventorySalesId
        } else {
    ...
    function getInvTaxList() {
        if ($scope.productNew.Id == null) {
            $scope.returnTaxurl = 'SalesManagements/Sales/GetMaterialSalesTaxDetail?salesId=' + $scope.productNew.InventorySalesId
        } else {
