"use strict";
salesPackingPostController.$inject = ["cboService", "commonMessage", '$window', "$scope", "$rootScope", "baseService", "$http", "$filter", "$controller", "accountService"];
function salesPackingPostController(cboService, commonMessage, $window, $scope, $rootScope, baseService, $http, $filter, $controller, accountService) {
    $rootScope.title = "Master Order Sales Packing Posting";
    $scope.Action = "Save";
    $scope.index = -1;
