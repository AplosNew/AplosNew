'use strict';
UpdateCompanyController.$inject = ["addressService", 'fileReader', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'cboService'];
function UpdateCompanyController(addressService, fileReader, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, cboService) {
    ...
    $scope.company = {
        ...
        EstedDate: null,
        PKPrefixField: null,
        IsVoucherFromBudget: null,
        IsQualificationDoc: true,
        IsTrainingDoc: true,
        IsExperienceDoc: true,
        Image: null,
        WebDomain: null,
