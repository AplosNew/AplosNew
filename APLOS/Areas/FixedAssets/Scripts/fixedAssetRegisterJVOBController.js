"use strict";
fixedAssetRegisterJVOBController.$inject = ["addressService", "commonMessage", "$scope", "$rootScope", "baseService", "cboService", "$http", "$filter", "$controller", "$window"];
function fixedAssetRegisterJVOBController(addressService, commonMessage, $scope, $rootScope, baseService, cboService, $http, $filter, $controller, $window) {
    ...
    baseService.init('fixedassets/fixedassetregister/getlist', null, null, "DESC", "FixedAssetMasterName", "FixedAssetMasterName");
    ...
    $scope.getWithFAM = function () {
        $http({
            method: "GET",
            url: $scope.path + "GetJVOBRegisterInfoWithFAMId?fixedAssetMasterId=" + $scope.register.FixedAssetMasterId + "&budgetMasterId=" + $scope.register.AssetBudgetMasterId + "&assetGLId=" + $scope.register.AssetGLId + "&activityId=" + $scope.register.AssetActivityId + "&companyId=" + $scope.register.CompanyId
        }).then(function successCallback(response) {
            $scope.getDataWithFAM = {
                ADBaseAmountTotal: 0,
                ADGroupAmountTotal: 0,
    ...
    $scope.getOpeningWithFAM = function () {
        $http({
            method: "GET",
            url: $scope.path + "GetJVOpeningBalanceFixedAssetItem?fixedAssetMasterId=" + $scope.register.FixedAssetMasterId+ "&assetGLId=" + $scope.register.AssetGLId + "&assetBudgetId=" + $scope.register.AssetBudgetMasterId
    ...
    $scope.SaveRegister = function () {
        try {
            ...
            if ($scope.form0.$valid) {
                ...
                $http({
                    method: "POST",
                    url: $scope.path + "CreateRegisterJVOB",
                    dataType: "JSON",
                    data: {
                        "register": $scope.register, "NumberOfQuantity": $scope.parsetNOQtoNumber
    ...
    $scope.checkIsRegisterApplyInUpdate = function (id) {
        ...
        $http({
            method: "GET",
            url: "FixedAssets/FixedAssetRegister/CheckFixedMasterIsRegisterApplyByOBJV?assetMasterId=" + id
        }).then(function successCallback(response) {
            $scope.IsRegisterApplyList = response.data;
        });
    };
