...
{
    public class AssetWIPStatusController : BaseController
    {
        ...
        public AssetWIPStatusController(
        ...
        {
            return View("~/Areas/FixedAssets/Views/AssetWIPStatusReport.cshtml");
        }
        #region GL vs Fa
       ...
       [HttpGet, Authorize]
        ...
        public ActionResult AssetWIPStatus()
        {
            return View("~/Areas/FixedAssets/Views/AssetWIPStatusReport.cshtml");
        }
