'use strict';
employeeLeaveBalanceController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function employeeLeaveBalanceController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    ...
    $scope.Update = function () {
        try {
            ...
            $http({
                method: 'POST',
                url: 'employees/employeeLeaveBalance/Update',
    ...
    $scope.loadNewEmployee = function () {
        ...
        $scope.popUpUrl = 'employees/employeeLeaveBalance/ActiveEmployeeList?plantId=' + $scope.EmployeeLeaveBalance.PlantId;
