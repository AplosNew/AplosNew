'use strict';
hrDashboardtrController.$inject = ['fileReader', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$cookies', '$window'];
function hrDashboardtrController(fileReader, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $cookies, $window) {
    ...
    $scope.GetGruopWiseConsecutiveAbsentLateStatus = function () {
        ...
        $http({
            method: 'GET',
            url: 'Employees/HRDashboardtr/ConsecutiveAbsentStats/',
        ...
        $http({
            method: 'GET',
            url: 'Employees/HRDashboardtr/ConsecutiveLateStats/',
            params: { 'hrDate': $scope.hrDate },
            dataType: 'JSON'
        }).then(function successCallback(response) {
    ...
    $scope.EmpCategory = function (EmplyeeTypeOrCategoryId) {
        ...
        $http({
            method: 'GET',
            url: 'Employees/HRDashboardtr/DefaultAttnStatus/',
        ...
        $http({
            method: 'GET',
            url: 'Employees/HRDashboardtr/HROverAllStatusDefault/',
            params: { 'hrDate': $scope.hrDate, 'EmplyeeTypeOrCategoryId': $scope.hrDrpDownModel.EmplyeeTypeOrCategoryId },
            dataType: 'JSON'
        }).then(function successCallback(response) {
        ...
        $http({
            method: 'GET',
            url: 'Employees/HRDashboardtr/JoiningStatusDaily/',
            params: { 'hrDate': $scope.hrDate, 'EmplyeeTypeOrCategoryId': $scope.hrDrpDownModel.EmplyeeTypeOrCategoryId },
            dataType: 'JSON'
        }).then(function successCallback(response) {
        ...
        $http({
            method: 'GET',
            url: 'Employees/HRDashboardtr/AbsentismStatusDaily/',
            params: { 'hrDate': $scope.hrDate, 'EmplyeeTypeOrCategoryId': $scope.hrDrpDownModel.EmplyeeTypeOrCategoryId },
            dataType: 'JSON'
        }).then(function successCallback(response) {
        ...
        $http({
            method: 'POST',
            url: 'Employees/HRDashboardtr/LeaveStatus/',
            data: {
                'hrDate': $scope.hrDate,
                'EmplyeeTypeOrCategoryId': $scope.hrDrpDownModel.EmplyeeTypeOrCategoryId
            },
        ...
        $http({
            method: 'GET',
            url: 'HRDashboardtr/HRLongAbsentismDefault/',
            params: {
                'hrDate': $scope.hrDate,
                'EmplyeeTypeOrCategoryId': $scope.hrDrpDownModel.EmplyeeTypeOrCategoryId
            },
    ...
    function getDrillDownList(companyId) {
        ...
        $http({
            method: 'GET',
            url: 'Employees/HRDashboardtr/OrgStructureListColList?CompanyId=' + companyId,
            dataType: 'JSON'
        }).then(function successCallback(response) {
    ...
    function getDrillDownListWithCompany(companyId) {
        $http({
            ...
            if ($scope.index + 3 < $scope.ColList.length) {
                $http({
                    method: 'POST',
                    url: 'Employees/HRDashboardtr/DrillDownAttnStatus/',
                    data: {
                ...
                $http({
                    method: 'POST',
                    url: 'Employees/HRDashboardtr/HROverAllStatusDynamic/',
                    data: {
                        'ChartColumnList': $scope.ColList,
                        'seq': $scope.index,
                        'hrDate': $scope.hrDate,
                ...
                $http({
                    method: 'POST',
                    url: 'Employees/HRDashboardtr/ConsecutiveAbsentStatsDynamic/',
                    data: {
                        'ChartColumnList': $scope.ColList,
                        'seq': $scope.index,
                        'hrDate': $scope.hrDate,
                ...
                $http({
                    method: 'POST',
                    url: 'Employees/HRDashboardtr/ConsecutiveLateStatsDynamic/',
                    data: {
                        'ChartColumnList': $scope.ColList,
                        'seq': $scope.index,
                        'hrDate': $scope.hrDate,
                ...
                $http({
                    method: 'POST',
                    url: 'Employees/HRDashboardtr/DynamicJoiningOrSeparationStatusDaily/',
                    data: {
                        'ChartColumnList': $scope.ColList,
                        'seq': $scope.index,
                        'hrDate': $scope.hrDate,
                ...
                $http({
                    method: 'POST',
                    url: 'Employees/HRDashboardtr/DynamicAbsentismStatusDaily/',
                    data: {
                        'ChartColumnList': $scope.ColList,
                        'seq': $scope.index,
                        'hrDate': $scope.hrDate,
                ...
                $http({
                    method: 'POST',
                    url: 'Employees/HRDashboardtr/DynamicLeaveStatus/',
                    data: {
                        'ChartColumnList': $scope.ColList,
                        'seq': $scope.index,
                        'hrDate': $scope.hrDate,
    ...
    $scope.GetChartColList = function () {
        $scope.ADGLUrl = 'Employees/HRDashboardtr/GetchartColumnList';
    ...
    $scope.ModalIncrementDue = function (data) {
        ...
        $http({
            method: 'POST',
            url: 'Employees/HRDashboardtr/ListOfIncrementDue/',
    ...
    $scope.ModalProbation = function (data) {
        ...
        $http({
            ...
            url: 'Employees/HRDashboardtr/ListProbationOverDue/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
    ...
    $scope.ModalResignation = function (data) {
        ...
        $http({
            method: 'POST',
            url: 'Employees/HRDashboardtr/ListSeparationStatus/',
            data: { 'ChartColumnList': $scope.ColList, 'seq': $scope.stIndex, 'condition': data, 'hrDate': $scope.hrDate, 'EmplyeeTypeOrCategoryId': $scope.hrDrpDownModel.EmplyeeTypeOrCategoryId },
            dataType: 'JSON'
        }).then(function successCallback(response) {
    ...
    $scope.ModalConsecutiveLate = function () {
        ...
        $http({
            method: 'POST',
            url: 'Employees/HRDashboardtr/ModalConsecutiveLateStats/',
    ...
    $scope.ModalConsecutiveAbsent = function () {
        ...
        $http({
            method: 'POST',
            url: 'Employees/HRDashboardtr/ModalConsecutiveAbsentStats/',
            data: { 'ChartColumnList': $scope.ColList, 'seq': $scope.stIndex, 'hrDate': $scope.hrDate, 'EmplyeeTypeOrCategoryId': $scope.hrDrpDownModel.EmplyeeTypeOrCategoryId },
            dataType: 'JSON'
        }).then(function successCallback(response) {
    ...
    $scope.GetModalHROnRoleStatusDetailList = function (pageno, data) {
        ...
        $http({
            ...
            dataType: 'JSON',
            //url: $scope.getSearchListUrl,
            url: 'Employees/HRDashboardtr/ModalOnRoleEmployeeList/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
    ...
    $scope.GetModalHRDailyPresentStatusDetailList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalHRDailyPresentStatusList/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
    ...
    $scope.GetModalHRDailyAbsentStatusDetailList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalHRDailyAbsentStatusList/',
            data: parameters
        }).then(function successCallback(response) {
    ...
    $scope.actionCompleteSearchLongAbsentism = function () {
        if (args.requestType == "refresh") {
    ...
    $scope.GetModalHRLongAbsentismDetailList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalLongAbsenteismStatusList/',
            data: parameters
        }).then(function successCallback(response) {
    ...
    $scope.GetModalHRDailyLateStatusList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalHRDailyLateStatusList/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
    ...
    $scope.GetModalHRDailyLeaveStatusDetailList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalHRDailyLeaveStatusList/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
    ...
    $scope.GetModalHRDailyShiftNotAssignedStatusList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalHRDailyShiftNotAssignedStatusList/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
    ...
    $scope.GetModalWeekOffList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalHRDailyOffDayStatusList/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
    ...
    $scope.XGetModalWeekOffList = function (pageno, data) {
        ...
        baseService.paginationPost('Employees/HRDashboardtr/ModalHRDailyOffDayStatusList/', formData)
    ...
    $scope.GetModalHRDailyAttdnNotProcessedStatusList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalHRDailyAttdnNotProcessedStatusList/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
    ...
    $scope.GetOtherModalDetailJS = function (data) {
        ...
        $http({
            method: 'POST',
            url: 'Employees/HRDashboardtr/ModalOthersDetail/',
    ...
    $scope.GetModalHRDailyLateInStatusDetailList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalHRDailyLateInStatusList/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
                if (baseService.arrayLength($scope.searchbyLeaveEmpList) === 0) {
    ...
    $scope.GetModalHRDailyEarlyOutStatusDetailList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalHRDailyEarlyOutStatusList/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
                if (baseService.arrayLength($scope.searchbyLeaveEmpList) === 0) {
    ...
    $scope.GetModalHRDailyLunchOutStatusDetailList = function (pageno, data) {
        ...
        $http({
            method: "POST",
            dataType: 'JSON',
            url: 'Employees/HRDashboardtr/ModalHRDailyLunchOutStatusList/',
            data: parameters
        }).then(function successCallback(response) {
            if (response.data.length > 0) {
                if (baseService.arrayLength($scope.searchbyLeaveEmpList) === 0) {
    ...
    $scope.getModalEmployeeSummaryJS = function (pageno) {
        var parameters = { 'ChartColumnList': $scope.ColList, 'seq': $scope.stIndex, 'EmplyeeTypeOrCategoryId': $scope.mpDrpDownModel.EmplyeeTypeOrCategoryId };
    ...
    //else
    //{
    //    $scope.secondDivTitle = "";
    //}
    //----------------------------------Absent-------------------------------------------------//
    //$scope.dateWiseAbsentListParam = {
    //    limit: 10,
    //    offset: 0,
    //    order: 'desc',
    //    sort: 'AbsentDays',
    ...
    $scope.GetGruopWiseDateWiseAbsentStatus = function () {
        ...
        if ($scope.hrJSFromDate === "" || $scope.hrJSFromDate === undefined) {
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'Employees/HRDashboardtr/DateWiseAbsentList',
                data: {
    ...
    //var conLateTable = document.getElementById("conLateTable");
    //conLateTable.style.display = "none";
    //----------------------------Absent End--------------------------------------------------------//
    //----------------------------------Late---------------------------------------------------//
    ...
    $scope.GetGruopWiseDateWiseLateStatus = function () {
        ...
        //}
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'Employees/HRDashboardtr/DateWiseLatetListStatus',
                data: {
            ...
            //$scope.GLUrl = 'Employees/HRDashboardtr/DateWiseLatetListStatus?companyId=' + $scope.companyId + "&plantId=" + $scope.plantId + "&hrFromDate=" + $scope.hrLateJSFromDate + "&hrToDate=" + $scope.hrLateJSToDate + "&dayCount=" + $scope.dayCountlate + " &comparator=" + $scope.lateComparator + "";
            //baseService.setCurrentPage('DateWiseLateStatusList');
            //$scope.DateWiseLateStatusList = [];
            //$scope.GetGruopWiseDateWiseLateStatusPg = function (pageno) {
            //    baseService.paginationBase($scope.GLUrl, pageno, $scope.dateWiseLateListParam)
            //        .then(function (data) {
            //            $scope.DateWiseLateStatusList = data.Rows;
            //            $scope.dateWiseLateListParam.total_count = data.Total;
            //        }, function () {
            //            ShowResult(commonMessage.NetworkError, 'failure');
            //        }).finally(function () {
            //        });
            //};
            //$scope.GetGruopWiseDateWiseLateStatusPg();
        }
    };
    ...
    $scope.GetGruopWiseDateWiseJoinStatus = function () {
        ...
        if ($scope.companyId === "" || $scope.companyId === undefined || $scope.companyId === null) {
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'Employees/HRDashboardtr/DateJoiningStatus',
                data: {
            ...
            //$scope.GLUrl = 'Employees/HRDashboardtr/DateJoiningStatus?companyId=' + $scope.companyId + "&plantId=" + $scope.plantId + "&hrFromDate=" + $scope.hrJoiningJSFromDate + "&hrToDate=" + $scope.hrJoiningJSToDate + "";
            //baseService.setCurrentPage('DateWiseJoiningStatusList');
            //$scope.DateWiseJoiningStatusList = [];
            //$scope.GetGruopWiseDateWiseJoiningStatusPg = function (pageno) {
            //    baseService.paginationBase($scope.GLUrl, pageno, $scope.dateWiseJoiningListParam)
            //        .then(function (data) {
            //            $scope.DateWiseJoiningStatusList = data.Rows;
            //            $scope.dateWiseJoiningListParam.total_count = data.Total;
            //        }, function () {
            //            ShowResult(commonMessage.NetworkError, 'failure');
            //        }).finally(function () {
            //        });
            //};
            //$scope.GetGruopWiseDateWiseJoiningStatusPg();
        }
    };
    ...
    $scope.GetGruopWiseDateWiseSeparationStatus = function () {
        ...
        if ($scope.companyId === "" || $scope.companyId === undefined || $scope.companyId === null) {
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'Employees/HRDashboardtr/DateSepartaionStatus',
                data: {
            ...
            //$scope.GLUrl = 'Employees/HRDashboardtr/DateSepartaionStatus?companyId=' + $scope.companyId + "&plantId=" + $scope.plantId + "&hrFromDate=" + $scope.hrSepartionJSFromDate + "&hrToDate=" + $scope.hrSeparationJSToDate + "";
            //baseService.setCurrentPage('DateWiseSeparationList');
            //$scope.DateWiseSeparationList = [];
            //$scope.GetGruopWiseDateWiseSeparationPg = function (pageno) {
            //    baseService.paginationBase($scope.GLUrl, pageno, $scope.dateWiseSaparaionListParam)
            //        .then(function (data) {
            //            $scope.DateWiseSeparationList = data.Rows;
            //            $scope.dateWiseSaparaionListParam.total_count = data.Total;
            //        }, function () {
            //            ShowResult(commonMessage.NetworkError, 'failure');
            //        }).finally(function () {
            //        });
            //};
            //$scope.GetGruopWiseDateWiseSeparationPg();
        }
    ...
    $scope.GetResponsiblePersonWiseAttdnStatus = function () {
        ...
        if ($scope.companyId === "" || $scope.companyId === undefined || $scope.companyId === null) {
            ...
            $scope.GLUrl = 'Employees/HRDashboardtr/ROPersonWiseAttnStatus?companyId=' + $scope.companyId + "&plantId=" + $scope.plantId + "&hrFromDate=" + $scope.hrRespPerJSFromDate + "&hrToDate=" + $scope.hrRespPerJSToDate + "&reportingPersonId=" + $scope.reportingPersonId + "";
    ...
    $scope.ModalORDivGetReportingPersonWisePresentEmployee = function () {
        ...
        $scope.GetReportingPersonWisePresentEmployee = function (pageno) {
            ...
            baseService.paginationBase('Employees/HRDashboardtr/ROPersonWisePresentStatusList', pageno, $scope.paramReportingPersonWisePresentEmployee)
                .then(function (data) {
    ...
    $scope.ModalORDivGetReportingPersonWiseAbsentEmployee = function () {
        ...
        $scope.GetReportingPersonWiseAbsentEmployee = function (pageno) {
            ...
            baseService.paginationBase('Employees/HRDashboardtr/ROPersonWiseAbsentStatusList', pageno, $scope.paramReportingPersonWiseAbsentEmployee)
                .then(function (data) {
    ...
    $scope.ModalORDivGetReportingPersonWiseLateEmployee = function () {
        ...
        $scope.GetReportingPersonWiseLateEmployee = function (pageno) {
            ...
            baseService.paginationBase('Employees/HRDashboardtr/ROPersonWiseLatetStatusList', pageno, $scope.paramReportingPersonWiseLateEmployee)
                .then(function (data) {
    ...
    $scope.ModalORDivGetReportingPersonWiseLeaveEmployee = function () {
        ...
        $scope.GetReportingPersonWiseLeaveEmployee = function (pageno) {
            ...
            baseService.paginationBase('Employees/HRDashboardtr/ROPersonWiseLeavetStatusList', pageno, $scope.paramReportingPersonWiseLeaveEmployee)
                .then(function (data) {
    ...
    $scope.ModalORDivGetReportingPersonWiseWeekOffHolidayEmployee = function () {
        ...
        $scope.GetROPersonWiseWeekOffHolidayEmployee = function (pageno) {
            ...
            baseService.paginationBase('Employees/HRDashboardtr/ROPersonWiseWeekOffHolidayStatusList', pageno, $scope.paramReportingPersonWiseWeekOffHolidayEmployee)
                .then(function (data) {
    ...
    $scope.ModalORDivGetReportingPersonShiftNotAssignEmployee = function () {
        ...
        $scope.GetROPersonWiseShiftNotAssignEmployeeEmployee = function (pageno) {
            ...
            baseService.paginationBase('Employees/HRDashboardtr/ModalROPHRDailyShiftNotAssignedStatusList', pageno, $scope.paramReportingPersonWiseShiftNotAssignEmployee)
                .then(function (data) {
    ...
    $scope.ModalORDivGetReportingPersonAttdnNotProcessedEmployee = function () {
        ...
        $scope.GetROPersonWiseAttdnNotProcessedEmployee = function (pageno) {
            ...
            baseService.paginationBase('Employees/HRDashboardtr/ModalROHRDailyAttdnNotProcessedStatusList', pageno, $scope.paramReportingPersonWiseAttdnNotProcessedEmployee)
                .then(function (data) {
    ...
    $scope.ModalEmpWiseDate = function (data) {
        ...
        $scope.ADGLUrl = 'Employees/HRDashboardtr/ModalEmployeeWiseAbsentDateList?companyId=' + $scope.companyId + "&plantId=" + $scope.plantId + "&hrFromDate=" + $scope.hrJSFromDate + "&hrToDate=" + $scope.hrJSToDate + "&employeeCode=" + data.EmployeeCode + "&dayCount=" + $scope.dayCount + "&comparator=" + $scope.absentComparator + "";
    ...
    $scope.ModalLateEmpWiseDate = function (data) {
        $scope.ADGLUrl = 'Employees/HRDashboardtr/ModalEmployeeWiseLateDateList?companyId=' + $scope.companyId + "&plantId=" + $scope.plantId + "&hrFromDate=" + $scope.hrLateJSFromDate + "&hrToDate=" + $scope.hrLateJSToDate + "&employeeCode=" + data.EmployeeCode + "&dayCount=" + $scope.dayCount + "&comparator=" + $scope.absentComparator + "";
        $scope.label = data.EmployeeName;
        $scope.empCode = data.EmployeeCode;
        $http({
            method: 'GET',
    ...
    $scope.ModalConsecutiveAbsentDateList = function (data) {
        $scope.label = data.EmployeeName;
        $scope.empCode = data.EmployeeCode;
        $scope.ADGLUrl = 'Employees/HRDashboardtr/ModalConsecutiveAbsentDateList?companyId=' + $scope.companyId + "&plantId=" + $scope.plantId + "&empSystemID=" + data.EmpSystemID + "&hrDate=" + $scope.hrDate;
    ...
    $scope.ModalConsecutiveLateDateList = function (data) {
        $scope.label = data.EmployeeName;
        $scope.empCode = data.EmployeeCode;
        $scope.Url = 'Employees/HRDashboardtr/ModalConsecutiveLateDateList?companyId=' + $scope.companyId + "&plantId=" + $scope.plantId + "&empSystemID=" + data.EmpSystemID + "&hrDate=" + $scope.hrDate;
