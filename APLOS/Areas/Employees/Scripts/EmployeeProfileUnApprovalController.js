'use strict';
EmployeeProfileUnApprovalController.$inject = ['addressService', 'fileReader', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$window'];
function EmployeeProfileUnApprovalController(addressService, fileReader, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter,$window) {
    $rootScope.title = 'Employee Profile Un-Approval';
    $scope.Action = 'Save';      
    $scope.path = 'employees/EmployeeProfileUnApproval/';
    $scope.getListUrl = $scope.path + 'GetApprovedEmployeeList';
    $scope.saveApprovedUrl = $scope.path + 'SaveUnApprovedEmployee';
