'use strict';
multipleResignationApprovalController.$inject = ['fileReader', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$window'];
function multipleResignationApprovalController(fileReader, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $window) {
    ...
    $scope.getListUrl = 'employees/resignationapprovalmultiple/multipleResignationPendingList';
    ...
    $scope.ReportEmployeeInfo = function () {
        ...
        location.href = 'employees/resignationapprovalmultiple/ReportEmployeeInfo';
    };
    $scope.As_ReportEmployeeInfo = function () {

        location.href = 'employees/resignationapprovalmultiple/As_ReportEmployeeInfo';
    };
            ...
            if (
                ...
                try {
                    ...
                    $http({
                        ...
                        method: 'POST',
                        url: 'employees/resignationapprovalmultiple/UpdateApprovalStatus',
