'use strict';
EmployeePlantTransferController.$inject = ['fileReader', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$compile', '$window'];

function EmployeePlantTransferController(fileReader, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $compile, $window) {
    $rootScope.title = 'Employee Promotion';
    $scope.path = 'Employees/EmployeePlantTransfer/';
