...
{
    public class HRDashboardtrController : BaseController
    {
        #region Constructor

        private readonly Library.HumanResource.Dashboard.HRDashboardtrService _HRDashboardService;

        public HRDashboardtrController()
        {
            _HRDashboardService = new Library.HumanResource.Dashboard.HRDashboardtrService();
        }
