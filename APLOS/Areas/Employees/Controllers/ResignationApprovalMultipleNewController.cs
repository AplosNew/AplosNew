...
{
    public class ResignationApprovalMultipleNewController : BaseController
    {
        #region Constructor
        private readonly IResignationNewService _ResignationService;
        private readonly IPreRecruitmentEmployeeService _preRecruitmentEmployeeService;

        public ResignationApprovalMultipleNewController(
              IResignationNewService ResignationService
