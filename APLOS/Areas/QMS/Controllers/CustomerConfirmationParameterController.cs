...
{
    public class CustomerConfirmationParameterController : Controller
    {
        #region Constructor
        ...
        public CustomerConfirmationParameterController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        [HttpGet, Authorize]
        public ActionResult LoadCustomerConfirmationParameter()
        {
...
where SO.OrderStatusId in ('Active','Toship','ToClose') and MOI.CustomerParameterId is not null and CUP.ApprovalStatus='ToApprove'";
        ...
        [HttpPost]
        public JsonResult createCustomerConfirmationPara(Dictionary<string, object> CustomerUpdateParaData,string ApprovalStatus)
        {
            try
            {
...
where P.LineItemNo='" + LineItemNo + @"'";
        ...
        [HttpPost]
        public JsonResult createCCPRequirement(Dictionary<string, object> UCPRequirementDetailsData)
        {
            try
            {
                ConnectionManager.DAL.ConManager conRack = new ConnectionManager.DAL.ConManager("1");
