...
namespace Aplos.Areas.QMS.Controllers
{
    public class CustomerRequirementControlController : Controller
    {
        ...
        public ActionResult LoadCustomerRequirementControl(string ParameterStatus)
        {
            ...
            //if (ParameterStatus == "Pending" || ParameterStatus == "null")
            //{
            //    FilterData = " and MOI.CustomerParameterId is null";
            //}
            //if (ParameterStatus == "ToApprove")
            //{
            //    FilterData = " and MOI.CustomerParameterId is not null and CUP.ApprovalStatus='ToApprove'";
            //}
...
where SO.OrderStatusId in ('Active','Toship','ToClose') and MOI.CustomerParameterId is null";
