...
{
    public class LotWiseQualityReportController : Controller
    {
        #region Constructor
        ...
        public LotWiseQualityReportController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        {
            return Json(_productionSummaryData.GetLotNumberLists(POId), JsonRequestBehavior.AllowGet);
        }

        [Authorize, HttpGet]
        public ActionResult LoadLotWiseQualityReport(string POId, string LotNumber,string CustomerId, string InvoiceId)
        {
            return Json(_productionSummaryData.LoadLotWiseQualityReport(POId, LotNumber, CustomerId, InvoiceId), JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpGet]
        public ActionResult GetCustomerQualityLotWiseJobCardReport(string CustomerId, string InvoiceId, string ProductionOrderId, string LotNumber)
        {
            try
            {
