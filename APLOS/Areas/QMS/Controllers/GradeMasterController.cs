...
namespace Aplos.Areas.QMS.Controllers
{
    public class GradeMasterController : BaseController
    {
        ...
        string TableName = "hkp.GradeMaster";

        #region Constructor

        private readonly ISqlRepository _sqlRepository;
        public GradeMasterController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.GradeMaster wher Id = '" + Id + "' ");
