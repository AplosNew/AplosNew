...
{
    public class DefectCheckLevelController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.DefectCheckLevel";
        //authentication for
        ...
        public DefectCheckLevelController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.DefectCheckLevel wher Id = '" + Id + "' ");
