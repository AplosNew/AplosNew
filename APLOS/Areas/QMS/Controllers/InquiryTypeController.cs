...
{
    public class InquiryTypeController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "HKP.InquiryType";
        //authentication for
        ...
        public InquiryTypeController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from TableName wher Id = '" + Id + "' ");
