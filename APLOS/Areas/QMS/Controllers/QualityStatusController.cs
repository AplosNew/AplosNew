...
{
    public class QualityStatusController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.QualityStatus";
        //authentication for
        ...
        public QualityStatusController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.QualityStatus where Id = '" + Id + "' ");
