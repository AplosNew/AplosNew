...
namespace Aplos.Areas.QMS.Controllers
{
    public class RepairTypeController : BaseController
    {
        ...
        string TableName = "hkp.RepairType";
        //authentication for
        ...
        public RepairTypeController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.RepairType wher Id = '" + Id + "' ");
