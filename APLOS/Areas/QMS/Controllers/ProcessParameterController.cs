...
namespace Aplos.Areas.QMS.Controllers
{
    public class ProcessParameterController : BaseController
    {
        ...
        string TableName = "hkp.ProcessParameter";
        //authentication for
        ...
        public ProcessParameterController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.ProcessParameter wher Id = '" + Id + "' ");
