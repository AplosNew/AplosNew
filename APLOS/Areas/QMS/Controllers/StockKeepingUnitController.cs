...
{
    public class StockKeepingUnitController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "HKP.StockKeepingUnit";
        //authentication for
        ...
        public StockKeepingUnitController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from TRN.QMSRejection wher Id = '" + Id + "' ");
