...
{
    public class InspectionTypeController  : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.InspectionType";
        //authentication for
        ...
        public InspectionTypeController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.InspectionType where Id = '" + Id + "' ");
