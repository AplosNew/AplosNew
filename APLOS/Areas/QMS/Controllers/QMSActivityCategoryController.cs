...
{
    public class QMSActivityCategoryController : BaseController
    {
        ...
        public QMSActivityCategoryController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.QMSActivityCategory wher Id = '" + Id + "' ");
        ...
        {
            string sql = @"select * from [HKP].[QMSActivityCategory] where CostingGroupId = '" + id + "'";
