...
{
    public class ProcessParameterMasterController : Controller
    {
        #region Constructor
        ...
        public ProcessParameterMasterController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult LoadProcessParaMasterList()
        {
            ...
            string sql = @" SELECT * FROM [MST].[ProcessParameterMaster]";
