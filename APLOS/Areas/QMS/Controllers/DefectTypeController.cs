...
namespace Aplos.Areas.QMS.Controllers
{
    public class DefectTypeController  : BaseController
    {
        ...
        string TableName = "hkp.DefectType";
        //authentication for
        ...
        public DefectTypeController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.DefectType wher Id = '" + Id + "' ");
