...
namespace Aplos.Areas.QMS.Controllers
{
    public class DocumentSourceController : BaseController
    {
        ...
        string TableName = "hkp.DocumentSource";
        ...
        public DocumentSourceController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.DocumentSource wher Id = '" + Id + "' ");
