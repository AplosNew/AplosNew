...
{
    public class QMSTestingMasterController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.QMSTestingMaster";
        //authentication for
        ...
        public QMSTestingMasterController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.QMSTestingMaster wher Id = '" + Id + "' ");
