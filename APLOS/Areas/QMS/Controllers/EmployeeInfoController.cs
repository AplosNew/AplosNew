...
namespace Aplos.Areas.QMS.Controllers
{
    public class EmployeeInfoController : BaseController
    {
       // string TableName = "hkp.BusinessProcess";
        string TableName = "[HKP].[EmployeeInfo]";
        ...
        public EmployeeInfoController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.EmployeeInfo wher Id = '" + Id + "' ");
        ...
        {
            string sql = @"select * from [HKP].[EmployeeInfo] where Id = '" + id + "'";
