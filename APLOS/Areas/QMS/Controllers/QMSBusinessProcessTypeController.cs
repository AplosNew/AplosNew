...
{
    public class QMSBusinessProcessTypeController : BaseController
    {
        string TableName = "hkp.BusinessProcessType";
        //authentication for
        ...
        public QMSBusinessProcessTypeController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.BusinessProcessType wher Id = '" + Id + "' ");
        ...
        {
            string sql = @"select * from [HKP].[BusinessProcessType] where CostingGroupId = '" + id + "'";
