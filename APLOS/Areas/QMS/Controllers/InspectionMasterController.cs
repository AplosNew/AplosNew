...
{
    public class InspectionMasterController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.InspectionMaster";
        //authentication for
        ...
        public InspectionMasterController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.InspectionMaster wher Id = '" + Id + "' ");
