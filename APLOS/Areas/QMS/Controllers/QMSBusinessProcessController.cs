...
{
    public class QMSBusinessProcessController : BaseController
    {
        string TableName = "hkp.BusinessProcess";
        //authentication for
        ...
        public QMSBusinessProcessController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.BusinessProcess wher Id = '" + Id + "' ");
        ...
        {
            string sql = @"select * from [HKP].[BusinessProcess] where CostingGroupId = '" + id + "'";
