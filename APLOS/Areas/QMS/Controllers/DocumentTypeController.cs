...
namespace Aplos.Areas.QMS.Controllers
{
    public class DocumentTypeController : BaseController
    {
        ...
        public DocumentTypeController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.DocumentType wher Id = '" + Id + "' ");
        ...
        {
            string sql = @"select * from [HKP].[DocumentType] where CostingGroupId = '" + id + "'";
