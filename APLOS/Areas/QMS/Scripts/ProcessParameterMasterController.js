'use strict';
ProcessParameterMasterController.$inject = ["cboService","commonMessage", "$scope", "$rootScope", "baseService", "$routeParams", "$location", "$http", "$filter"];
function ProcessParameterMasterController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = "ProcessParameterMaster";
    ...
    $scope.TypeLists = [];
    $scope.Action = 'Save';
    $scope.path = 'QMS/ProcessParameterMaster/';
