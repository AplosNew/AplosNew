    ...
    $scope.JobCardCQReportFunc = function () {
        try {
            ...
            if ($scope.LWQRListNew.length > 500) {
                ...
                var url = $scope.path + '/GetCustomerQualityLotWiseJobCardReport?Customer=' + $scope.statusNew.CustomerId + '&Invoice=' + $scope.statusNew.InvoiceId + '&ProductionOrderId=' + $scope.statusNew.ProductionOrderId + '&LotNumber=' + $scope.statusNew.LotNo;
