'use strict';
partyLedgerOutstandingReportController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller', '$window'];
function partyLedgerOutstandingReportController(commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller, $window) {
    $rootScope.title = 'Party Outstanding Ledger';
    ...
    $scope.getReport = function () {
        if (baseService.isUndefinedOrNull($scope.report.PartyType)) {
            ...
            var url = 'Parties/PartyReport/GetPartyOutstandingLedgerReport?reportFormat=' + $scope.report.ReportFormat + '&partyType=' + $scope.report.PartyType + '&partyId=' + $scope.report.PartyId + '&fromDate=' + $scope.report.FromDate + '&toDate=' + $scope.report.ToDate + '&active=' + $scope.report.Active;
