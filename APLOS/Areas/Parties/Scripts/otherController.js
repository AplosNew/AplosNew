'use strict';
otherController.$inject = ["addressService", 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', 'toaster'];
function otherController(addressService, commonMessage, $scope, $rootScope, baseService, $http, $filter, toaster) {
    $rootScope.title = 'Other';
    $scope.Action = 'Save';
    ...
    $scope.getListUrl = $scope.path + 'GetOtherList';
    $scope.getPartyContactListUrl = 'addresses/contactmasterparty/getlistbyparty/';
    $scope.getSeqUrl = $scope.path + 'getautosequence';
    $scope.saveUrl = $scope.path + 'InsertOther';
    $scope.updateUrl = $scope.path + 'EditOther';
    ...
    $scope.Save = function () {
        ...
        try {
            if ($scope.partyForm.$valid && $scope.partyForm4.$valid) {
