...
{
    public class ScanItemController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "dbo.ScanItem";
        //authentication for
        ...
        public ScanItemController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from dbo.ScanItem where Id = '" + Id + "' ");
