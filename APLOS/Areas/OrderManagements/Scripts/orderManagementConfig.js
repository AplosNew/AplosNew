...
function OrderManagementConfig($routeProvider, $locationProvider)
{
    $routeProvider
        ...
        .when('/dispatch-plan', {
            templateUrl: 'OrderManagements/DispatchMaster/DispatchPlan',
            controller: 'DispatchPlanController'
        })
        ...
        .when('/packingcategory', {
            templateUrl: 'OrderManagements/ProductionOrder/PackingCategory',
            controller: 'PackingCategoryController'
        })
