'use strict';
CostingSOTemplateController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function CostingSOTemplateController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = "CostingSOTemplate";
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.lsds = [];
