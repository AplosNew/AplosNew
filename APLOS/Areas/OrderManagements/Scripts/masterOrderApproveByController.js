'use strict';
masterOrderApproveByController.$inject = ['accountService', '$window', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller', 'toaster'];
function masterOrderApproveByController(accountService, $window, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller, toaster) {
    $rootScope.title = "Master Order ApproveBy";
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.files = [];
    ...
    $scope.getListUrl = $scope.path + 'GetApproveList';
    ...
    function getSalesOrderList() {
        ...
        $http.get('OrderManagements/MasterOrder/GetSOListForApprove?masterItemId=' + $scope.masterItemId)
            .then(function (response) {
