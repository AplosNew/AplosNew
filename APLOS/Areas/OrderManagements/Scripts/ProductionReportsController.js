'use strict';
ProductionReportsController.$inject = ["cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$filter", "$window", "$http"];
function ProductionReportsController(cboService, commonMessage, $scope, $rootScope, baseService, $filter, $window, $http) {
    ...
    $scope.path = 'OrderManagements/ProductionReports/';
    $scope.FromDate = '';
    $scope.ToDate = '';
    $scope.EntityId = '';
    $scope.prdProcessSetList = [];
    ...
    $scope.SelectedProcessId = null;
    $scope.ProcessList = [];
    $scope.getProcess = function () {

        $http({
            method: 'POST',
            url: $scope.path + "GetProcessForMultipleEntities",
            data: { entityIds: $scope.EntityId }
        }).then(function successCallback(response) {
    ...
    $scope.RunProductionTargetScheduler = function () {
        $http({
            method: 'POST',
            data: {},
            url: "OrderManagements/ProductionReports/RunProductionTargetScheduler"
        }).then(function successCallback(response) {
    ...
    $scope.getAllEntities = function () {
        ...
        $http({
            method: 'POST',
            url: "OrderManagements/ProductionReports/GetEntity"
        }).then(function successCallback(response) {
    ...
    $scope.getMasterOrder = function (status) {
        ...
        try {
            var file_src = 'OrderManagements/ProductionReports/MasterOrder?entityid=' + $scope.EntityId + '&status=' + status
    ...
    $scope.getos1 = function () {
        ...
        try {
            var file_src = 'OrderManagements/ProductionReports/OS1xls?entityid=' + $scope.EntityId
            $rootScope.report(file_src);
    ...
    $scope.getos2 = function () {
        ...
        try {
            var file_src = 'OrderManagements/ProductionReports/OS2xls?entityid=' + $scope.EntityId
            $rootScope.report(file_src);
    ...
    $scope.getos3 = function () {
        ...
        try {
            var file_src = 'OrderManagements/ProductionReports/OS3xls?entityid=' + $scope.EntityId
            $rootScope.report(file_src);
    ...
    $scope.getos4 = function () {
        ...
        try {
            ...
            var file_src = 'OrderManagements/ProductionReports/OS4xls?entityid=' + $scope.EntityId + "&fromDate=" + $scope.FromDate + "&toDate=" + $scope.ToDate;
            $rootScope.report(file_src);
    ...
    $scope.ProductionData = function () {
        ...
        try {
            ...
            var file_src = 'OrderManagements/ProductionReports/ProductionDataXls?entityid=' + $scope.EntityId + "&fromDate=" + $scope.FromDate + "&toDate=" + $scope.ToDate + "&ProcessId=" + $scope.SelectedProcessId;
            $rootScope.report(file_src);
    ...
    $scope.getos5 = function () {
        ...
        try {
            ...
            var file_src = 'OrderManagements/ProductionReports/OS5xls?entityid=' + $scope.EntityId + "&fromDate=" + $scope.FromDate + "&toDate=" + $scope.ToDate;
            $rootScope.report(file_src);
    ...
    $scope.LineBookingStatus = function () {
        ...
        try {
            var file_src = 'OrderManagements/ProductionReports/LineBookingStatus?entityid=' + $scope.EntityId
            $rootScope.report(file_src);
    ...
    $scope.PunchInfoDummy = function () {
        ...
        try {
            ...
            $http({
                method: 'GET',
                url: 'OrderManagements/ProductionReports/getOrderMasterDummy'
            }).then(function successCallback(response) {
    ...
    $scope.getProductionInfoWithWIP = function () {
        try {
            ...
            var file_src = 'OrderManagements/ProductionReports/ProductionReport?entityid=' + $scope.EntityId + "&fromDate=" + $scope.FromDate + "&todate=" + $scope.ToDate + "&ProductionStatus=" + proStatus ;
            $rootScope.report(file_src);
