'use strict';
FgPoFormasterOrderController.$inject = ['accountService', 'addressService', '$window', 'factoryService', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller'];
function FgPoFormasterOrderController(accountService, addressService, $window, factoryService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    ...
    $scope.getalldata = function () {
        $http({
            ...
            dataType: 'JSON',
            //url: $scope.getSearchListUrl,
            url: 'Products/PurchaseOrder/GetListForHold',
        }).then(function successCallback(response) {
...
//#region FGForMasterOrder(Finishing Goods For Master Order) 22-Jun-2019
    ...
    function getTaxCategoryListForFGService(hsnCodeId) {
        ...
        $http({
            method: 'GET'
            //,url: $scope.path + 'GetTaxCategoryListForFGService?receiveId=' + $scope.productNew.Id + '&hsnCodeId=' + hsnCodeId
