...
InoutGetpassCheckedController.$inject = ['accountService', 'addressService', '$location', '$window', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller'];
function InoutGetpassCheckedController(accountService, addressService, $location, $window, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    ...
    $scope.GetGetCheckedApprovedList = function () {
        ...
        $http({
            method: 'GET',
            url: 'Products/GateentryToken/GetGatePassCheckedApprovedList?tabType=' + $scope.tabType
    ...
    $scope.InOutGatePassUpdatePOP = function () {
        try {
            if ($scope.url === 'In-out-gate-pass-Checking') {
                ...
                $http({
                    method: 'POST',
                    url: 'Products/GateentryToken/InOutGatePassUncheckUpdate',
                    data:
                    {
