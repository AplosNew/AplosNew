...
inventorySalesCheckApproveController.$inject = ['accountService', 'addressService', '$location', '$window',  'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller'];
function inventorySalesCheckApproveController(accountService, addressService, $location, $window,  cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    ...
    $scope.uiType = function () {
        ...
        if ($scope.url === 'inventory-sales-Approval') {
            $scope.tabType = 'UnApprovedList';
        }
        else if ($scope.url === 'inventory-sales-checking') {
    ...
    $scope.GetGetCheckedApprovedList = function () {
        ...
        $http({
            method: 'GET',
            url: 'Products/InventoryIssue/GetCheckedApprovedList?tabType=' + $scope.tabType
    ...
    $scope.GetToBeApprovedByByList = function () {
        ...
        $http({
            method: 'GET',
            url: 'Products/InventoryIssue/GetSalesApproveddBy'
        }).then(function successCallback(response) {
    ...
    $scope.GatePassCheckApproved = function () {
        //debugger;
        if ($scope.url === 'inventory-sales-checking') {
            ...
            $http({
                method: 'POST',
                url: 'Products/InventoryIssue/GatePassCheckedAndApproved',
                data: {
                ...
                if (response.data.Error === true) {
                    ShowResult('Inventory Sale Updated successfully', 'failure');
                }
                else {
                    ShowResult('Inventory Sale Updated successfully', 'success');
                    $scope.GetGetCheckedApprovedList();
                }
        ...
        else if ($scope.url === 'inventory-sales-Approval') {
    ...
    //    //debugger;
    //    if ($scope.productNew.GatePassType === 'ReturnDispatch') {
    //        $scope.GetChallan();
    //        //$scope.GetChallanReturnToAddress();
    ...
    //    $http({
    //        method: 'GET',
    //        url: 'Products/GateentryToken/GetIndexGridDataList'
    //    }).then(function successCallback(response) {
