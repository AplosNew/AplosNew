...
inventoryScrapCheckApproveController.$inject = ['accountService', 'addressService', '$location', '$window',  'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller'];
function inventoryScrapCheckApproveController(accountService, addressService, $location, $window,  cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    ...
    $scope.uiType = function () {
        ...
        if ($scope.url === 'inventory-scrap-approval') {
            $scope.tabType = 'UnApprovedList';
        }
        else if ($scope.url === 'inventory-scrap-checking') {
    ...
    $scope.GetGetCheckedApprovedList = function () {
        ...
        $http({
            method: 'GET',
            url: 'Products/InventoryIssue/GetCheckedApprovedListScrap?tabType=' + $scope.tabType
    ...
    $scope.GetToBeApprovedByByList = function () {
        ...
        $http({
            method: 'GET',
            url: 'Products/InventoryIssue/GetScrapApprovedBy'
        }).then(function successCallback(response) {
    ...
    $scope.GatePassCheckApproved = function () {
        //debugger;
        if ($scope.url === 'inventory-scrap-checking') {
            ...
            $http({
                method: 'POST',
                url: 'Products/InventoryIssue/CheckedAndApprovedScrap',
                data: {
        ...
        else if ($scope.url === 'inventory-scrap-approval') {
