...
ServicePOCheckController.$inject = ['$location', '$window',  'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller'];
function ServicePOCheckController( $location, $window, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {

    $rootScope.title = "Service PO Checked";
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.products = [];
