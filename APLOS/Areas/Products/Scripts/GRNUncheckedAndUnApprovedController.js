...
GRNUncheckedAndUnApprovedController.$inject = ['accountService', 'addressService', '$window', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller', '$location'];
function GRNUncheckedAndUnApprovedController(accountService, addressService, $window, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller, $location) {

	$rootScope.title = "GRN Un check/approve";
	$scope.modelList = [];
	...
	$scope.GriddataGRNCheckedist = [];
	$scope.getGRNCheckedListData = function () {
		$http({
			method: "GET",
			dataType: 'JSON',
			url: 'Products/GoodsReceiveNote/getGRNCheckedListData',
		}).then(function successCallback(response) {
	...
	$scope.GriddataGRNApprovedist = [];
	$scope.getGRNApprovedListData = function () {
		//debugger;
		$http({
			method: "GET",
			dataType: 'JSON',
			url: 'Products/GoodsReceiveNote/getGRNApprovedListData',
		}).then(function successCallback(response) {
			$scope.GriddataGRNApprovedist = response.data;
	...
	$scope.GRNUnChecked = function () {
		...
		$http({
			method: 'POST',
			url: 'Products/GoodsReceiveNote/GRNUncheckUpdate',
			data:
			{
	...
	$scope.GRNUnapprovedUpdate = function () {
		...
		$http({
			method: 'POST',
			url: 'Products/GoodsReceiveNote/GRNUnapprovedUpdate',
			data:
			{
