...
ServiceAckCheckedApprovedByController.$inject = ['accountService', 'addressService', '$location', '$window', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller'];
function ServiceAckCheckedApprovedByController(accountService, addressService, $location, $window,  cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {

    $rootScope.title = "Service Acknowledgement Check and approve";
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.products = [];
    ...
    $scope.uiType = function () {
        ...
        if ($scope.url === 'Service-Ack-Approval') {
            $scope.tabType = 'UnApprovedList';
        }
        else if ($scope.url === 'Service-Ack-Checked') {
    ...
    $scope.GetGetCheckedApprovedList = function () {
       //debugger;
        $http({
            method: 'GET',
            url: 'Products/PurchaseOrder/GetCheckedApprovedListserviceack?tabType=' + $scope.tabType
    ...
    $scope.GatePassCheckApproved = function () {
       //debugger;
        if ($scope.url === 'Service-Ack-Checked') {
            ...
            $http({
                method: 'POST',
                url: 'Products/PurchaseOrder/ServiceAckCheckedAndApproved',
                data: {
        ...
        else if ($scope.url === 'Service-Ack-Approval') {
