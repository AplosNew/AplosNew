'use strict';
inventoryIssueSlipBaseController.$inject = ['$window', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$controller'];
function inventoryIssueSlipBaseController($window, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $controller) {
	...
	$scope.Save = function () {
		...
		$scope.ispostDisable = true;
		$scope.productNew.MaterialStorageId = $scope.specificStockList[0].MaterialStorageId;
