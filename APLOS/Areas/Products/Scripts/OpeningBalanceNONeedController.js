...
OpeningBalanceController.$inject = ['accountService', 'addressService', '$window', 'factoryService', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$controller'];
function OpeningBalanceController(accountService, addressService, $window, factoryService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    
    $rootScope.title = "Opening Balance";
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.products = [];
   ...
   // $scope.getApprovaldataAUth();
    ...
    $scope.recorddoubleclick = function ($event) {
        ...
        //$scope.productNew.PlantWiseGateId = res;
        //getPartyPlantList();
  ...
  //#region GateEntry Reginter by nurul
    ...
    $scope.GetOpeningBalane = function () {
        ...
        $http({
            ...
            url: 'Products/GateentryToken/OpeningBalanceLoadOnData'
        }).then(function successCallback(response) {
    ...
    $scope.OpeningBalanceReportExcel = function () {
        ...
        try {
            var file_src = $scope.path + "OpeningBalanceReportExcel";
    ...
    $scope.OpeningBalanceReportPdf = function () {
        ...
        try {
            var file_src = $scope.path + "OpeningBalanceReportPdf";
            $rootScope.report(file_src);
