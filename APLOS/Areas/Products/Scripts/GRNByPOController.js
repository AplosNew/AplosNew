...
function GRNByPOController(addressService, $window, factoryService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    ...
    $scope.checkValidation = function () {
        ...
        for (var i = 0; i < $scope.inventoryMaterialListPO.length; i++) {
            ...
            $scope.poLotNumberList = $filter("filter")($scope.inventoryMaterialListPO, { 'PODetailsID': $scope.inventoryMaterialListPO[i].PODetailsID, 'ArticleId': $scope.inventoryMaterialListPO[i].ArticleId, 'LotNumber': $scope.inventoryMaterialListPO[i].LotNumber,'check':true });
