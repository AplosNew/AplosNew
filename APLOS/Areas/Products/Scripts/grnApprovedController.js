'use strict';
grnApprovedController.$inject = ['addressService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$http'];
function grnApprovedController(addressService, commonMessage, $scope, $rootScope, baseService, $routeParams, $http) {
    $rootScope.title = "GRN Approval";
    $scope.modelList = [];
