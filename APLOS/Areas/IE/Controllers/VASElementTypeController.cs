...
{
    public class VASElementTypeController : Controller
    {
        #region Constructor
        ...
        public VASElementTypeController(
        ...
        #region Forhad Code
        [HttpGet, Authorize]
        public JsonResult GetAllElementType()
        {
            string sql = "";
            sql = @"SELECT Id, Code,ShortName,StandardName,UserName,Description FROM [HKP].[ElementType] ORDER BY StandardName";

            return Json(_sqlRepository.GetDataCollection(sql), JsonRequestBehavior.AllowGet);
        }

        [HttpPost, Authorize]
        public JsonResult GetSelectedElementType(int Id)
        {
            string sql = "";
            sql = @"SELECT Id, Code,ShortName,StandardName,UserName,Description FROM [HKP].[ElementType] WHERE Id='" + Id + "'";

            return Json(_sqlRepository.GetDataCollection(sql), JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public ActionResult SaveElementType(Dictionary<string, object> elementType)
        {
            ...
            try
            {
                ...
                con.getDataSet("Select * from [HKP].[ElementType] where Id='" + elementType["Id"].ToString() + "'", out DataSet dsElementType);
        ...
        [HttpGet]
        public ActionResult DeleteSelectedElementType(int Id)
        {
            try
            {
                ...
                con.executeQuery("DELETE FROM [HKP].[ElementType] WHERE Id='" + Id.ToString() + "'");
