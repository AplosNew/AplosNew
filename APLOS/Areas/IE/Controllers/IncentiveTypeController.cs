...
{
    public class IncentiveTypeController : BaseController
    {
        //abcd
        //this is my code from tarek
        string TableName = "hkp.IncentiveType";
        //authentication for
        ...
        public IncentiveTypeController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.IncentiveType wher Id = '" + Id + "' ");
