'use strict';
sizeGroupController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function sizeGroupController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = 'SizeGroup';
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.sizeGroups = [];
    $scope.path = 'IE/sizeGroup/';
