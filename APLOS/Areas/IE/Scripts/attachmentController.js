'use strict';
attachmentController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function attachmentController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = 'Attachment';
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.sizeGroups = [];
    $scope.path = 'IE/attachment/';
