'use strict';
skillGroupingController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function skillGroupingController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = 'Skill Grouping'; 
    $scope.Action = 'Save';  
    $scope.Action1 = 'Save';
    ...
    $scope.path = 'IE/SkillGrouping/';//ControlerName
    ...
    $scope.getaldataOperationMaster = function () {
        ...
        $http({
            ...
            $scope.GriddataSkillGrouping = response.data;
...
//#endregion
    ...
    $scope.GeneratSequenceNo = function () {
        $http({
            method: 'GET',
            url: 'IE/skillGrouping/GetAutoSequence'
        }).then(function successCallback(response) {
 ...
 //#endregion 
    ...
    $scope.GetDataByMasterOrderIdfn = function (OMId) {
        ...
        $http({
            method: 'GET',
            url: 'IE/SkillGrouping/GetDataBySkillGroupingId?id=' + OMId
        }).then(function successCallback(response) {
    ...
    $scope.GetDataByMasterOrderIdfnMP = function (OMId) {
        ...
        $http({
            method: 'GET',
            url: 'IE/SkillGrouping/GetDataByMasterOrderIdMP?id=' + OMId
        }).then(function successCallback(response) {
