...
{
    public class CommercialAdditionalInfoController : BaseController
    {
        string TableName = "dbo.CommercialAdditionalInfo";
        //authentication for
        ...
        public CommercialAdditionalInfoController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        [HttpGet, Authorize]
        public ActionResult GetCommercialAdditionalInfo()
        {
            string sql = @"SELECT *,Flag=Convert(bit, 0) FROM [dbo].[CommercialAdditionalInfo]";
        ...
        {
            string sql = @"select * from dbo.CommercialAdditionalInfo where Id = '" + id + "'";
                try
                {
