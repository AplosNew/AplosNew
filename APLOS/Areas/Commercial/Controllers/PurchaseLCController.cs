    ...
    public class PurchaseLCController : BaseController
    {
        ...
        public ActionResult GetList()
        {
            try
            {
                ...
                string sql = @"
						...
						,FORMAT(PLC.ShipmentDate,'dd-MMM-yyyy') ShipmentDate,PLC.PINo,OB.CurrencyId BankCurrency,MLC.LCRef MasterLCNo
        ...
        public ActionResult GetPurchaseLCUnPostList()
        {
            string sql = @"
						...
						,FORMAT(M.AmendmentDate,'dd-MMM-yyyy') AmendmentDate,0 AmendmentAmount
						...
						,FORMAT(M.AmendmentDate,'dd-MMM-yyyy') AmendmentDate, M.Amount AmendmentAmount
						,FORMAT(M.ExpiryDate,'dd-MMM-yyyy') ExpiryDate, CN.Code Currency,P.UserName PartyName,OB.AccountTitle OpeningBank,M.LCRef,CH.PurchaseLCId,CH.VoucherId
