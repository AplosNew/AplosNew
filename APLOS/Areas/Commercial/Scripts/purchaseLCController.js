'use strict';
purchaseLCController.$inject = ['accountService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$window', 'cboService', 'bankService', '$controller'];
function purchaseLCController(accountService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $window, cboService, bankService, $controller) {
    $rootScope.title = "PurchaseLC";
    $scope.Action = 'Save';
    ...
    $scope.SelectedContract = function (obj) {
        ...
        //$scope.purchaseLCNew.LCRef = data.LCRef;CustomerName
        angular.element(document.querySelector('#ContractPopUp')).modal('hide');
    }
