"use strict";
OverHeadTypeGLSalesController.$inject = ["cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$http"];
function OverHeadTypeGLSalesController(cboService, commonMessage, $scope, $rootScope, baseService, $http) {
