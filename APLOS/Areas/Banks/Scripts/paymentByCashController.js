"use strict";
paymentByCashController.$inject = ["bankService", "accountService", "cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$http", "$filter", "$controller"];
function paymentByCashController(bankService, accountService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    $rootScope.title = "Payment By Cash";
    $scope.Action = "Save";
    $scope.voucherList = [];
    $scope.index = -1;
    $scope.url = "Banks/CashJournal";
    $scope.listUrl = $scope.url + "/GetPaymentByCashList";
    $scope.parkUrl = $scope.url + "/InsertPaymentByCash";
    $scope.updateUrl = $scope.url + "/UpdatePaymentByCash";
    $scope.postUrl = $scope.url + "/PostPaymentByCash";
    ...
    $scope.getBankCashPaymentDetailList = function (id) {
        $http({
            method: "GET",
            url: "Banks/CashJournal/GetBankCashPaymentDetailList?bankJournalId=" + id
        }).then(function successCallback(response) {
    ...
    $scope.clear = function () {
        ...
        $scope.voucher.BankJournalType = "CashToVendor";
    ...
    $scope.getCboVoucherTypeBankJournalList = function () {
        accountService.getCboVoucherTypePaymentByCashList(function (result) {
