"use strict";
paymentByBankController.$inject = ["bankService", "accountService", "cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$http", "$filter", "$controller"];
function paymentByBankController(bankService, accountService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    $rootScope.title = "Payment By Bank";
    $scope.Action = "Save";
    $scope.voucherList = [];
    $scope.index = -1;
    $scope.url = "Banks/BankJournal";
    $scope.listUrl = $scope.url + "/GetPaymentByBankList";
    $scope.parkUrl = $scope.url + "/InsertPaymentByBank";
    $scope.updateUrl = $scope.url + "/UpdatePaymentByBank";
    $scope.postUrl = $scope.url + "/PostPaymentByBank";
    ...
    $scope.voucher = {
        ...
        BankJournalType: "BankToVendor",
        BankJournalId: null,
        IsReverse: null,
        CompanyCurrencyRate: 1,
        BankJournalDetailId: null
    };
    ...
    $scope.getBankCashPaymentDetailList = function (id) {
        $http({
            method: "GET",
            url: "Banks/BankJournal/GetBankCashPaymentDetailList?bankJournalId=" + id
    ...
    $scope.Get = function (data) {
        ...
        $scope.Action = "Update";
        $scope.getAllPartyPlantJournalCbo($scope.voucher.VoucherId);
        $scope.voucher.PartyPlantId = data.PartyPlantId;
        $scope.getBankCashPaymentDetailList($scope.voucher.Id);
    };
    ...
    $scope.clear = function () {
        ...
        $scope.voucher.BankJournalType = "BankToVendor";
        $scope.voucher.Amount = null;
        $scope.voucher.VoucherId = null;
        $scope.voucher.VoucherDetailId = null;
    ...
    $scope.getCboVoucherTypeBankJournalList = function () {
        accountService.getCboVoucherTypePaymentByBankList(function (result) {
    ...
    $scope.GetEmployeeTransactionNo = function (employeeId) {
        $http({
            ...
            $scope.voucher.DocRefNo = "EA-" + $scope.employeeTransactionNo;
        });
    };
