"use strict";
postDateChequeController.$inject = ["commonMessage", "$scope", "$rootScope", "baseService", "$http", "$filter","$controller"];
function postDateChequeController(commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    $rootScope.title = "PDC";
    $scope.Action = "Save";
    $scope.index = -1;
