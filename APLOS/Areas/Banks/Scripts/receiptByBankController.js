"use strict";
receiptByBankController.$inject = ["bankService", "accountService", "cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$http", "$filter", "$controller"];
function receiptByBankController(bankService, accountService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    $rootScope.title = "Receipt By Bank";
    $scope.Action = "Save";
    $scope.voucherList = [];
    $scope.index = -1;
    $scope.url = "Banks/BankJournal";
    $scope.listUrl = $scope.url + "/GetReceiptByBankList";
    $scope.parkUrl = $scope.url + "/InsertReceiptByBank";
    $scope.updateUrl = $scope.url + "/UpdateReceiptByBank";
    $scope.postUrl = $scope.url + "/PostReceiptByBank";
    ...
    $scope.voucher = {
        ...
        BankJournalType: "BankToCustomer",
        BankJournalId: null,
        IsReverse: null,
    ...
    $scope.getBankCashPaymentDetailList = function (id) {
        $http({
            method: "GET",
            url: "Banks/BankJournal/GetBankCashReceiptDetailList?bankJournalId=" + id
        }).then(function successCallback(response) {
    ...
    $scope.clear = function () {
        ...
        $scope.voucher.BankJournalType = "BankToCustomer";
    ...
    $scope.getCboVoucherTypeBankJournalList = function () {
        accountService.getCboVoucherTypeReceiptByBankList(function (result) {
