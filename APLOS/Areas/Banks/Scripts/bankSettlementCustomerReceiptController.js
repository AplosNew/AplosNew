...
function bankSettlementCustomerReceiptController(bankService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller, $routeParams) {
    ...
    $scope.GetBankUploadInfoById = function (id) {
        $http({
            ...
            $scope.voucher.BankName = $scope.bankUploadInfoList[0].AccountTitle;
            $scope.voucher.Amount = $scope.bankUploadInfoList[0].BankAmount;
            $scope.voucher.BankAmount = $scope.bankUploadInfoList[0].BankAmount;
            $scope.voucher.DocRefNo = $scope.bankUploadInfoList[0].DocRefNo;
