"use strict";
bankOpeningBalanceController.$inject = ["cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$http", "$filter", "$controller"];
function bankOpeningBalanceController(cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    $rootScope.title = "Bank Opening Balance";
    $scope.Action = "Save";
    $scope.index = -1;
    ...
    $scope.url = "Banks/BankOpeningBalance";
    $scope.listUrl = $scope.url + "/GetBankList";
    $scope.saveUrl = $scope.url + "/InsertBank";
    $scope.updateUrl = $scope.url + "/UpdateBank";

    $controller("currencyBaseController", { $scope: $scope, $http: $http });
    $scope.bankACType = "HouseBank";
