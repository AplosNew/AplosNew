...
{
    public class JobWorkTransformationPOController : BaseController
    {
        string TableName = "OSTransformationPO";
        //authentication for
        //GetList Create Delete
      //  Library.MaterialManagement.JobWork.OSCommon JobWorkCommon = null;
        Library.MaterialManagement.JobWork.JWCommon JobWorkCommon = null;
        ...
        public JobWorkTransformationPOController(ISqlRepository R, IPurchaseOrderService inventoryReveiveService, IRepositoryAsync<POService> inventoryServiceRepository)
        {
