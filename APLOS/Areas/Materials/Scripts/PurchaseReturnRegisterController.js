'use strict';
PurchaseReturnRegisterController.$inject = ['fileReader', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', 'cboService', '$window', '$controller'];
function PurchaseReturnRegisterController(fileReader, commonMessage, $scope, $rootScope, baseService, $http, $filter, cboService, $window, $controller) {
	...
	$scope.GetPurchaseRegister = function () {
		...
		$http({
			method: 'POST',
			//url: $scope.getSearchListUrl,
            url: 'Materials/MaterialLedger/GetPurchaseReturnRegister',
			data: {
				fromDate: $scope.report.FromDate,
				toDate: $scope.report.ToDate,
				Type: $scope.productNew.Type
	...
	$scope.MaterialLedgerReportExcel = function (id, reportFormat) {
		...
		var reportFormat = "Excel";
		//if (baseService.isUndefinedOrNull(id)) return ShowResult('No Id found', 'failure');
		$window.open('Materials/MaterialLedger/Report?reportFormat=' + reportFormat + '&fromDate=' + $scope.report.FromDate + '&toDate=' + $scope.report.ToDate + '&Qty=' + $scope.productNew.Qty + '&Amount=' + $scope.productNew.Amount, '_blank');
	};
	...
	$scope.PurchaseOrderReportPdf = function (id, reportFormat) {
		...
		var reportFormat = "Pdf";
		//if (baseService.isUndefinedOrNull(id)) return ShowResult('No Id found', 'failure');
        $window.open('Materials/MaterialLedger/PurchaseRegisterReturnReport?reportFormat=' + reportFormat + '&fromDate=' + $scope.report.FromDate + '&toDate=' + $scope.report.ToDate + '&Type=' + $scope.productNew.Type, '_blank');
	};
    ...
    $scope.MaterialStockBalanceReportPdf = function (id, reportFormat) {
        ...
        var reportFormat = "Pdf";
        //if (baseService.isUndefinedOrNull(id)) return ShowResult('No Id found', 'failure');
        $window.open('Materials/MaterialLedger/MaterialStockBalanceReport?reportFormat=' + reportFormat + '&fromDate=' + $scope.report.FromDate + '&toDate=' + $scope.report.ToDate + '&Qty=' + $scope.productNew.Qty + '&Amount=' + $scope.productNew.Amount + '&RcptIssue=' + $scope.productNew.RcptIssue + '&Asset=' + $scope.productNew.Asset + '&Inventory=' + $scope.productNew.Inventory, '_blank');

    };
    $scope.MaterialStockBalanceReportExcel = function (id, reportFormat) {
        debugger;
        $scope.productNew.Asset === false;
        $scope.productNew.Inventory === false;
        if ($scope.productNew.AsOnDate === 'AsOnDate') {
        ...
        var reportFormat = "Excel";
        //if (baseService.isUndefinedOrNull(id)) return ShowResult('No Id found', 'failure');
        $window.open('Materials/MaterialLedger/MaterialStockBalanceReport?reportFormat=' + reportFormat + '&fromDate=' + $scope.report.FromDate + '&toDate=' + $scope.report.ToDate + '&Qty=' + $scope.choice1 + '&Amount=' + $scope.choice2 + '&RcptIssue=' + $scope.productNew.RcptIssue + '&Asset=' + $scope.productNew.Asset + '&Inventory=' + $scope.productNew.Inventory, '_blank');
    };
    ...
    //-------Material Store Ledger Report--------//

    $scope.MaterialStoreLedgerReportPdf = function (id, reportFormat) {
    ...
    $scope.MaterialStoreLedgerReportExcel = function (id, reportFormat) {
        ...
        var reportFormat = "Excel";
        //if (baseService.isUndefinedOrNull(id)) return ShowResult('No Id found', 'failure');
		$window.open('Materials/MaterialLedger/MaterialStoreLedgerReport?reportFormat=' + reportFormat + '&fromDate=' + $scope.report.FromDate + '&toDate=' + $scope.report.ToDate + '&Qty=' + $scope.choice1 + '&Amount=' + $scope.choice2 + '&RcptIssue=' + $scope.productNew.RcptIssue + '&MaterialId=' + $scope.detailModel.MaterialMasterId + '&ArticleId=' + $scope.detailModel.ArticleId, '_blank');
    };
    ...
    $scope.MaterialConsumptionReportExcel = function (id, reportFormat) {
    ...
    $scope.MaterialConsumptionCCReportExcel = function (id, reportFormat) {
    ...
    $scope.MaterialReceiptsReportExcel = function (id, reportFormat) {
        debugger;
        $scope.productNew.Asset === false;
        $scope.productNew.Inventory === false;
        if ($scope.productNew.AsOnDate === 'AsOnDate') {
        ...
        var reportFormat = "Excel";
        //if (baseService.isUndefinedOrNull(id)) return ShowResult('No Id found', 'failure');
        $window.open('Materials/MaterialLedger/MaterialReceiptsReports?reportFormat=' + reportFormat + '&fromDate=' + $scope.report.FromDate + '&toDate=' + $scope.report.ToDate + '&Qty=' + $scope.choice1 + '&Amount=' + $scope.choice2 + '&RcptIssue=' + $scope.productNew.RcptIssue + 
'&Asset=' + $scope.productNew.Asset + '&Inventory=' + $scope.productNew.Inventory, '_blank');
    };
    ...
    $scope.MaterialIssueReportExcel = function (id, reportFormat) {
        ...
        var reportFormat = "Excel";
        //if (baseService.isUndefinedOrNull(id)) return ShowResult('No Id found', 'failure');
        $window.open('Materials/MaterialLedger/MaterialIssueReports?reportFormat=' + reportFormat + '&fromDate=' + $scope.report.FromDate + '&toDate=' + $scope.report.ToDate + '&Qty=' + $scope.choice1 + '&Amount=' + $scope.choice2 + '&RcptIssue=' + $scope.productNew.RcptIssue, '_blank');
    };
  ...
  //  $scope.getStatusallGRNPendingList();
    ...
    $scope.MaterialMasterStatusReportPdf = function (id, reportFormat) {
        debugger;
        ...
        //        ShowResult('Select With1 Stock OR Without Stock', 'failure');
        //        return false;
        //    }
        ...
        var reportFormat = "Pdf";
        //if (baseService.isUndefinedOrNull(id)) return ShowResult('No Id found', 'failure');
        $window.open('Materials/MaterialLedger/MaterialMasterStatus?reportFormat=' + reportFormat + '&fromDate=' + $scope.report.FromDate + '&toDate=' + $scope.report.ToDate + '&Qty=' + $scope.choice1 + '&Amount=' + $scope.choice2 + '&RcptIssue=' + $scope.productNew.RcptIssue + '&Asset=' + $scope.productNew.WithStock + '&Inventory=' + $scope.productNew.WithoutStock, '_blank');
    };
    $scope.MaterialMasterStatusReportExcel = function (id, reportFormat) {
        debugger;
        $scope.productNew.WithStock === false;
        $scope.productNew.WithoutStock === false;
        //if ($scope.productNew.AsOnDate === 'AsOnDate') {
    ...
    $scope.MaterialStationeryRequestReportPdf = function (id, reportFormat) {
        //if ($scope.productNew.AsOnDate === 'AsOnDate') {
        //    ShowResult('Please Select for the perion', 'failure');
        //    return false;
            //if ($scope.report.ToDate === "" || $scope.report.ToDate === null || $scope.report.ToDate === undefined) {
            //    ShowResult('Select To Date', 'failure');
            //    return false;
