'use strict';
OTManualNewController.$inject = ["addressService", 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function OTManualNewController(addressService, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    ...
    $scope.path = 'Attendances/OTManualNew/';
    ...
    $scope.GetPlant = function () {
        ...
        $http({
            method: 'GET',
            url: 'Attendances/OTManualNew/getplant/'
    ...
    $scope.getEntityWithChange = function () {
        ...
        $http({
            method: 'GET',
            url: 'Attendances/OTManualNew/getentity/'
        }).then(function successCallback(response) {
    ...
    $scope.GetShift = function () {
        ...
        $http({
            method: 'GET',
            url: 'Attendances/OTManualNew/getshift?PlantId=' + $scope.OTManual.PlantValue
        }).then(function successCallback(response) {
    ...
    $http({
        method: 'GET',
        url: 'Attendances/OTManualNew/getdepartment/'
    }).then(function successCallback(response) {
    ...
    $http({
        method: 'GET',
        url: 'Attendances/OTManualNew/getsection/'
    }).then(function successCallback(response) {
    ...
    $http({
        method: 'GET',
        url: 'Attendances/OTManualNew/getsubsection/'
    }).then(function successCallback(response) {
  ...
  //      $scope.EntityList = [];
    ...
    $scope.getEmpDetailsData = function () {
        ...
        $http({
            ...
            url: 'Attendances/OTManualNew/LoadAllEmpDetailsForSelection/'
        }).then(function successCallback(response) {
    ...
    $scope.GetEMPSysId = function () {
       ...
       var EMPdata = [];
        $http({
            method: 'POST',
            data: { Id: $scope.OTManual.Id, PlantId: $scope.OTManual.PlantValue, DepartmentId: $scope.OTManual.DepartmentId, SectionId: $scope.OTManual.SectionId, SubSectionId: $scope.OTManual.SubSectionId, EmpCode: $scope.OTManual.EmployeeCode, EmpWorkDate: $scope.OTManual.WorkDate },
            url: 'Attendances/OTManualNew/getempinouttime/'
        }).then(function successCallback(response) {
