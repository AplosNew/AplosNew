'use strict';
monthlyGoodWorkReportController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'cboService'];
function monthlyGoodWorkReportController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, cboService) {
    ...
    $scope.loadfilters = function () {
        $http({
            method: 'GET',
            url: 'Attendances/MonthlyGoodWorkReport/getFilters',
            dataType: 'JSON'
    ...
    $scope.GetGoodWorkReport = function (reportType) {
        try {
            ...
            if (baseService.isUndefinedOrNull($scope.GoodWork.MonthNo)) {
                ...
                $http({
                    method: 'POST',
                    url: 'Attendances/MonthlyGoodWorkReport/XlsGoodWorkReport',
                    data: {
