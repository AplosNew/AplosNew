'use strict';
ManualOTUploadController.$inject = ['$window',"addressService", 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function ManualOTUploadController($window,addressService, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = 'Manual OT Upload';
    $scope.OTFilingList = [];
    $scope.SelectedEmpINOUTListExcel = [];
    $scope.PlantList = [];

    $scope.path = 'Attendances/ManualOTUpload/';
    ...
    $scope.GetPlantList = function () {
        ...
        $http({
            method: 'GET',
            url: 'Attendances/ManualOTUpload/getplant/'
    ...
    $scope.GetSample = function () {
        ...
        try {
            window.open('Attendances/ManualOTUpload/GetSampleReport?reportFormat=' + reportFormat, '_blank');
    ...
    $scope.ImportData = function () {
        try {
            ...
            if ($scope.uploadexcelForm.$valid) {
                ...
                $http({
                    method: 'POST',
                    url: 'Attendances/ManualOTUpload/ImportData',
    ...
    $scope.getEmpDetailsDataForExcel = function () {
        ...
        $http({
            ...
            url: 'Attendances/ManualOTUpload/LoadAllEmpDetailsForSelection/'
        }).then(function successCallback(response) {
