'use strict';
AttendanceRawDataDeleteNewController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$window', '$filter'];
function AttendanceRawDataDeleteNewController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $window, $filter) {
    $rootScope.title = 'Attendance Raw Data Delete';
    $scope.path = 'Attendances/AttendanceRawDataDeleteNew/';
