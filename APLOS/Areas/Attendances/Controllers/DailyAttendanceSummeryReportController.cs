...
{
    public class DailyAttendanceSummeryReportController : BaseController
    {
        #region Constructor
        ...
        public DailyAttendanceSummeryReportController(
        ...
        [HttpGet, Authorize]
        public ActionResult GetReport(ReportFormat reportFormat, string WorkDate)
        {

            var identity = (CustomIdentity)Thread.CurrentPrincipal.Identity;
            DailyAttandanceSummeryReport ep = new DailyAttandanceSummeryReport();
            var reportFileName = "Daily Attendance Summery";
            var workbook = ep.XlsDailyAttendanceSummaryRpt(WorkDate);
            switch (reportFormat)
            {
