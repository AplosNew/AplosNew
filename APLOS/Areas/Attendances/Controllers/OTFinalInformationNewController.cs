...
{
    public class OTFinalInformationNewController : BaseController
    {
        #region Constructor
        ...
        public OTFinalInformationNewController(
        ...
        public ActionResult XlsOTFinalReport(string Month, string Year)
        {
            ...
            try
            {
                ...
                #region DataSet
                HourlyOTReportService os = new HourlyOTReportService();
                os.GetOTFinalRpt(identity.PlantId, dtFrmDt.ToString("dd-MMM-yyyy"), dtEndDate.ToString("dd-MMM-yyyy"), sUnit, sDevi, sDept, sSect, sSbSe, sLine, sEmpC, sDeGr, sDesi, out dsOT);
                dtOT = dsOT.Tables[0];
                dvOT = new DataView();
