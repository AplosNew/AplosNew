...
namespace Aplos.Areas.Costings.Controllers
{
    public class QuickCostingMasterController : BaseController
    {
        ...
        {
            string sql = @"select ci.CostingComponentId,o.Sequence,o.Id,CI.Id AS CostingItemId, o.[Value], o.[Description],e.EmployeeName as ResponsiblePersoin, e.SystemId as ResponsiblePersonId,  ci.UserName, o.Description
                            from hkp.CostingItem ci
