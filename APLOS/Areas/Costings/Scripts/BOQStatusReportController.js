...
function BOQStatusReportController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $window) {
    $rootScope.title = 'BOQ Status Report';
    $scope.path = 'Costing/BOQStatusReport/';
