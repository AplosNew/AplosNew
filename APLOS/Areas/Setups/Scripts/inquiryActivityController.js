'use strict';
inquiryActivityController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$http', '$filter', 'cboService'];
function inquiryActivityController(commonMessage, $scope, $rootScope, baseService, $routeParams, $http, $filter, cboService) {
    $rootScope.title = 'Inquiry Activity';
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.buyerActivitys = [];
    $scope.path = 'Setups/OrderActivity/';
    $scope.getListUrl = $scope.path + 'getlist';
    $scope.saveUrl = $scope.path + 'CreateInquiryActivity';
    $scope.updateUrl = $scope.path + 'EditInquiryActivity';
    ...
    cboService.getEnumCbo("enum/GetInquiryActivityCbo", function (result) {
    ...
    $scope.getListData = function () {
        ...
        $rootScope.parameters.activityType = 'Inquiry';
