'use strict';
TermsAndConditionsController.$inject = ['$window', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function TermsAndConditionsController($window, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = 'Terms And Conditions';
    $scope.path = 'setups/TermsAndConditions/';
    $scope.Action = 'Save';
    ...
    $scope.loadGrid = function (data) {
        try {
            //if (baseService.isUndefinedOrNull($scope.ESICPolicyHead.Description)) {
            //    throw "Select Description";
            //}          
            var newObj = Object.assign({}, $scope.TermsAndConditionModel);
    ...
    $scope.Remove = function (index) {
        ...
        $scope.TermsAndConditionModel = removed;
        //$scope.Detail.pop();
    }
    //#endregion
