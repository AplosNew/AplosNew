'use strict';
productionSystemController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter'];
function productionSystemController(commonMessage, $scope, $rootScope, baseService, $http, $filter) {
    $rootScope.title = "Production System";
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.modelList = [];
    $scope.path = 'Machines/ProductionSystem/';
    ...
    function ClearFields(seq) {
        $scope.Action = "Save";
        $scope.model = {};
        $scope.modelNew = { Sequence: seq, Active: true, FactorValue:0};
    }
}
