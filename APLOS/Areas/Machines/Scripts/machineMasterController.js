'use strict';
machineMasterController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function machineMasterController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    ...
    $scope.GetOperationPositionMPBudgetService = [];
    $scope.GetOperationPositionMPBudgetService = function () {
        $http({
            method: "GET",
            dataType: 'JSON',
            //url: $scope.getSearchListUrl,
            url: 'IE/OperationMaster/GetOperationPositionMPBudgetService',
        }).then(function successCallback(response) {
            $scope.GetOperationPositionMPBudgetService = response.data;
            //entrydata = copy(searchdata);
        });
    };
    $scope.GetOperationPositionMPBudgetService();
