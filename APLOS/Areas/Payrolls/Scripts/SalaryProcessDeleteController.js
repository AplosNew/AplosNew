'use strict';
salaryProcessDeleteController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$window', 'cboService'];
function salaryProcessDeleteController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $window, cboService) {
    $rootScope.title = "Salary Process";
    $scope.Action = 'Delete';
    $scope.salaryProcesss = [];
    $scope.path = 'Payrolls/SalaryProcesDelete/';
