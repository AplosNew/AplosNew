'use strict';
dailyAllowanceTransactionController.$inject = ['cboService','commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$window'];
function dailyAllowanceTransactionController(cboService,commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $window) {
    $rootScope.title = "Daily Allowance Transaction";
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.path = 'Payrolls/preallocatedot/';
