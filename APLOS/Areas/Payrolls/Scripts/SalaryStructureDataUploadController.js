'use strict';
SalaryStructureDataUploadController.$inject = ['$scope', '$http', '$location', "$rootScope", '$window', "$compile", 'baseService', 'fileReader'];
function SalaryStructureDataUploadController($scope, $http, $location, $rootScope, $window, $compile, baseService, fileReader) {
    $scope.path = 'Payrolls/SalaryStructureDataUpload/';
    ...
    $scope.ImportData = function () {
        try {
            ...
            if ($scope.ModelNewForm.$valid) {
                ...
                $http({
                    method: 'POST',
                    url: 'Payrolls/SalaryStructureDataUpload/ImportData',
    ...
    $scope.save = function () {
        ...
        try {
            ...
            $.ajax({
                type: "POST",
                url: 'Payrolls/SalaryStructureDataUpload/SaveAttendanceRawData',
    ...
    $scope.GetSampleFile = function () {
        ...
        location.href = 'Payrolls/SalaryStructureDataUpload/GetSampleFile?reportFormat=' + ReportFormat;
    };
