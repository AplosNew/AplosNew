'use strict';
attendanceSlipController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function attendanceSlipController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {
    ...
    $scope.GetEmployeeInformation = function () {
        ...
        //}
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'payrolls/AttendanceSlip/GetEmpInfo',
                data: parameters
    ...
    $scope.GetEmployeeAttdnSlip = function () {
        try {
            ...
            $http({
                method: 'POST',
                url: 'payrolls/AttendanceSlip/GetEmployeeAttdnSlip',
                data: {
                    'month': $scope.month,
                    'year': $scope.year,
