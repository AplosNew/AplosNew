'use strict';
SalaryProcessOtherStatusNewController.$inject = ['addressService', 'fileReader', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$window'];
function SalaryProcessOtherStatusNewController(addressService, fileReader, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $window) {
    $rootScope.title = ' Salary Process (Other Status)';
    $scope.Action = 'Save';
    $scope.path = 'payrolls/SalaryProcessOtherStatusNew/';
    ...
    $scope.GetEmployee_sep = function () {
        try {
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'payrolls/SalaryProcessOtherStatusNew/GetSeparatedEmpInfo',
                data: parameters
    ...
    $scope.GetEmployee_sep_zero = function () {
        try {
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'payrolls/SalaryProcessOtherStatusNew/GetSeparatedEmpZeroPresentInfo',
                data: parameters
            }).then(function successCallback(response) {
    ...
    $scope.GetEmployee_sep_Approved = function () {
        try {
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'payrolls/SalaryProcessOtherStatusNew/GetSeparatedApprovedEmpInfo',
                data: parameters
            }).then(function successCallback(response) {
                if (response.data.Error === true) {
    ...
    $scope.GetEmployee_mlv = function () {
        try {
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'payrolls/SalaryProcessOtherStatusNew/GetmlvEmpInfo',
                data: parameters
            }).then(function successCallback(response) {
    ...
    $scope.GetEmployee_mlv_Approved = function () {
        try {
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'payrolls/SalaryProcessOtherStatusNew/GetMLVApprovedEmpInfo',
                data: parameters
            }).then(function successCallback(response) {
    ...
    $scope.GetEmployee_tbs = function () {
        try {
            ...
            $http({
                method: "POST",
                dataType: 'JSON',
                url: 'payrolls/SalaryProcessOtherStatusNew/GettbsEmpInfo',
                data: parameters
            }).then(function successCallback(response) {
