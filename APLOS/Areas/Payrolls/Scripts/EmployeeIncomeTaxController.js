...
function EmployeeIncomeTaxController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, fileReader) {
    ...
    //#region Taxable Income Functions
    ...
    $scope.TaxableAmtPopup = [];
    $scope.GetTaxAmtGridData = function () {
        ...
        $http({
            method: 'POST',
            url: $scope.path + "GetTaxAmtGridData",
            data: {
                'PolicyId': $scope.EmployeeIncomeTaxModel.TaxPolicyHeaderId,
                'EmpId': $scope.EmployeeIncomeTaxModel.EmpSystemId,
                'YearId': $scope.EmployeeIncomeTaxModel.TaxYearId
            ...
            $scope.TaxableAmtPopup = [];
            $scope.TaxableAmtPopup = response.data;

        });
    }

    $scope.RebatePopUp = [];
    $scope.GetRebateAmtGridData = function () {
        ...
        $http({
            method: 'POST',
            url: $scope.path + "GetRebateGridData",
            data: {
                'PolicyId': $scope.EmployeeIncomeTaxModel.TaxPolicyHeaderId,
                'EmpId': $scope.EmployeeIncomeTaxModel.EmpSystemId,
                'YearId': $scope.EmployeeIncomeTaxModel.TaxYearId
            ...
            $scope.RebatePopUp = [];
            $scope.RebatePopUp = response.data;
