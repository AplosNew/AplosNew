"use strict";
InvestmentSettelmentController.$inject = ["accountService", "bankService", "cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$http", "$filter", "$controller"];
function InvestmentSettelmentController(accountService, bankService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    $rootScope.title = "Investment Settelment";
    $scope.Action = "Save";
    $scope.index = -1;
    $scope.voucherList = [];
    ...
    $scope.showInvestmentPopUp = function () {
        $scope.getPopUpData();
