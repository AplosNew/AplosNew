'use strict';
interPlantInvestmentTakenOpeningBalanceController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', '$controller'];
function interPlantInvestmentTakenOpeningBalanceController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, $controller) {
    ...
    baseService.init('accounts/OpeningBalance/GetInterPlantInvestmentTakenList', null, null, 'DESC', 'PostingDate', 'PostingDate');
    ...
    $scope.Save = function () {
        ...
        if ($scope.form1.$valid & !$scope.invalidDocDate && !invalidEntity) {
            if ($scope.Action === 'Update') {
                $http({
                    method: 'POST',
                    url: 'accounts/OpeningBalance/UpdateInterPlantInvestmentTaken',
                    data: {
