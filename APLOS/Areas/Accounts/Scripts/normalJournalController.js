"use strict";
normalJournalController.$inject = ["accountService", "cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$http", "$filter", "$controller"];
function normalJournalController(accountService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    ...
    $scope.deleteUrl = "accounts/voucher/DeleteJournal";
    ...
    baseService.init("Accounts/Voucher/GetAdvanceJournalList", null, null, "DESC", "PostingDate DESC, VoucherNo", "VoucherNo");
    ...
    $scope.Get = function (data) {
        ...
        $scope.voucher.VoucherDate = $filter("dateFiltering")(data.VoucherDate);
        //$scope.GetCurrencyExchangeRateList();
    ...
    $scope.Save = function () {
        ...
        if ($scope.form0.$valid) {
            if ($scope.Action === "Save") {
                $http({
                    method: "POST",
                    url: "accounts/voucher/ParkAdvanceJournal",
                    data: {
