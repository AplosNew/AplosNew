'use strict';
inventoryIssueReturnJournalController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$http', '$filter', '$window'];
function inventoryIssueReturnJournalController(cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $window) {
    $rootScope.title = "Inventory Issue Return Posting";
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.dataList = [];
    ...
    cboService.getCboVoucherTypeIssueReturnJournalList(function (result) {
