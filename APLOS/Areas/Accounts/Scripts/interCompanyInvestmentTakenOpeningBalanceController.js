'use strict';
interCompanyInvestmentTakenOpeningBalanceController.$inject = ['cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', '$controller'];
function interCompanyInvestmentTakenOpeningBalanceController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, $controller) {
    ...
    baseService.init('accounts/OpeningBalance/GetInterCompanyInvestmentTakenList', null, null, 'DESC', 'PostingDate', 'PostingDate');
    ...
    $scope.Save = function () {
        ...
        if ($scope.form1.$valid && !$scope.invalidDocDate && !$scope.invalidRow && !invalidEntity) {
            if ($scope.Action === 'Update') {
                $http({
                    method: 'POST',
                    url: 'accounts/OpeningBalance/UpdateInterCompanyInvestmentTaken',
                    data: {
