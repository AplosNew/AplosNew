baseOpeningBalanceController.$inject = ['$rootScope', '$scope', '$http', '$filter', 'baseService', 'cboService', 'commonMessage'];
function baseOpeningBalanceController($rootScope, $scope, $http, $filter, baseService, cboService, commonMessage) {
    $scope.Action = 'Save';
    $scope.index = -1;
    ...
    $scope.closeCashPopUp = function () {
        if ($scope.cashIndex !== -1) {
            ...
            if (baseService.isUndefinedOrNull(cash.GLGeneralInfoId)) {
                ...
                $scope.openingBalanceDetail.CashCurrencyId = cash.CurrencyId;
                $scope.openingBalanceDetail.BankAmount = 0;
    ...
    function addBankRow(bank) {
        ...
        $scope.openingBalanceDetail.BankCurrencyId = bank.CurrencyId;
        $scope.openingBalanceDetail.BankAmount = 0;
        ...
        $scope.openingBalanceDetail.PartyType = 'Bank';
        $scope.openingBalanceDetail.LifeOfYear = 0;
        $scope.openingBalanceDetail.NoOfInstallmentPerYear = 0;
        $scope.openingBalanceDetail.NoOfPaidInstallment = 0;
        $scope.openingBalanceDetail.TotalNoOfInstallment = 0;
