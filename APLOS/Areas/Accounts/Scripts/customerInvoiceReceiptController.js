"use strict";
customerInvoiceReceiptController.$inject = ["bankService", "cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$http", "$filter", "$controller"];
function customerInvoiceReceiptController(bankService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    ...
    $scope.getPopupCustomerReceivableList = function () {
            $scope.customerInvoiceParameters.partyId = $scope.voucher.PartyId;
