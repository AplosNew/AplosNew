"use strict";
GroupBalanceReportController.$inject = ["$scope", "$rootScope", "$filter", "accountService", "$window", "baseService"];
function GroupBalanceReportController($scope, $rootScope, $filter, accountService, $window, baseService) {
    $rootScope.title = "Group Balance";
    $scope.report = {
        GLName: null,
