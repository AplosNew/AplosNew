"use strict";
directorRemunerationController.$inject = ["cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$http", "$filter", "$controller", "bankService", '$window'];
function directorRemunerationController(cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller, bankService, $window) {
    $rootScope.title = "Director Remuneration";
    ...
    $scope.ServiceGLSelect = function (obj) {
        ...
        $scope.voucherDetail.ServiceName = $scope.model.ServiceName;
