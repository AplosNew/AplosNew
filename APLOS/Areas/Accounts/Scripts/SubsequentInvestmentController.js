"use strict";
SubsequentInvestmentController.$inject = ["accountService", "bankService", "cboService", "commonMessage", "$scope", "$rootScope", "baseService", "$http", "$filter", "$controller"];
function SubsequentInvestmentController(accountService, bankService, cboService, commonMessage, $scope, $rootScope, baseService, $http, $filter, $controller) {
    $rootScope.title = "Subsequent Investment";
    $scope.Action = "Save";
    $scope.index = -1;
    $scope.voucherList = [];
