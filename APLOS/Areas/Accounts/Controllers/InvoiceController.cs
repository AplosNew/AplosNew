    ...
    public class InvoiceController : BaseController
    {
            ...
            , IEnumerable<InvoiceTaxViewModel> taxDetailVMList, IEnumerable<InvoiceTaxViewModel> tdsVMList)
        {
            ...
            if (voucherVM.BeneficiaryType == NewBeneficiaryType.Vendor.ToString())
                return Json(new { Message = string.Format(AplosMessage.VoucherSave, _invoiceService.InsertVendorInvoice(voucherVM, voucherDetailVMList, taxDetailVMList, tdsVMList)) });
            else
