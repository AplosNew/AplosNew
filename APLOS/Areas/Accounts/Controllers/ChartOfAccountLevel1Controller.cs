...
{
    public class ChartOfAccountLevel1Controller : BaseController
    {
        private readonly IChartOfAccountLevel1Service _chartOfAccountLevel1Service;

        public ChartOfAccountLevel1Controller(IChartOfAccountLevel1Service chartOfAccountLevel1Service)
        {
        ...
        {
            return View("~/Areas/Accounts/Views/ChartOfAccountLevel1.cshtml");
        }
