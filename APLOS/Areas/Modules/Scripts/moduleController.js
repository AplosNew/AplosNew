'use strict';
ModuleController.$inject = ['cboService', '$route', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter'];
function ModuleController(cboService, $route, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter) {
    $rootScope.title = 'Module';
    $scope.Action = 'Save';
    $scope.index = -1;
    $scope.modules = [];
    $scope.path = 'Modules/module/';
    $scope.getListUrl = $scope.path + 'getmodulelist';
    ...
    $scope.getSequence = function () {
        cboService.getSequence('Modules/module/getautosequence', function (result) {
                ...
                $http({
                    ...
                    function success(response) {
                        if (response.data.Error === true) {
                            ...
                            $scope.modules.push(response.data.Module);
