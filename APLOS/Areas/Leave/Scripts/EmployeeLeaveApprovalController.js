'use strict';
EmployeeLeaveApprovalController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'cboService'];
function EmployeeLeaveApprovalController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, cboService) {
    $rootScope.title = 'Employee Leave Approval';
    $scope.Action = 'Save';   
    $scope.path = 'Leave/EmployeeLeaveApproval/';
