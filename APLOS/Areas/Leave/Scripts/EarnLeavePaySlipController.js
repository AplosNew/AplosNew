'use strict';
EarnLeavePaySlipController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'toaster', 'cboService', '$window'];
function EarnLeavePaySlipController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, toaster, cboService, $window) {

    $scope.path = 'Leave/EarnLeavePaySlip/';
    ...
    $scope.GetEmployeeAttdnSlip = function () {
        try {
            var parameters = [];
            ...
            $http({
                method: 'POST',
                url: $scope.path +'GetEmployeeELPaySlip',
                data: {                   
                    'CalanderYearId': $scope.year,                    
