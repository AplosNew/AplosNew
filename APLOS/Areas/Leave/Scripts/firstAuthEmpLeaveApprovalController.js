'use strict';
firstAuthEmpLeaveApprovalController.$inject = ['commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', 'cboService'];
function firstAuthEmpLeaveApprovalController(commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, cboService) {
    $rootScope.title = 'Employee Leave Approval';
    $scope.Action = 'Save';   
    $scope.path = 'Leave/FirstAuthEmpLeaveApproval/';
