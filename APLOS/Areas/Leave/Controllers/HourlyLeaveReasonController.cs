...
{
    public class HourlyLeaveReasonController : BaseController
    {
        string TableName = "hkp.HourlyLeaveReason";
        //authentication for
        ...
        public HourlyLeaveReasonController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult Get(string Id)
        {
            try
            {
                var _master = _sqlRepository.GetDataCollection("select * from hkp.HourlyLeaveReason where Id = '" + Id + "' ");
