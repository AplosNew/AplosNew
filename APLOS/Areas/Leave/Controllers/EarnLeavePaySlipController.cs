...
{
    public class EarnLeavePaySlipController : BaseController
    {
        #region Constructor
        ...
        public EarnLeavePaySlipController(
        ...
        //        Dictionary<string, List<DataRow>> dicMonthlyAttdnSummary = GetEmployeeELInformation(identity.PlantId, fdateOfMonth, ldateOfMonth, languageId, parameters, isActive, isSeperated, isMaternity);
        ...
        [HttpPost]
        public ActionResult GetEmployeeELPaySlip(string CalanderYearId,string languageId, Dictionary<string, string> parameters)
        {
            try
            {
                var identity = (CustomIdentity)Thread.CurrentPrincipal.Identity;

                var fileName = "EL Pay Slip" + DateTime.Now.ToString("yyMMdd") + identity.Name + ".xlsx";
                string fullPath = System.Web.Hosting.HostingEnvironment.MapPath("~/") + fileName;
                ...
                GetEmployeeInfoDetail( identity.PlantId, languageId, parameters,  out dsEmpLoyeeInfo);//Sql Query For Salary  Data
                //Dictionary<string, List<DataRow>> dicMonthlyAttdnSummary = GetEmployeeAttdnSummaryInformation(identity.CompanyGroupId, identity.CompanyId, identity.PlantId, fdateOfMonth, ldateOfMonth, languageId, parameters, isActive, isSeperated, isMaternity);

                Dictionary<string, List<DataRow>> dicELInformation = GetEmployeeELInformation(identity.PlantId, CalanderYearId, parameters);
                    ...
                    try
                    {
                        for (int i = 0; i < dtEmpLoyeeInfo.Rows.Count; i++)
                        {
                            try
                            {
                                ...
                                attdnInfoStartCol = employeeInfoEndCol;
                                if (dicELInformation.ContainsKey(dtEmpLoyeeInfo.Rows[i]["SystemID"].ToString()))
                                {
                                    List<DataRow> drAttdnSummaryCollection = dicELInformation[dtEmpLoyeeInfo.Rows[i]["SystemID"].ToString()];
                                    attdnInfoStartRow = employeeInfoStartRow;
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol, employeeInfoStartRow, attdnInfoStartCol + 3].BorderAround(ExcelLineStyle.Hair);
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].Text = ru.GetLabelname(labelList, LabelNameInLocalLanguage.AttendanceInfo.ToString(), "Earn Leave Information");
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol, employeeInfoStartRow, attdnInfoStartCol + 3].Merge();
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].CellStyle.Font.FontName = printFont;

                                    employeeInfoStartRow++;
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].Text = ru.GetLabelname(labelList, LabelNameInLocalLanguage.WeeklyLeaveDays.ToString(), "Earning Days") + ":   ";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].CellStyle.Font.FontName = printFont;
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol, employeeInfoStartRow, attdnInfoStartCol + 1].Merge();
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 2].Text = ":";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].Number = +clsStaticInfo.dbl(drAttdnSummaryCollection[0]["CalculatedEarningDays"].ToString());
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].NumberFormat = ru.GetDecimalFormatlocal(0, localLanguage);
                                    ...
                                    employeeInfoStartRow++;
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].Text = ru.GetLabelname(labelList, LabelNameInLocalLanguage.Present.ToString(), "Brought Forward") + ":   ";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].CellStyle.Font.FontName = printFont;

                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol, employeeInfoStartRow, attdnInfoStartCol + 1].Merge();
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 2].Text = ":";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].Number = Convert.ToDouble(clsStaticInfo.dbl(drAttdnSummaryCollection[0]["BroughtForward"].ToString()));
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].NumberFormat = ru.GetDecimalFormatlocal(0, localLanguage);
                                    employeeInfoStartRow++;

                                    //sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].Text = ru.GetLabelname(labelList, LabelNameInLocalLanguage.AvailedLeave.ToString(), "Current Year Allocation") + ":   ";
                                    //sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].CellStyle.Font.FontName = printFont;
                                    //sheet1.Range[employeeInfoStartRow, attdnInfoStartCol, employeeInfoStartRow, attdnInfoStartCol + 1].Merge();
                                    //sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 2].Text = ":";
                                    //sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].Number = clsStaticInfo.dbl(drAttdnSummaryCollection[0]["CurrentYearAllocation"].ToString());
                                    //sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].NumberFormat = ru.GetDecimalFormatlocal(0, localLanguage);

                                    //employeeInfoStartRow++;

                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].Text = ru.GetLabelname(labelList, LabelNameInLocalLanguage.HoliDay.ToString(), "LeaveDays Allowed") + ":   ";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].CellStyle.Font.FontName = printFont;
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol, employeeInfoStartRow, attdnInfoStartCol + 1].Merge();
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 2].Text = ":";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].Number = clsStaticInfo.dbl(drAttdnSummaryCollection[0]["LeaveDaysAllowed"].ToString());
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].NumberFormat = ru.GetDecimalFormatlocal(0, localLanguage);

                                    employeeInfoStartRow++;

                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].Text = ru.GetLabelname(labelList, LabelNameInLocalLanguage.AbsentDays.ToString(), "Availed Leave") + ":   ";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].CellStyle.Font.FontName = printFont;
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol, employeeInfoStartRow, attdnInfoStartCol + 1].Merge();
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 2].Text = ":";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].Number = clsStaticInfo.dbl(drAttdnSummaryCollection[0]["AvailedLeave"].ToString());
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].NumberFormat = ru.GetDecimalFormatlocal(0, localLanguage);

                                    employeeInfoStartRow++;

                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].Text = ru.GetLabelname(labelList, LabelNameInLocalLanguage.TotalAttendance.ToString(), "Encashed") + ":   ";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].CellStyle.Font.FontName = printFont;
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol, employeeInfoStartRow, attdnInfoStartCol + 1].Merge();
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 2].Text = ":";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].Number = clsStaticInfo.dbl(drAttdnSummaryCollection[0]["EncashedInbetween"].ToString());
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].NumberFormat = ru.GetDecimalFormatlocal(0, localLanguage);
                                    ...
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].Text = ru.GetLabelname(labelList, LabelNameInLocalLanguage.TotalAttendance.ToString(), "Balance") + ":   ";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol].CellStyle.Font.FontName = printFont;
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol, employeeInfoStartRow, attdnInfoStartCol + 1].Merge();
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 2].Text = ":";
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].Number = clsStaticInfo.dbl(drAttdnSummaryCollection[0]["Balance"].ToString());
                                    sheet1.Range[employeeInfoStartRow, attdnInfoStartCol + 3].NumberFormat = ru.GetDecimalFormatlocal(0, localLanguage);
                ...
                sheet1.Name = "EL Pay Slip";
                #endregion




                fileName = "ELPaySlip" + DateTime.Now.ToString("yyMMdd") + identity.Name + ".xlsx";
                string fullPathPDF = Path.Combine(System.Web.Hosting.HostingEnvironment.MapPath("~/") + fileName);
        ...
        public void GetEmployeeInfoDetail(string plantId, string languageId ,Dictionary<string, string> parameters, out DataSet dsRef)
        {
            string strSQL;
            ...
            try
            {
                ...
                if (parameters.Count > 0)
                {
                    ...
                    {
                        strSQL += @" Where SystemID IN(" + parameters["EmpSystemId"] + ")";
                    }
                }
        ...
        public Dictionary<string, List<DataRow>> GetEmployeeELInformation( string PlantId, string CalanderYearId,Dictionary<string, string> parameters)
        {
            string strSQL;
            DataSet dsRef = null;
            Dictionary<string, List<DataRow>> dicAttdn = new Dictionary<string, List<DataRow>>();
            ...
            try
            {
                ...
                strSQL = @" select 
                            s.EmployeeId EmpInfoSystemID,e.EmployeeCode,e.EmployeeName,Format(e.DOJ,'dd-MMM-yyyy') DOJ,e.PlantId, t.UserName LeaveType
                            ,s.BroughtForward
                            ...
                            ,Balance=isnull(s.BroughtForward,0)+isnull(s.DaysCanBeSanctioned,0)-isnull(kk.LeaveDuration,0)-isnull(s.EncashedInbetween,0),s.CalculatedEarningDays,s.EncashedInbetween
                            from trn.EmployeeLeaveSummary s 
                            left join LeaveType t on s.LeaveTypeId=t.Id
                            ...
                            (select FromDate from YearlyCalendar where Id='" + CalanderYearId + @"' and PlantId='" + PlantId + @"'
                            )
                            and (select ToDate from YearlyCalendar where Id='" + CalanderYearId + @"' and PlantId='" + PlantId + @"'
                            )
                            ...
                            where s.PlantId='" + PlantId + @"' and CalanderYearId='" + CalanderYearId + @"' and t.LeaveType='earn'
                ...
                if (parameters.Count > 0)
                {
                    if (parameters.Keys.ElementAt(0) != "")
                    {
                        strSQL += @" AND  s.EmployeeId IN(" + parameters["EmpSystemId"] + ")";
                    }
                }

                strSQL += " ORDER BY   s.EmployeeId";
