...
function OSTransformationPOController(cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $controller, $window, accountService) {
    ...
    $scope.productionOredrMapListUrl = $scope.path + 'GetProductionOredrMapList?entityid=';
    ...
    $scope.GetProductionOrderPopUp = function () {
        if (!baseService.isUndefinedOrNull($scope.productNew.EntityId)) {
            $http({
                method: 'POST',
                data: {
                    'entityid': $scope.productNew.EntityId, 'processid': $scope.productNew.ProcessId, 'column': $scope.PRSearchColumn, 'value': $scope.PRSearchValue
                },
    ...
    $scope.SetPrOData = function () {
        ...
        $scope.rowLength = $filter("filter")($scope.selectedProductionOrder, { 'POId': gridObj.getSelectedRecords()[0].POId });
    ...
    // Shashank
    $scope.pathJWCBO = 'Outsourcing/JobWorkValueAddedContract/';
    ...
    $scope.NotificationSettingStatus = function () {
        ...
        $http({
            method: 'GET',
            url: 'Outsourcing/OSTransformationPO/NotificationSetting',
            dataType: 'JSON'
        }).then(function successCallback(response) {
    ...
    $scope.getalldata = function () {
        ...
        $http({
            ...
            url: 'Outsourcing/OSTransformationPO/GetPOTypeList?POTypeStatus=' + $scope.POTypeStatus
        }).then(function successCallback(response) {
    ...
    $scope.getalldataPoApp = function () {
        ...
        $http({
            method: "GET",
            dataType: 'JSON',
            url: 'Outsourcing/OSTransformationPO/GetListForHoldRejectApproved?ApproveRejectHold=' + $scope.ApproveRejectHold,
        }).then(function successCallback(response) {
    ...
    $scope.recorddoubleclick = function ($event) {
        ...
        $scope.loadProcessList(x.data.EntityId);
        $scope.productNew.ProcessId = x.data.ProcessId;
        $scope.getPoChilddata();
        $scope.getPoProductionOrderMapData();
                ...
                if (!$scope.checkDateValidation()) {
                    if ($scope.Action === "Save") {
                        $http({
                            ...
                            data: {
                                'data': $scope.product,
                                'mapdata': $scope.selectedProductionOrder
    ...
    $scope.getPoProductionOrderMapData = function () {
        $http({
            method: "POST",
            dataType: 'JSON',
            url: $scope.productionOredrMapListUrl + $scope.productNew.EntityId + '&processid=' + $scope.productNew.ProcessId + '&osPOId=' + $scope.productNew.Id
        }).then(function successCallback(response) {
            $scope.selectedProductionOrder = response.data;
        });
    };
    ...
    $scope.SaveMatPlanning = function () {
        ...
        $scope.path = "Outsourcing/JobWorkValueAddedContract/";
        $http({
            method: 'POST',
    ...
    $scope.GetTransformOrderWiseUOM = function () {
        $http({
            method: 'GET',
            url: 'Outsourcing/JobWorkValueAddedContract/getoutputunit/',
        }).then(function successCallback(response) {
    ...
    $scope.SaveTransformOrderWiseReqTab = function () {
        ...
        if ($scope.TransformOrderWiseReqForm.$valid) {
            $http({
                method: 'POST',
                url: 'Outsourcing/JobWorkValueAddedContract/SaveTransformOrderWiseReqTab/',
    ...
    $scope.DelTransformOrderWise = function () {
        $http({
            method: 'GET',
            url: 'Outsourcing/JobWorkValueAddedContract/DelTransformOrderWise?Id=' + $scope.TransformOrderWiseChildTabId
        }).then(function successCallback(response) {
            if (response.data.Error == true) {
                ShowResult(response.data.Message, "failure");
            }
    ...
    $scope.getMatInputListData = function () {
        $http({
            method: 'GET',
            url: 'Outsourcing/JobWorkValueAddedContract/getMatInputListData?JobWorkItemId=' + $scope.JWInputId + '&ActivityId=' + $scope.JWActivityId + '&Id=' + $scope.MatPlanningTabId
        }).then(function successCallback(response) {
    ...
    $scope.SaveMaterialInputTab = function () {
        ...
        try {
            ...
            $http({
                ...
                url: 'Outsourcing/JobWorkValueAddedContract/SaveMaterialInputTab/'
            }).then(function successCallback(response) {
                if (response.data.Error == true) {
                    ShowResult(response.data.Message, "failure");
                }
    ...
    $scope.DelMaterialInput = function () {
        $http({
            method: 'GET',
            url: 'Outsourcing/JobWorkValueAddedContract/DelMaterialInput?Id=' + $scope.MaterialInputChildTabId
        }).then(function successCallback(response) {
            if (response.data.Error == true) {
                ShowResult(response.data.Message, "failure");
            }
    ...
    $scope.getMaterialInputData = function () {
        ...
        $http({
            method: 'GET',
            url: 'Outsourcing/JobWorkValueAddedContract/getMaterialInputData?MaterialMasterId=' + $scope.MatPlanningTabId
        }).then(function successCallback(response) {
    ...
    $scope.getByProductMasterData = function () {
        ...
        $http({
            method: 'GET',
            url: 'Outsourcing/JobWorkValueAddedContract/getByProductMasterData?JobWorkItemId=' + $scope.JWInputId + '&ActivityId=' + $scope.JWActivityId + '&Id=' + $scope.MatInputTabId
        }).then(function successCallback(response) {
    ...
    $scope.getMaterialDetailsData = function (data) {
        ...
        $http({
            method: 'POST',
            url: 'Outsourcing/JobWorkValueAddedContract/LoadMaterialMstDetails/'
        }).then(function successCallback(response) {
    ...
    $scope.getArticleData = function (RowData) {
        ...
        $http({
            method: 'POST',
            data: { MaterialMstId: $scope.MatMstId },
            url: 'Outsourcing/JobWorkValueAddedContract/LoadMaterialMstArticle/'
        }).then(function successCallback(response) {
    ...
    $scope.SaveByProductTab = function () {
        ...
        try {
            ...
            $http({
                ...
                url: 'Outsourcing/JobWorkValueAddedContract/SaveByProductTab/'
            }).then(function successCallback(response) {
                if (response.data.Error == true) {
                    ShowResult(response.data.Message, "failure");
                }
    ...
    $scope.DelByProduct = function () {
        $http({
            method: 'GET',
            url: 'Outsourcing/JobWorkValueAddedContract/DelByProduct?Id=' + $scope.ByProductTabId
        }).then(function successCallback(response) {
            if (response.data.Error == true) {
                ShowResult(response.data.Message, "failure");
            }
    ...
    $scope.getByProductData = function () {
        $http({
            method: 'GET',
            url: 'Outsourcing/JobWorkValueAddedContract/getByProductData?MaterialInputId=' + $scope.MatInputTabId
        }).then(function successCallback(response) {
    ...
    $scope.DocumentSave = function () {
        ...
        try {
            ...
            $http({
                method: "POST",
                url: 'Outsourcing/OSTransformationPO/PODocCreate',
                headers: { 'Content-Type': undefined },
                transformRequest: function (data) {
    ...
    $scope.ImagedataLoad = function () {
        $http({
            method: "GET",
            dataType: 'JSON',
            url: 'Outsourcing/OSTransformationPO/PODocumentMapData?POID=' + $scope.productNew.Id,
        }).then(function successCallback(response) { //datagatefun
    ...
    $scope.DeletePOIgame = function (Id) {
        ...
        if (!baseService.isUndefinedOrNull($scope.DocId)) {
            $http({
                method: 'POST',
                url: 'Outsourcing/OSTransformationPO/POImageDelete?Id=' + $scope.DocId,
                dataType: 'JSON'
            }).then(function (response) {
                if (response.data.Error === true)
                    ShowResult(response.data.Message, 'failure');
    ...
    $scope.PODocumentMapDataAll = function () {
        ...
        $http({
            method: 'GET',
            url: 'Outsourcing/OSTransformationPO/PODocumentMapDataAll'
        }).then(function successCallback(response) {
