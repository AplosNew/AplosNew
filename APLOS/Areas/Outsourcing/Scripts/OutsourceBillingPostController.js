...
function OutsourceBillingPostController($window, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, factoryService) {
    ...
    $scope.path = 'Outsourcing/OutSourceBillingPost/';
    ...
    $scope.getPopUpData = function () {
        $http({
            method: 'GET',
            url: 'Outsourcing/OutSourceBillingPost/GetOutsourcingBillingNonPostData',
    ...
    $scope.GetDetailData = function (masterId) {
        $http({
            method: 'GET',
            url: 'Outsourcing/OutSourceBillingPost/GetJWReceiveBillingDetailData?masterId=' + masterId
        }).then(function successCallback(response) {
    ...
    $scope.GetOutsourcingBillingJV=function (billingId) {
        $http.get('Outsourcing/OutSourceBillingPost/GetOutsourcingBillingJV?billingId=' + billingId)
