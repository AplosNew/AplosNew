...
function OSReceiveBillingController($window, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, factoryService) {
    ...
    $scope.masterList = [];
    $scope.ContractList = [];
    $scope.path = 'Outsourcing/OSReceiveBilling/';
    ...
    $scope.GetData = function () {
        $http({
            method: 'GET',
            url: 'Outsourcing/OSReceiveBilling/GetJWReceiveBillingData'
        }).then(function successCallback(response) {
    ...
    $scope.GetDetailData = function (masterId, contractId, inventoryReceiveIds) {
        $http({
            method: 'GET',
            url: 'Outsourcing/OSReceiveBilling/GetJWReceiveBillingDetailData?masterId=' + masterId + '&contractId=' + contractId + '&inventoryReceiveIds=' + inventoryReceiveIds
        }).then(function successCallback(response) {
    ...
    $scope.GetJWGRNDataChecking = function (contractId) {
        ...
        $http({
            method: "GET",
            dataType: 'JSON',
            url: 'Outsourcing/OSReceiveBilling/GetInventoryReceiveByTransformationContractId?contractId=' + contractId,
        }).then(function successCallback(response) {
    ...
    $scope.GetSavedGRNList = function (masterId) {
        $http({
            method: 'GET',
            url: 'Outsourcing/OSReceiveBilling/GetSavedGRNList?masterId=' + masterId
        }).then(function successCallback(response) {
    ...
    $scope.GetGRNDetailData = function (masterId, contractId, InventoryReceiveIds) {
        $http({
            method: "GET",
            dataType: 'JSON',
            url: 'Outsourcing/OSReceiveBilling/GetInventoryReceiveDetailByOutSourcePO?masterId=' + masterId + '+&contractId=' + contractId + '&inventoryReceiveIds=' + InventoryReceiveIds,
        }).then(function successCallback(response) {
            $scope.JWPOList = response.data;
        });
    }
    ...
    $scope.Save = function () {
        try {
            ...
            if ($scope.Action === 'Save' || $scope.Action === 'Update') {
                $http({
                    method: 'POST',
                    url: 'Outsourcing/OSReceiveBilling/Create',
                    data: {
