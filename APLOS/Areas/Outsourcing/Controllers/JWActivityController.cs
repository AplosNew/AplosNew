...
{
    public class JWActivityController : BaseController
    {
        string TableName = "JWActivity";
        //authentication for
        ...
        public JWActivityController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        public ActionResult GetList(string column, string value)
        {
            ...
            string sql = @"select JWA.*,EEI.EmployeeName ResponsiblePersonName,SM.UserName ServiceName,PRC.UserName ProcessName from JWActivity JWA 
