...
{
    public class SecretarialDocumentCategoryController : BaseController
    {

        //string TableName = "hkp.DocumentType";

        string TableName = "[HKP].[SecretarialDocumentCategory]";
        // string TableName = "BankCashPercentageSettinng";

        #region Constructor

        private readonly ISqlRepository _sqlRepository;
        public SecretarialDocumentCategoryController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
        ...
        //    try
        //    {
        //        var _master = _sqlRepository.GetDataCollection("select * from [HKP].[SecretarialDocumentCategory] wher Id = '" + Id + "' ");
        ...
        {
            string sql = @"select * from [HKP].[SecretarialDocumentCategory] where Id = '" + id + "'";
