...
{
    public class TaskSubCategoryIssueController : BaseController
    {
        private static string Flag = TaskCategoryFlagEnum.Issue.ToString();
        ...
        public TaskSubCategoryIssueController(ISqlRepository R)
        {
            _sqlRepository = R;
        }
