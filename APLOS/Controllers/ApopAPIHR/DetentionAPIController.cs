...
where SU.UserId = '" + Userid + "'"));
        ...
        public IHttpActionResult GetWorkcenter(string EntityId , string ProcessId)
        {
            ...
            try
            {
                return Json(_sqlRepository.GetDataTable(@"Select Id Value , UserName Name from scs.WorkCenterMaster where ProcessId = '" + ProcessId + "' and EntityId = '" + EntityId + "'  and Active = 1 order by Code asc"));
