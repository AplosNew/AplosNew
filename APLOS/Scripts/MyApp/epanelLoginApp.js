'use strict';
var epanelLoginApp = angular.module('epanelLoginApp', ['ngRoute', 'ngCookies', 'angularUtils.directives.dirPagination', 'toaster'])
    .controller('epanelLoginController', epanelLoginController)
