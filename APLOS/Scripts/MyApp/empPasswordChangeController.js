'use strict';
empPasswordChangeController.$inject = ['$scope', 'baseService', '$routeParams', '$http', '$filter'];
function empPasswordChangeController($scope, baseService, $routeParams, $http, $filter) {
    Get($routeParams.id);
    ...
    function Get(id) {
        $http.get('MyApp/getforpasswordchange?id=' + id)
