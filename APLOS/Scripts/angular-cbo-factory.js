...
function cboService($http, $window, $rootScope, baseService) {
    var service = {
        ...
        , GetBudgetMasterActivityLevelWithServiceMasterPotalCbo: GetBudgetMasterActivityLevelWithServiceMasterPotalCbo
        ...
        , GetCboByPlantAdmin: GetCboByPlantAdmin
        ...
        , getCboVoucherTypeDirectorRemunerationList: getCboVoucherTypeDirectorRemunerationList
    ...
    function GetBudgetMasterActivityLevelWithServiceMasterPotalCbo(budgetMasterId, level, employeeId, callback) {
        base('SetUps/ServiceMaster/GetBudgetMasterActivityLevelWithServiceMasterPotalCbo?budgetMasterId=' + budgetMasterId + '&level=' + level + '&employeeId=' + employeeId, callback);
    }
    ...
    function getCboVoucherTypeDirectorRemunerationList(callback) {
        base('accounts/VoucherTypeMatrix/GetCboVoucherTypeDirectorRemunerationList', callback);
    }
    ...
    function GetCboByPlantAdmin(companyGroupId, companyId, plantId, callback) {
        if (baseService.isUndefinedOrNull(companyGroupId)) {
            if (!baseService.isUndefinedOrNull($window.companyGroupId))
                companyGroupId = $window.companyGroupId;
            else
        ...
        base('Organizations/entity/GetCboByPlantAdmin?companyGroupId=' + companyGroupId + '&companyId=' + companyId + '&plantId=' + plantId, callback);
    }
