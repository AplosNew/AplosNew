 'use strict';
myParentsCalendarController.$inject = ['uiCalendarConfig', '$uibModal', 'fileReader', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$cookies'];
function myParentsCalendarController(uiCalendarConfig, $uibModal,fileReader, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $cookies) {
    $scope.eventsTab = [];
