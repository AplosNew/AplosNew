'use strict';
parentsPasswordChangeController.$inject = ['$scope', 'baseService', '$routeParams', '$http', '$filter'];
function parentsPasswordChangeController($scope, baseService, $routeParams, $http, $filter) {
    Get($routeParams.id);
    ...
    function Get(id) {
        $http.get('MyParents/getforpasswordchange?id=' + id)
