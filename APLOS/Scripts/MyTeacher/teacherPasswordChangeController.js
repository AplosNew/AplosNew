'use strict';
teacherPasswordChangeController.$inject = ['$scope', 'baseService', '$routeParams', '$http', '$filter'];
function teacherPasswordChangeController($scope, baseService, $routeParams, $http, $filter) {
    Get($routeParams.id);
    ...
    function Get(id) {
        $http.get('MyTeacher/getforpasswordchange?id=' + id)
