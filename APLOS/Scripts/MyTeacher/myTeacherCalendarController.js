 'use strict';
myTeacherCalendarController.$inject = ['uiCalendarConfig', '$uibModal', 'fileReader', 'cboService', 'commonMessage', '$scope', '$rootScope', 'baseService', '$routeParams', '$location', '$http', '$filter', '$cookies'];
function myTeacherCalendarController(uiCalendarConfig, $uibModal,fileReader, cboService, commonMessage, $scope, $rootScope, baseService, $routeParams, $location, $http, $filter, $cookies) {
    $scope.eventsTab = [];
