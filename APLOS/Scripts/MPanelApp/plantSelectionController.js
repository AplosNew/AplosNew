"use strict";
plantSelectionController.$inject = ["$window", "$scope", "$rootScope", "$routeParams", "$http", "$filter", '$location', '$timeout', '$cookies'];
function plantSelectionController($window, $scope, $rootScope, $routeParams, $http, $filter, $location, $timeout, $cookies) {
