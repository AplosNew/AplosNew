"use strict";
mpanelLoginController.$inject = ["$scope", "$rootScope", "$routeParams", "$http", "$filter", "$window", "$cookies", "cboService"];
function mpanelLoginController($scope, $rootScope, $routeParams, $http, $filter, $window, $cookies, cboService) {
    $rootScope.title = "Master::Login";
    ...
    $scope.Login = function () {
        ...
        if ($scope.mpanelLoginForm.$valid) {
