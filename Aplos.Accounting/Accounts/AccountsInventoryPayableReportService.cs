...
namespace Library.Accounting.Accounts
{
    public class AccountsInventoryPayableReportService
    {
        ...
        {
            var cmdText = @"Select X.*,E.Id EntityId From(Select NULL Id,BG.Sequence BudgetGroupSequence,BG.UserName BudgetGroup,BC.Sequence BudgetCategorySequence
...
OUTER APPLY (SELECT * FROM ORG.Entity Where Id IN("+ entityids + @")) E 
...
ORDER BY X.ActivityId,E.Id";
        ...
        public DataTable GetCheckApproveData()
        {
            var cmdText = @"Select NULL Id,BMA.Id ControlId,BG.UserName BudgetGroup,BC.UserName BudgetCategory,B.UserName Budget,A.UserName Activity,R.UserName Register
,BMA.UserCategory,BMA.UserSubCategory,BMA.UserItem,BMA.UserReport,BMA.UserGroup,NULL Remark,NULL EmloyeeName,NULL Designation,NULL EmpType,NULL Department,NULL EmpCurrentStatus,NULL EmpStatus
...
LEFT JOIN [HKP].[Register] R ON R.Id=BM.RegisterId
Order by B.UserName";
            return _sqlRepository.GetDataTable(cmdText);
        ...
        public IWorkbook GetBalanceSheetSchedulingCheckingApprovingData(string Name, string CompanyGroupId, string PlantId, string CompanyId, string PlantName)
        {
            #region declare
            clsReport objRpt = null;
            clsStaticInfo objStatic = null;
            ...
            try
            {
                ...
                sheetSource = workbook.Worksheets[1];
                xlsRow = 1;
                DataTable dtData = GetCheckApproveData();
                #region ------------------Column Header------------------

                sheet[xlsRow, xlsCol].Text = "ControlId"; sheet[xlsRow, xlsCol].ColumnWidth = 10; int colBMA = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "Budget Group"; sheet[xlsRow, xlsCol].ColumnWidth = 15; int colBGU = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "Budget Category"; sheet[xlsRow, xlsCol].ColumnWidth = 30; int colBCU = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "Budget"; sheet[xlsRow, xlsCol].ColumnWidth = 35; int colBU = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "Activity"; sheet[xlsRow, xlsCol].ColumnWidth = 35; int colA = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "Register"; sheet[xlsRow, xlsCol].ColumnWidth = 25; int colRegister = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "User Category"; sheet[xlsRow, xlsCol].ColumnWidth = 30; int colUC = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "User SubCategory"; sheet[xlsRow, xlsCol].ColumnWidth = 35; int colUSC = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "User Item"; sheet[xlsRow, xlsCol].ColumnWidth = 35; int colUI = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "User Report"; sheet[xlsRow, xlsCol].ColumnWidth = 12; int colUR = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "User Group"; sheet[xlsRow, xlsCol].ColumnWidth = 15; int colUG = xlsCol; xlsCol++;
             
                sheet[xlsRow, xlsCol].Text = "Employee Name"; sheet[xlsRow, xlsCol].ColumnWidth = 15; int colEN = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "Designation"; sheet[xlsRow, xlsCol].ColumnWidth = 15; int colDesignation = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "EmpType"; sheet[xlsRow, xlsCol].ColumnWidth = 15; int colEmpType = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "Department"; sheet[xlsRow, xlsCol].ColumnWidth = 15; int colDepartment = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "EmpCurrentStatus"; sheet[xlsRow, xlsCol].ColumnWidth = 15; int colEmpCurrentStatus = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "EmpStatus"; sheet[xlsRow, xlsCol].ColumnWidth = 15; int colEmpStatus = xlsCol; xlsCol++;
                sheet[xlsRow, xlsCol].Text = "Remark"; sheet[xlsRow, xlsCol].ColumnWidth = 15; int colR = xlsCol;
                ...
                for (int i = 0; i < dtData.Rows.Count; i++)
                {
                    sheet[xlsRow, colBMA].Text = dtData.Rows[i]["ControlId"].ToString();
                    sheet.Range[xlsRow, colBMA].HorizontalAlignment = ExcelHAlign.HAlignLeft;
                    sheet.Range[xlsRow, colBMA].VerticalAlignment = ExcelVAlign.VAlignTop;
                    ...
                    sheet[xlsRow, colA].Text = dtData.Rows[i]["Activity"].ToString();
                    sheet.Range[xlsRow, colA].HorizontalAlignment = ExcelHAlign.HAlignLeft;
                    sheet.Range[xlsRow, colA].VerticalAlignment = ExcelVAlign.VAlignTop;

                    sheet[xlsRow, colRegister].Text = dtData.Rows[i]["Register"].ToString();
                    sheet.Range[xlsRow, colRegister].HorizontalAlignment = ExcelHAlign.HAlignLeft;
                    sheet.Range[xlsRow, colRegister].VerticalAlignment = ExcelVAlign.VAlignTop;
                    ...
                    sheet[xlsRow, colR].Text = dtData.Rows[i]["Remark"].ToString();
                    sheet.Range[xlsRow, colR].HorizontalAlignment = ExcelHAlign.HAlignLeft;
                    sheet.Range[xlsRow, colR].VerticalAlignment = ExcelVAlign.VAlignTop;
                    ...
                    sheet[xlsRow, colEN].Text = dtData.Rows[i]["EmloyeeName"].ToString();
                    sheet.Range[xlsRow, colEN].HorizontalAlignment = ExcelHAlign.HAlignLeft;
                    sheet.Range[xlsRow, colEN].VerticalAlignment = ExcelVAlign.VAlignTop;


                    sheet[xlsRow, colDesignation].Text = dtData.Rows[i]["Designation"].ToString();
                    sheet.Range[xlsRow, colDesignation].HorizontalAlignment = ExcelHAlign.HAlignLeft;
                    sheet.Range[xlsRow, colDesignation].VerticalAlignment = ExcelVAlign.VAlignTop;


                    sheet[xlsRow, colEmpType].Text = dtData.Rows[i]["EmpType"].ToString();
                    sheet.Range[xlsRow, colEmpType].HorizontalAlignment = ExcelHAlign.HAlignLeft;
                    sheet.Range[xlsRow, colEmpType].VerticalAlignment = ExcelVAlign.VAlignTop;


                    sheet[xlsRow, colDepartment].Text = dtData.Rows[i]["Department"].ToString();
                    sheet.Range[xlsRow, colDepartment].HorizontalAlignment = ExcelHAlign.HAlignLeft;
                    sheet.Range[xlsRow, colDepartment].VerticalAlignment = ExcelVAlign.VAlignTop;

                    sheet[xlsRow, colEmpCurrentStatus].Text = dtData.Rows[i]["EmpCurrentStatus"].ToString();
                    sheet.Range[xlsRow, colEmpCurrentStatus].HorizontalAlignment = ExcelHAlign.HAlignLeft;
                    sheet.Range[xlsRow, colEmpCurrentStatus].VerticalAlignment = ExcelVAlign.VAlignTop;

                    sheet[xlsRow, colEmpStatus].Text = dtData.Rows[i]["EmpStatus"].ToString();
                    sheet.Range[xlsRow, colEmpStatus].HorizontalAlignment = ExcelHAlign.HAlignLeft;
                    sheet.Range[xlsRow, colEmpStatus].VerticalAlignment = ExcelVAlign.VAlignTop;
        ...
        #region GoodWorkPaymentAdvisePayments Reports

        public IWorkbook GoodWorkPaymentAdvisePaymentsReports(string reportFileName, string companyGroupId, string companyId, string plantId, string plantName, string goodWorkPaymentAdviseId)
        {
            var reportUtility = new ReportUtility();
            var excelEngine = new ExcelEngine();
            var workbook = reportUtility.GetWorkbook(ref excelEngine, 1);
            workbook.Version = ExcelVersion.Excel2016;
            var sheet = workbook.Worksheets[0];
            sheet.Name = "GoodWorkPaymentAdvise";

            var header = GetGoodWorkPaymentAdvisePaymentsReportsHeader(companyGroupId, companyId, plantId, goodWorkPaymentAdviseId);

            var dsLocal = GoodWorkPaymentAdvisePaymentsReportsData(companyGroupId, companyId, plantId, goodWorkPaymentAdviseId);

            
            GetParallelCurrency(companyId, out string companyCurrencyId, out string companyCurrencyCode);
            var transcationCurrency = companyCurrencyId;
            ...
            reportUtility.SetMasterHeaderText(ref sheet, row, 1, "Advise Id");
            reportUtility.SetText(ref sheet, row, 2, header["Id"].ToString(), ExcelHAlign.HAlignLeft);
            reportUtility.SetMasterHeaderText(ref sheet, row, 4, "By Whom");
            reportUtility.SetText(ref sheet, row, 5, header["ByWhom"].ToString(), ExcelHAlign.HAlignLeft);

            sheet[reportUtility.GetColumnNameForXls(2) + row + ":" + reportUtility.GetColumnNameForXls(3) + row].Merge();

            row++;

            reportUtility.SetMasterHeaderText(ref sheet, row, 1, "From Date");
            reportUtility.SetText(ref sheet, row, 2, header["FromDate"].ToString(), ExcelHAlign.HAlignLeft);
            reportUtility.SetMasterHeaderText(ref sheet, row, 4, "To Date");
            reportUtility.SetText(ref sheet, row, 5, header["ToDate"].ToString(), ExcelHAlign.HAlignLeft);
            ...
            reportUtility.SetMasterHeaderText(ref sheet, row, 1, "Payment Source");
            reportUtility.SetText(ref sheet, row, 2, header["PaymentSource"].ToString(), ExcelHAlign.HAlignLeft);
            reportUtility.SetMasterHeaderText(ref sheet, row, 4, "Payments Status");
            reportUtility.SetText(ref sheet, row, 5, header["PaymentsStatus"].ToString(), ExcelHAlign.HAlignLeft);
            ...
            colLast = companyCurrencyId == transcationCurrency ? 5 : 7;
            reportUtility.SetMasterHeaderText(ref sheet, row, 1, "User Ref");
            reportUtility.SetText(ref sheet, row, 2, header["UserRef"].ToString(), ExcelHAlign.HAlignLeft);

            reportUtility.SetMasterHeaderText(ref sheet, row, 4, "Remarks");
            reportUtility.SetText(ref sheet, row, 5, header["Remarks"].ToString(), ExcelHAlign.HAlignLeft);
            ...
            reportUtility.SetHeaderText(ref sheet, row, xlsCol, "EmployeeCode"); colEmployeeCode = xlsCol; xlsCol++;
            //sheet[reportUtility.GetColumnNameForXls(colGl) + row + ":" + reportUtility.GetColumnNameForXls(2) + row].BorderAround(ExcelLineStyle.Thin); ;
            //sheet[reportUtility.GetColumnNameForXls(colGl) + row + ":" + reportUtility.GetColumnNameForXls(2) + row].Merge(); xlsCol++;
            //reportUtility.SetHeaderText(ref sheet, row, xlsCol, "GL", 12, ExcelHAlign.HAlignRight);

            reportUtility.SetHeaderText(ref sheet, row, xlsCol, "EmployeeName", 12); colEmployeeName = xlsCol; xlsCol++;
            reportUtility.SetHeaderText(ref sheet, row, xlsCol, "Remarks", 12); colRemarks = xlsCol; xlsCol++;
            reportUtility.SetHeaderText(ref sheet, row, xlsCol, "Minute", 12); colMinute = xlsCol; xlsCol++;
            reportUtility.SetHeaderText(ref sheet, row, xlsCol, "Hour", 12); colHour = xlsCol; xlsCol++;
            ...
            //else
            //{
                reportUtility.SetHeaderText(ref sheet, row, xlsCol, "Rate", 13, ExcelHAlign.HAlignRight); colRate = xlsCol; xlsCol++;
                reportUtility.SetHeaderText(ref sheet, row, xlsCol, "Amount", 13, ExcelHAlign.HAlignRight); colinrCredit = xlsCol;
                colLast = xlsCol;
            //}
            ...
            if (dsLocal.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dsLocal.Rows.Count; i++)
                {
                    ...
                    reportUtility.SetText(ref sheet, row, colRemarks, dsLocal.Rows[i]["Remarks"].ToString());
                    reportUtility.SetText(ref sheet, row, colMinute, dsLocal.Rows[i]["Minute"].ToString());
                    reportUtility.SetText(ref sheet, row, colHour, dsLocal.Rows[i]["Hour"].ToString());
                    ...
                    //else
                    //{
                        reportUtility.SetText(ref sheet, row, colRate, Convert.ToDouble(dsLocal.Rows[i]["Rate"].ToString()));
                        reportUtility.SetText(ref sheet, row, colinrCredit, Convert.ToDouble(dsLocal.Rows[i]["Amount"].ToString()));
                    //}
                    totalBookCurrencyAmount += Convert.ToDouble(dsLocal.Rows[i]["Amount"].ToString());
                ...
                reportUtility.CompanyPlantHeader(ref sheet, colLast, "GoodWorkPaymentAdvise", companyId, plantId, plantName, null);
                reportUtility.PageSetup(ref sheet, colLast, ExcelPageOrientation.Portrait);
            }
            else
            {
                sheet.UsedRange.WrapText = true;
                sheet.UsedRange.CellStyle.Font.Size = 8;
                reportUtility.CompanyPlantHeader(ref sheet, 5, "GoodWorkPaymentAdvise", companyId, plantId, plantName, null);
                reportUtility.PageSetup(ref sheet, 5, ExcelPageOrientation.Portrait);
            }
            return workbook;
        }
        ...
        private Dictionary<string, object> GetGoodWorkPaymentAdvisePaymentsReportsHeader(string companyGroupId, string companyId, string plantId, string goodWorkPaymentAdviseId)
        {
            var cmdText = @"select ei.EmployeeCode,ei.EmployeeName ByWhom,gwp.Id,FORMAT(gwp.FromDate,'dd-MMM-yyy') FromDate,FORMAT(gwp.ToDate,'dd-MMM-yyy')ToDate
                        ...
                        where gwp.Id='" + goodWorkPaymentAdviseId + @"' ";
            return _sqlRepository.GetData(cmdText);
        }
        private DataTable GoodWorkPaymentAdvisePaymentsReportsData(string companyGroupId, string companyId, string plantId, string goodWorkPaymentAdviseId)
        {
            var sql = @"select gwpad.Id,gwpad.PaymentAdviseId,gwpad.EmpSystemId,ei.EmployeeCode,ei.EmployeeName,gwpad.Hour,gwpad.Hour*60 Minute,gwpad.Rate,gwpad.Amount,gwpad.Remarks
                            ...
                            where gwpa.Id='" + goodWorkPaymentAdviseId + @"' and gwpad.IsCheck=1 AND ISNULL(gwpad.IsDisburse,0)=1 ";
            return _sqlRepository.GetDataTable(sql);
        }
