        ...
        public List<Dictionary<string, object>> GetSalaryLockDataGLList(string yearNo, string monthNo, string employeeId, bool isActive, bool isSeperated, bool isMaternity, string plantId)
        {
            ...
            string sql = @"SELECT 
                       X.SalaryHeadId,X.AccountsGroupId ,X.AccountsGroup,'Direct' SalaryType,X.SalaryHead ,X.SalaryHeadCategory,
                        ...
                        WHERE sl.MonthNo='" + monthNo + "' and sl.YearNo='" + yearNo + @"' AND sl.PayableVoucherId IS NULL " + wcEmpStatus + @" AND SPL.PlantId='" + plantId + @"'  and DMC.plantId='" + plantId + @"'--and sl.EmpSystemId='" + employeeId + @"' 
