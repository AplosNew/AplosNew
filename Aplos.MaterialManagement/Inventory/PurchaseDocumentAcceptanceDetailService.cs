...
{
    public class PurchaseDocumentAcceptanceDetailService : Service<PurchaseDocAcceptanceDetail>, IPurchaseDocumentAcceptanceDetailService
    {
        #region Constructor
        ...
        public PurchaseDocumentAcceptanceDetailService(
            IRepositoryAsync<PurchaseDocAcceptanceDetail> purchaseDocAcceptanceDetailRepository
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(purchaseDocAcceptanceDetailRepository, unitOfWork, pkGeneratorService)
        {
