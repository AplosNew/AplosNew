...
{
    public class PurchaseDocAcceptancePOMapService : Service<PurchaseDocAcceptancePOMap>, IPurchaseDocAcceptancePOMapService 
    {
        #region Constructor
        ...
        public PurchaseDocAcceptancePOMapService(
            IRepositoryAsync<PurchaseDocAcceptancePOMap> PurchaseDocAcceptancePOMapRepository
            , IPKGeneratorService pkGeneratorService
            , IUnitOfWork unitOfWork
            , ISqlRepository sqlRepository
            ) : base(PurchaseDocAcceptancePOMapRepository, unitOfWork, pkGeneratorService) 
        {
